<?php
$fwMainView = 'file:' . getcwd() . '/taskeditproposalurl.tpl';
...
{		
	...
	if($complete == '0')
	{
		$sql_update = "UPDATE proposal_tasks
							SET  bt_complete = 0,
							bt_completed_date=0,
							bt_completed_by=0,
							bt_comment=''
	...
	elseif($complete == '1')
	{
		...
		$sql_update = "UPDATE proposal_tasks SET bt_complete = 1,
	...
	$tablebtasks = new Fw_Db_Table('proposal_tasks');
