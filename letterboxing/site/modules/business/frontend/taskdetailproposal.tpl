...
<table cellpadding="0" cellspacing="0" border="1"  width="100%">
  ...
  {{/if}}
    ...
    <td>
	<a href="javascript:modelwindow('{{$BASE_URL}}business.subtaskproposal/bus_id/{{$item.bt_bsn_id}}/tsid/{{$item.bt_task_status_id}}/tid/{{$item.bt_task_id}}','90%','90%', 'yes');">
<img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/sub.png" title="Sub Task Edit"/></a> 
    
    <a href="javascript:modelwindow('{{$BASE_URL}}business.taskeditproposalurl/bus_id/{{$item.bt_bsn_id}}/taskId/{{$item.bt_id}}','90%','90%', 'yes');">
...
<img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/qa.png" title="Sub Task Edit"/></a> <br />
    ...
    <input type="hidden" name="comp[tsn]" value="{{$tsn}}" />
  ...
  {{/foreach}}
   <tr> <td colspan="12" style="padding:5px;"><input type="submit" name="not_required_task_save" value="Save Not Required" /></td>
</table>
<br />
<br />
</form>
...
{{if $pp }}
<input type="button" value="Back To Project Plan Report" onclick="location.href='{{$BASE_URL}}project_plans_report.home';" /> 
{{elseif $pcr}}
<input type="button" value="Back To Pre Construction Report" onclick="location.href='{{$BASE_URL}}pre_construction_report.home';" /> 
{{else}}

{{if $allTasks[0].bt_task_status_id eq 5 }}
<input type="button" value="Back To Inclusion Task Report" onclick="location.href='{{$BASE_URL}}inclusions_task_tracker.home';" /> 
{{/if}}
{{if $allTasks[0].bt_task_status_id eq 3 }}
<input type="button" value="Back To Construction Task Report" onclick="location.href='{{$BASE_URL}}construction_task_tracker.home';" /> 
{{/if}}
{{if $allTasks[0].bt_task_status_id eq 2 }}
<input type="button" value="Back To Planning Task Report" onclick="location.href='{{$BASE_URL}}planning_task_tracker.home';" /> 
{{/if}}
