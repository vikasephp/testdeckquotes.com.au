        ...
        <table id="list-table" width="100%">
           ...
           {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
            <tr>
                ...
                <td><textarea cols="120" name="{{$TABLE}}[qa_question]" >{{$detail.qa_question}} </textarea>
                </td></tr></table>
                 </td>
            </tr>        
            <tr>
                ...
                <td width="500">
                <table  width="500" id="none-table22"><tr><td>
                <textarea cols="120" rows="2"name="{{$TABLE}}[qa_answer]" class="tinymce" style="height:10px;">{{$detail.qa_answer|stripslashes}}</textarea>    
                </td></tr></table>
                </td>
            </tr>
          ...
          <td>{{$detail.qa_last_updated_by}}</td>
            ...
            <tr>
          <th>Attachment: </th>
          <td><input type= "file" name="docs" />{{if $detail.qa_attachment}} {{$detail.qa_attachment}} {{/if}}  </td>
          </tr>
