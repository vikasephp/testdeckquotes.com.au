...
{{if $msg != 0}}
<script type="text/javascript">
	parent.requestddtimetrackerInfo(1);
   </script>
<script type="text/javascript">
...
{{/if}}
   {{if $msg != 0}}
<script type="text/javascript">
	parent.toggleLayer('divtimetracker','addtimetrackeralert');
...
<table width="100%" id="none-table" style="background-color:#FFFFFF;">
  ...
  <input type="hidden" name="{{$TABLE}}[tt_id]" value="{{$detail.tt_id}}" id="edt_id"/>
  <input type="hidden" name="{{$TABLE}}[tt_bsn_id]" value="{{$detail.tt_bsn_id|default:$bsn_id}}" id="beb_id"/>
<tr>
   <td>
    <table width="100%" height="200" style="background-color:#FFFFFF; border:1px solid #c1dad7;">
        ...
        <td>Event:&nbsp;</td>
        <th> <input type="text" name="{{$TABLE}}[tt_event]" value="{{$detail.tt_event}}" style="width:700px;" /> </th>
      </tr>
    
     <tr>	 
      <td>Working Days:&nbsp;</td>
      <th><input type="text" name="{{$TABLE}}[tt_working_days]" value="{{$detail.tt_working_days}}" /></th>
      </tr>
      ...
      <th><input type="text" name="{{$TABLE}}[tt_date_submitted]" value="{{$detail.tt_date_submitted}}" id="demo2" class="w16em dateformat-d-ds-m-ds-Y" readonly="readonly" /></th>
      </tr>
      ...
      <tr>
      <td>Due Date:&nbsp;</td>
      <th ><input type="text" name="{{$TABLE}}[tt_due_date]" value="{{$detail.tt_due_date}}" id="demo3" class="w16em dateformat-d-ds-m-ds-Y" readonly="readonly" /></th>
      </tr>
      
      <tr>
        <td>Rule:&nbsp;</td>
        <th > <input type="text" name="{{$TABLE}}[tt_rule]" value="{{$detail.tt_rule}}" style="width:700px;" /> </th>
      </tr>
    ...
    <tr>
      <td colspan="2"><div align="left">
          ...
          <input type="button" name="cancel" value="Cancel" onclick="javascript:parent.add_edit_time_tracker();" class="sml"/>
          </div>
      </td>
    </tr>
  </form>
...
<script type="text/javascript" language="javascript" >
    ...
    frmvalidator.addValidation("{{$TABLE}}[be_alert_text]","req", "Please specify alert text.");
