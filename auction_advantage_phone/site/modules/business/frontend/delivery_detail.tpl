...
{{/if}}
   {{if $msg != 0}}
<script type="text/javascript">
	parent.toggleLayer('divdelivery','adddelivery');
	closeTop();
   </script>
{{/if}}
...
<table width="100%" id="none-table" style="background-color:#FFFFFF;">
  <form name="detail" method="post" action="" id="form1" enctype="multipart/form-data" onsubmit="showTop(); return false;">
    ...
    <tr>
      ...
      <table width="100%" height="120" style="background-color:#FFFFFF; border:1px solid #c1dad7;">
      <input type="hidden" name="delivery[de_bus_id]" value="{{$detail.de_bus_id|default:$bsn_id}}" id="beb_id"/>
      <input type="hidden" name="delivery[de_id]" value="{{$detail.de_id}}" />
            
         <tr>
            <td>Delivery Type:&nbsp;</td>
            <th colspan="3"> <input type="text" name="delivery[de_delivery_type]" id="own" value="{{$detail.de_delivery_type}}" style="width:300px;" /></th>
          </tr>

           <tr>
            <td>Delivery Confirmation:&nbsp;</td>
            <th colspan="3"> <input type="file" name="delconfir"  id="fl" /></th>
          </tr>
        
	  
          <tr>
            <td>Photos:&nbsp;</td>
            <th colspan="3"> <input type="file" name="photos"  id="fl" /></th>
          </tr>
    ...
    <tr>
      <td colspan="2"><div align="left">
          ...
          <input type="button" name="cancel" value="Cancel" onclick="javascript:parent.add_edit_delivery();" class="sml" />
...
<script type="text/javascript" language="javascript" >
    ...
    frmvalidator.addValidation("delivery[de_delivery_type]","req",  "Please specify type.");
</script>
