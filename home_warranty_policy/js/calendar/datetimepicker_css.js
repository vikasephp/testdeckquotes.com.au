...
var MonthYearColor="#63C1DB";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#63C1DB";//var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor="#DBE254";//var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor="#DBE254";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#FFFF33";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#63C1DB";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader="<table "+CalBgColor+" background='"+ThemeBg+"' style='border: solid 4px #63C1DB;' cellpadding=0 cellspacing=0 width='200px' valign='top'>\n";
