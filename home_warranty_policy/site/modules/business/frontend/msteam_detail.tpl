...
<table width="100%" id="none-table" style="background-color:#FFFFFF;">
  <form name="detail" method="post" action="{{$XFA.msteam_detail}}" enctype="multipart/form-data" onsubmit="showTop();return false;">
    <tr>
      <td colspan="10" height="30">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="3" width="100%">
      <table width="100%" height="150" style="background-color:#FFFFFF; border:1px solid #c1dad7;">
      <input type="hidden" name="msteam[ms_bus_id]" value="{{$detail.ms_bus_id|default:$bsn_id}}" id="beb_id"/>
      <input type="hidden" name="msteam[ms_id]" value="{{$detail.ms_id}}" />
          
          <tr>
            <td>Stream:</td>
            <th colspan="3"><input type="text" class="xxlrg" name="msteam[ms_stream]" value="{{$detail.ms_stream}}" style="width:400px;"/>
              </th>
          </tr>
          
         <tr>
            <td>Path:&nbsp;</td>
            <th colspan="3"> <input type="text" name="msteam[ms_path]" id="be_comments" value="{{$detail.ms_path}}" style="width:900px;" /></th>
          </tr>
    ...
    <tr>
      <td colspan="2"><div align="left">
          ...
          <input type="button" name="cancel" value="Cancel" onclick="javascript:parent.add_edit_ms_team();" class="sml"/>
          </div></td>
    </tr>
  </form>
</table>
<script type="text/javascript" language="javascript" >
    ...
    frmvalidator.addValidation("msteam[ms_stream]","req", "Please specify stream.");
