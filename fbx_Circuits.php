...
$Fusebox['circuits']['ai_repository'] = './site/modules/ai_repository/frontend';
...
// Items
$Fusebox['circuits']['itemAdmin'] = './site/modules/item_list/admin';
...
//nsw_planning_assesment_quickreport
$Fusebox['circuits']['nsw_planning_assesment_quickreport'] = './site/modules/nsw_planning_assesment_quickreport/frontend';
...
//Inclusions Calculation Report
$Fusebox['circuits']['inclusions_calculation_report'] = './site/modules/inclusions_calculation_report/frontend';

//Construction Report
$Fusebox['circuits']['construction_report'] = './site/modules/construction_report/frontend';

// Construction Procedures
$Fusebox['circuits']['construction_procedures'] = './site/modules/construction_procedures/frontend';
...
$Fusebox['circuits']['planning_only_task_tracker'] = './site/modules/planning_only_task_tracker/frontend';
...
$Fusebox['circuits']['warranty_communication'] = './site/modules/warranty_communication/frontend';

//Warranty Log
$Fusebox['circuits']['warranty_log2'] = './site/modules/warranty_log2/frontend';

// Inspection Warranty Log
$Fusebox['circuits']['inspection_warranty_log'] = './site/modules/inspection_warranty_log/frontend';

// Warranty Escalation Report
$Fusebox['circuits']['warranty_escalation_report'] = './site/modules/warranty_escalation_report/frontend';
...
$Fusebox['circuits']['variations_in_progress'] = './site/modules/variations_in_progress/frontend';
...
//Late Letter Email Log
$Fusebox['circuits']['lateletter_email_log'] = './site/modules/lateletter_email_log/frontend';
...
//Archive Design Plans – Mistake Log
$Fusebox['circuits']['design_plans_mistake_log'] = './site/modules/design_plans_mistake_log/frontend';

// Designs - Architects (MAIN MENU)
// Missing Plans Database
$Fusebox['circuits']['missing_plans_database'] = './site/modules/missing_plans_database/frontend';

//Central Letter Database
$Fusebox['circuits']['central_letter_database'] = './site/modules/central_letter_database/frontend';
...
// Planning Client Alerts
$Fusebox['circuits']['planning_client_alerts'] = './site/modules/planning_client_alerts/frontend';


// Legal Dispute Database
$Fusebox['circuits']['legal_dispute_database'] = './site/modules/legal_dispute_database/frontend';
// Claim Against Us
$Fusebox['circuits']['claim_against_us'] = './site/modules/claim_against_us/frontend';
// Our Claims
$Fusebox['circuits']['our_claims'] = './site/modules/our_claims/frontend';
// Construction Invoice Disputes
$Fusebox['circuits']['construction_invoice_disputes'] = './site/modules/construction_invoice_disputes/frontend';
// Disputes < 25k
$Fusebox['circuits']['disputes_less_than_25k'] = './site/modules/disputes_less_than_25k/frontend';
// Disputes > 25k
$Fusebox['circuits']['disputes_more_than_25k'] = './site/modules/disputes_more_than_25k/frontend';

$Fusebox['circuits']['property_price_report'] = './site/modules/property_price_report/frontend';

// 
$Fusebox['circuits']['designs_information_repository'] = './site/modules/designs_information_repository/frontend';

//
$Fusebox['circuits']['development_log_ephp'] = './site/modules/development_log_ephp/frontend';

//
$Fusebox['circuits']['debt_recovery_report'] = './site/modules/debt_recovery_report/frontend';

//
$Fusebox['circuits']['street_sign_planning_inclusion'] = './site/modules/street_sign_planning_inclusion/frontend';

//
$Fusebox['circuits']['street_sign_construction'] = './site/modules/street_sign_construction/frontend';

$Fusebox['circuits']['quote_management_report'] = './site/modules/quote_management_report/frontend';

$Fusebox['circuits']['franks_recording_report'] = './site/modules/franks_recording_report/frontend';

$Fusebox['circuits']['site_progress_report'] = './site/modules/site_progress_report/frontend';

$Fusebox['circuits']['property_sale_project_tracker'] = './site/modules/property_sale_project_tracker/frontend';
$Fusebox['circuits']['properties_sale_reports'] = './site/modules/properties_sale_reports/frontend';

$Fusebox['circuits']['sales_phase_logon'] = './site/modules/sales_phase_logon/frontend';


$Fusebox['circuits']['sales_document_explained'] = './site/modules/sales_document_explained/frontend';
$Fusebox['circuits']['sales_process_explained'] = './site/modules/sales_process_explained/frontend';
$Fusebox['circuits']['design_documents'] = './site/modules/design_documents/frontend';
$Fusebox['circuits']['design_timeline'] = './site/modules/design_timeline/frontend';
$Fusebox['circuits']['proposal_documents'] = './site/modules/proposal_documents/frontend';
$Fusebox['circuits']['proposal_timeline'] = './site/modules/proposal_timeline/frontend';
$Fusebox['circuits']['planning_documents'] = './site/modules/planning_documents/frontend';
$Fusebox['circuits']['planning_timeline'] = './site/modules/planning_timeline/frontend';
$Fusebox['circuits']['inclusion_timeline'] = './site/modules/inclusion_timeline/frontend';
$Fusebox['circuits']['sample_project_guidance'] = './site/modules/sample_project_guidance/frontend';
$Fusebox['circuits']['explanation_videos'] = './site/modules/explanation_videos/frontend';
$Fusebox['circuits']['planning_approval_common_questions'] = './site/modules/planning_approval_common_questions/frontend';

//Supplier Report
$Fusebox['circuits']['supplier_report'] = './site/modules/supplier_report/frontend';

//Home Warranty Policy
$Fusebox['circuits']['home_warranty_policy'] = './home_warranty_policy/site/modules/site/frontend';

//Auction Advantage Phone Log
$Fusebox['circuits']['auction_advantage_phone_log'] = './site/modules/auction_advantage_phone_log/frontend';

//Auction Advantage Phone Frontend URL
$Fusebox['circuits']['auction_advantage_phone'] = './auction_advantage_phone/site/modules/site/frontend';

//For download docs from pdf url
$Fusebox['circuits']['documents'] = './site/modules/documents/frontend';

//Upcoming 10 Days PAR Appointment
$Fusebox['circuits']['upcoming_10_days_par_appointment'] = './site/modules/upcoming_10_days_par_appointment/frontend';

$Fusebox['circuits']['log_report'] = './site/modules/log_report/frontend';


$Fusebox['circuits']['weekly_turnover_report'] = './site/modules/weekly_turnover_report/frontend';
$Fusebox['circuits']['xray_overview_report_2'] = './site/modules/xray_overview_report_2/frontend';
$Fusebox['circuits']['12_week_turnover_forecast'] = './site/modules/12_week_turnover_forecast/frontend';

//AI Procedure Document
$Fusebox['circuits']['ai_procedure'] = './site/modules/ai_procedure/frontend';

//Event Log Clearing Center
$Fusebox['circuits']['event_log_clearing_center'] = './site/modules/event_log_clearing_center/frontend';

//Design Estimates Report
$Fusebox['circuits']['design_estimates_report'] = './site/modules/design_estimates_report/frontend';

// ChatGPT Interface
$Fusebox['circuits']['chatgpt_interface'] = './site/modules/chatgpt_interface/frontend';

$Fusebox['circuits']['hia_signups_2026'] = './site/modules/hia_signups_2026/frontend';

// Buyer's Agent Canberra
$Fusebox['circuits']['buyers_agent_canberra'] = './site/modules/buyers_agent_canberra/frontend';
$Fusebox['circuits']['members'] = './site/modules/members/frontend';

// Insurance Manager
$Fusebox['circuits']['insurance_manager'] = './site/modules/insurance_manager/frontend';

// Central SMS Database
$Fusebox['circuits']['central_sms_database'] = './site/modules/central_sms_database/frontend';

// Certifier_structural_engineer
$Fusebox['circuits']['certifier_structural_engineer'] = './site/modules/certifier_structural_engineer/frontend';

//Dual Occupancy Lead Report
$Fusebox['circuits']['dual_occupancy_lead_report'] = './site/modules/dual_occupancy_lead_report/frontend';

//Dual Occupancy Canberra Q and A
$Fusebox['circuits']['dual_occupancy_canberra_q_and_a'] = './site/modules/dual_occupancy_canberra_q_and_a/frontend';

// Short Stays Payables Tracker
$Fusebox['circuits']['short_stays_payables_tracker'] = './site/modules/short_stays_payables_tracker/frontend';

//For API of Prospect List and Dual Occupancy Lead Report to get data from other website
$Fusebox['circuits']['api'] = './site/modules/api/frontend';

//Project Delay Register
$Fusebox['circuits']['project_delay_register'] = './site/modules/project_delay_register/frontend';


//Planning Legislation Register
$Fusebox['circuits']['planning_legislation_register'] = './site/modules/planning_legislation_register/frontend';

//Planning Definitions Database
$Fusebox['circuits']['planning_definations_database'] = './site/modules/planning_definations_database/frontend';

//Planning Knowledge Library
$Fusebox['circuits']['planning_knowledge_library'] = './site/modules/planning_knowledge_library/frontend';

//Alert Escalation Report
$Fusebox['circuits']['alert_escalation_report'] = './site/modules/alert_escalation_report/frontend';
