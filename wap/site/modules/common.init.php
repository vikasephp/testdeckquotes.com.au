...
//  $mail->Username   = "admin@deckquotes.com.au";  // GMAIL username
//  $mail->Password   = "*Gondia12";            // GMAIL password
 ...
 //// $mail->SMTPSecure = "SSL";                 // sets the prefix to the servier
  ...
  /*$mail->Username   = "manojs@ephpsolutions.com";  // GMAIL username
  $mail->Password   = "*Gondia12"; 	*/
  
$mail->Username   = "cgfbccbsemails@ephpsolutions.com";  // GMAIL username
  $mail->Password   = "HwXE98NwCirO9OtH023OaldZ58eVn3obOHvkk"; 

  $mail->SetFrom($from, $from_name);
  $mail->AddReplyTo($from, $from_name);
  $mail->AddAddress($to, $to_name);
  $mail->AddBCC("emailbackup@cgfb.com.au", "Backup Email");
  //$mail->AddBCC("manoj@vantagenine.net", "Backup Email");
...
$fwViewData['custom_dcl'] = array('1' => 'Document Check List - A',
