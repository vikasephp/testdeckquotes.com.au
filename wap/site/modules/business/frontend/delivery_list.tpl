...
<table cellpadding="3" cellspacing="3" width="98%" id="list-table" >
	  ...
	  <td>{{$item.de_delivery_type}}</th>
          ...
          <td>{{if $item.de_delivery_conf}}<a href = "https://deckquote.s3.amazonaws.com/files/delivery_doc/{{$item.de_delivery_conf}}" target="_blank">Download{{/if}}</td>
          
          <td>{{if $item.de_photos}}<a href = "https://deckquote.s3.amazonaws.com/files/delivery_doc/{{$item.de_photos}}" target="_blank">Download{{/if}}</td>
