...
<tr><td valign="middle" width="200"> Partner Name:&nbsp;</td> <th>
...
<input type="text" class="xxlrg" style="width:504px;" name="{{$TABLE}}[bs_customers_name]" value="{{$detail.bcust_fname}} {{$detail.bcust_lname}}" id="txtCustId" onkeyup="requestCustomerInfo()" autocomplete="off"/>
<br /><div id="divCustomersInfo" class="element"></div>
     ...
     <tr><td>Send Notification:&nbsp;</td><th>
      <input type="checkbox" name="{{$TABLE}}[bs_qanotification]" value="1" {{if $detail.bs_qanotification == 1 }} checked="checked" {{/if}}>
     </th><td></td><th></th></tr>
    
    <tr><td>Email Salutation:&nbsp;</td><th>
      <input type="text" name="{{$TABLE}}[bs_email_salutation]" value="{{$detail.bs_email_salutation}}" class="lrg" >
     </th><td></td><th></th></tr>
...
<script type="text/javascript" language="javascript" >
    ...
    frmvalidator.addValidation("{{$TABLE}}[bs_customers_id]","req", "Please specify valid customer name.");
</script>
</body>