<?php /* Smarty version 2.6.20, created on 2024-06-29 20:29:48
         compiled from file:/home/deckquotescom/public_html/wap/site/modules/site/frontend/home.tpl */ ?>
<style>
	...
	<div class="login-html">
		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
                    <input type="hidden" name="wap[wl_wa_id]" value="<?php echo $this->_tpl_vars['wa_id']; ?>
" />
           			<input type="hidden" name="wap[wl_supplier]" value="<?php echo $this->_tpl_vars['comp']; ?>
" />
            		<input type="hidden" name="wap[wl_sup_email]" value="<?php echo $this->_tpl_vars['eml']; ?>
" />
                     
					<label for="name" class="label">Warranty  Log  Number :- <?php echo $this->_tpl_vars['wa_id']; ?>
 </label>
					
				</div>
				<div class="group">
					<label for="number" class="label">Supplier :- <?php echo $this->_tpl_vars['comp']; ?>
</label>
					
				</div>
                
                <div class="group">
					<label for="number" class="label" style="text-transform:none !important;">Problem :- <?php echo $this->_tpl_vars['problem']; ?>
</label>
