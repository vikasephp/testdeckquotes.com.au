 ...
 <tr><td height="30">&nbsp;</td></tr>
                                                ...
                                                <tr>
                                                    <td colspan="3" align="left" class="conBorders hpconwidth" height="400">
													<div align="center" class="logo_header">Turnkey Studios</div>
                                                    {{$detail.page_body}}                                                  </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <!-- Shadow Starts -->
                                                <tr>
                                                    <td colspan="3" align="center"><img src="{{$BASE_URL}}images/content-area-shadow.jpg" height="15" width="780"/></td>
                                                </tr>
                                                <!-- Shadow Ends -->
                                            </table>
