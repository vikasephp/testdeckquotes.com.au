...
(function () {
  var message = "Your access to TinyMCE will expire on 30 November 2020. Please either contact your administrator or upgrade your account using the instructions available <a href='https://www.tiny.cloud/blog/how-to-migrate-from-tinymce-4-to-tinymce-5/'>here</a>.";
  var messageWithoutLink = "Your access to TinyMCE will expire on 30 November 2020. Please either contact your administrator or upgrade your account using the instructions available at https://www.tiny.cloud/blog/how-to-migrate-from-tinymce-4-to-tinymce-5/.";


!function(c){"use strict";var n=void 0!==c.window?c.window:Function("return this;")(),u=function(){return(new Date).getTime()},i=function(n,t,e,o,i){var r,a=u();r=c.setInterval(function(){n()&&(c.clearInterval(r),t()),u()-a>i&&(c.clearInterval(r),e())},o)},r=function(i){return function(){var n,t,e,o=(n=i,t="position",e=n.currentStyle?n.currentStyle[t]:c.window.getComputedStyle(n,null)[t],e||"").toLowerCase();return"absolute"===o||"fixed"===o}},a=function(n){n.parentNode.removeChild(n)},e=function(n,t){var e,o=((e=c.document.createElement("div")).style.display="none",e.className="mce-floatpanel",e);c.document.body.appendChild(o),i(r(o),function(){a(o),n()},function(){a(o),t()},10,5e3)},o=function(n){n.notificationManager?n.notificationManager.open({text:message,type:"warning",timeout:0,icon:""}):n.windowManager.alert(messageWithoutLink)},t=function(n){n.EditorManager.on("AddEditor",function(n){var t=n.editor;e(function(){o(t)},function(){c.alert(messageWithoutLink)})})},d=function(n){t(n)};d(n.tinymce)}(window);
})();