  ...
  <form name="createadmin" method="post" action="" enctype="multipart/form-data">
    ...
    <table id="list-table1"  width="100%">
      ...
      <tr>
        ...
        <td><input class="input lrg" name="{{$TABLE}}[customer_bsb]" type="text"  value="{{$detail.customer_bsb}}"/></td>
        <th class="labelhead">Bank Account Number:</th>
        <td><input class="input lrg" name="{{$TABLE}}[customer_account_number]" type="text"  value="{{$detail.customer_account_number}}"/></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input class="input lrg" name="{{$TABLE}}[customer_tax_num]" type="text"  value="{{$detail.customer_tax_num}}"/></td>
