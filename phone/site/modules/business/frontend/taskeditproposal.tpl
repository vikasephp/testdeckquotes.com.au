  ...
  <tr>
    <td><table cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td>&nbsp;</td>
          <td><strong>Task Name123:</strong> {{$taskData.bst_task_name}}</td>
        </tr>
      </table></td>
  </tr>
  <tr>
...
<!--            <input type="text" name="{{$TABLE}}[bsn_status_time]" value="{{$taskData.time}}" class="vvsml" id="editTaskTime" readonly="readonly"/>
  ...
  <tr>
    ...
    <input type="submit" value="Update Task" name="updatetask" />
     <input type="button" value="Close123" onclick='javascript:refresh_close();' />
...
{
	parent.requestAllTasksProposal(0, {{$tn}});
