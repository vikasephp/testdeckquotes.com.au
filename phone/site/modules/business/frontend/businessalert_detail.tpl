...
{{/if}}
   {{if $msg != 0}}
<script type="text/javascript">
	parent.toggleLayer('divbyeralert','addalert');
...
<table width="100%" id="none-table" style="background-color:#FFFFFF;">
  <form name="detail" method="post" action="{{$XFA.businessalert_detail}}" enctype="multipart/form-data" onsubmit="showTop();return false;">
   ...
   <tr>
    ...
    <tr>
      <td colspan="2"><div align="left">
          ...
          <input type="button" name="cancel" value="Cancel" onclick="javascript:parent.add_edit_business_alerts();" class="sml"/>
          </div></td>
    </tr>
  </form>
</table>
