...
<table cellpadding="0" cellspacing="0" width="100%">
  ...
  {{/if}}
    ...
    {{if !empty($ipad)}} 
    <td style="text-align:left;"><a href="https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$item.doc_file_name}}?dummy={{$ran}}" class="action_checklist" title="{{$item.doc_file_name}}" target="_blank">{{$item.doc_file_name|truncate:"40"}}</a></td>
   
    {{else}}
   <td style="text-align:left;"><a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$item.doc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$item.doc_file_name}}">{{$item.doc_file_name|truncate:"40"}}</a>
   {{if $item.doc_file_name}}<br /><a href="https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$item.doc_file_name}}" target="_blank">Link</a>
   {{/if}}
   </td>
     {{/if}}
...
<input type="radio" name="md{{$item.doc_id}}" value="0" onclick="updateCustWWW({{$item.doc_id}}, {{$item.doc_bsn_id}}, 0)" {{if $item.doc_cust_www == 0}} checked="checked" {{/if}} /> NO 
  ...
  {{/foreach}}
   ...
   <tr> <td colspan="7"><input type="submit" name="not_required_save" value="Save Not Required" /></td>
...
<table cellpadding="0" cellspacing="0" width="100%" id="divtruelog" style="border-collapse:collapse;">
  ...
  {{/if}}
    ...
    {{else}}
   <td style="text-align:left;"><a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$item.doc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$item.doc_file_name}}">{{$item.doc_file_name|truncate:"40"}}</a></td>
     {{/if}}
...
<input type="radio" name="not_required[{{$item.doc_id}}][cwww]" value="0"  {{if $item.doc_cust_www == 0}} checked="checked" {{/if}} /> NO 
  ...
  <td>{{$itemc.cdc_doc_name}}</td>
   ...
   {{if !empty($ipad)}} 
    <td style="text-align:left;"><a href="https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$itemc.cdc_file_name}}?dummy={{$ran}}" class="action_checklist" title="{{$itemc.cdc_file_name}}" target="_blank">{{$itemc.cdc_file_name|truncate:"40"}}</a></td>
   
    {{else}}
   <td style="text-align:left;"><a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$itemc.cdc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$itemc.cdc_file_name}}">{{$itemc.cdc_file_name|truncate:"40"}}</a></td>
     {{/if}}
...
<input type="radio" name="not_required[{{$item.doc_id}}][cwww]" value="0"  {{if $item.doc_cust_www == 0}} checked="checked" {{/if}} /> NO 
  ...
  {{if !empty($ipad)}} 
    ...
    {{else}}
   <td style="text-align:left;"><a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$itemc.cdc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$item.doc_file_name}}">{{$itemc.cdc_file_name|truncate:"40"}}</a></td>
     {{/if}}
    ...
    <table cellpadding="0" cellspacing="0" class="table"  >
      ...
      <tr>
        ...
        <td><input type="file" name="image" id="doc_file_name" />
          ...
          <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$doc_data.doc_file_name}}')" id="label_doc_file_name_temp" target="_blank">{{$doc_data.doc_file_name}}</a> <a href="javascript:remove_img();" id="crossimg"><img src="{{$BASE_URL}}css/default/images/notdone-task.gif" id="crossimg" /></a> {{/if}} </td>
      </tr>
      <tr>
        <td colspan="2">
      ...
      <tr>
        ...
        <td><input type="file" name="image" id="doc_file_name" />
         <input type="hidden" name="doc[doc_checklist_number]" value="{{$doc_data.doc_checklist_number}}"  />
          ...
          <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$doc_data.doc_file_name}}?dummy={{$ran}}')" id="label_doc_file_name_temp" target="_blank">{{$doc_data.doc_file_name}}</a> <a href="javascript:remove_img();" id="crossimg"><img src="{{$BASE_URL}}css/default/images/notdone-task.gif" id="crossimg" /></a> {{/if}} </td>
      </tr>
      <tr>
        <td colspan="2">
    ...
    <table cellpadding="0" cellspacing="0" class="table" style="font-size:12px;"  >
      ...
      <tr>
        ...
        <td><input type="file" name="custom_mini" id="cdc_file_name_mini" />
          ...
          <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$cdetail.cdc_file_name}}?dummy={{$ran}}')" id="label_cdc_file_name_temp" target="_blank">{{$cdetail.cdc_file_name}}</a>
...
<table cellpadding="0" cellspacing="0" width="100%" id="customDocumenttable" >
  ...
  {{foreach from=$cprint_data item=item key=key}}
   ...
   <!-- <td>{{$item.admin_cdoc_type}} </td>-->
    ...
    <td style="text-align:center;"><input type="checkbox" {{if $item.doc_upload_to_dossier == 1}} checked="checked"{{/if}} disabled="disabled" /></td>
    <td style="text-align:center;"><input type="checkbox" {{if $item.doc_not_avail == 1}} checked="checked"{{/if}} disabled="disabled" /></td>
    <td style="text-align:center;">{{if !empty($item.admin_doc_manual)}}<a href="https://deckquote.s3.amazonaws.com/files/document_check_list_files_roof/{{$item.admin_doc_manual}}?dummy={{$ran}}" rel="nofollow">View</a>{{/if}}</td>
  </tr>
...
<div id="checkListIframe" >
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <table cellpadding="0" cellspacing="0" class="table" style="border:1px solid #CCCCCC; padding:10px; width:100%; text-align:left;" >
      ...
      <tr>
        <th>File Name: </th>
     <td>{{if !empty($detail.bpd_doc_name)}} <a href="{{$BASE_URL}}{{$FILE_PATH}}files/business_documents/{{$detail.bpd_doc_name}}?dummy={{$ran}}" target="_blank">{{$detail.bpd_doc_name}}</a>
...
<div id="checkListIframe" >
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <table cellpadding="0" cellspacing="0" class="table" style="border:1px solid #CCCCCC; padding:10px; width:100%; text-align:left;" >
      ...
      <tr>
        <th> File Name: </th>
        <td> {{if !empty($detail.bd_doc_name)}} <a href="{{$BASE_URL}}{{$FILE_PATH}}files/business_documents/{{$detail.bd_doc_name}}?dummy={{$ran}}" target="_blank">{{$detail.bd_doc_name}}</a>
...
{{if $documents_data}}
  ...
  <tr>
    ...
    <td style="text-align:center;"><a href="{{$BASE_URL}}{{$FILE_PATH}}files/business_documents/{{$item.bd_doc_name}}?dummy={{$ran}}" title="{{$item.bd_doc_name}}" class="action_small" target="_blank">{{$item.bd_doc_name|truncate:"30"}}</a></td>
...
{{if $pddocs_data}}
  ...
  <tr>
    ...
    <td style="text-align:center;"><a href="{{$BASE_URL}}{{$FILE_PATH}}files/business_documents/{{$item.bpd_doc_name}}?dummy={{$ran}}" title="{{$item.bpd_doc_name}}" class="action_small" target="_blank">{{$item.bpd_doc_name|truncate:"30"}}</a></td>
