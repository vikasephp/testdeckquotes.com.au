<?php /* Smarty version 2.6.20, created on 2026-01-12 22:10:29
         compiled from file:/home/deckquotes/deckquotes.com.au/public_html/phone/site/modules/site/frontend/home.tpl */ ?>
<style>
		...
		<div class="login-form">
			<div class="sign-in-htm">
                ...
                <label for="name" class="label" style="text-transform:capitalize !important;font-size:16px;"">***Repeat callers - Full name and phone number  </label><br />
					...
					<input id="name" type="text" class="input" name="phone[name]" required>
				</div>
				<div class="group">
					<label for="number" class="label">Number</label>
					<input id="number" type="text" class="input" name="phone[number]" required>
				</div>
