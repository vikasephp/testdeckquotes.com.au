...
try {
  ...
  //$mail->Host       = "smtp.smtpcorp.com";      // sets GMAIL as the SMTP server
  //$mail->Port       = 2525;                   // set the SMTP port for the GMAIL server
  //$mail->Username   = "frank@businessbuys.com.au";  // GMAIL username
  //$mail->Password   = "Capital23";            // GMAIL password
  $mail->SMTPSecure = "SSL";                 // sets the prefix to the servier
  $mail->Host       = "mail.turnkeystudios.com.au";      // sets GMAIL as the SMTP server
  $mail->Port       = "25";                   // set the SMTP port for the GMAIL server
  $mail->Username   = "test@turnkeystudios.com.au";  // GMAIL username
...
$pdf->SetAuthor('TurnKeyStudios Project Sales');
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, $headtext, "TurnKeyStudios Project Sales");
