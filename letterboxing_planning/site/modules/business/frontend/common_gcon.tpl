...
<table cellpadding="0" cellspacing="0" border="1"  width="100%">
  <tr>
    ...
    <th width="5%" align="left">Auto Email Auto Text</th>
...
<table cellpadding="0" cellspacing="0" width="100%">
  ...
  {{/if}}
    ...
    {{if !empty($ipad)}} 
    <td style="text-align:left;"><a href="{{$BASE_URL}}{{$FILE_PATH}}files/document_check_list_files/{{$item.doc_file_name}}?dummy={{$ran}}" class="action_checklist" title="{{$item.doc_file_name}}" target="_blank">{{$item.doc_file_name|truncate:"40"}}</a></td>
   
    {{else}}
   <td style="text-align:left;"><a href="javascript:parent.modelviewimages('{{$BASE_URL}}{{$FILE_PATH}}files/document_check_list_files/{{$item.doc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$item.doc_file_name}}">{{$item.doc_file_name|truncate:"40"}}</a></td>
     {{/if}}
...
<table cellpadding="0" cellspacing="0" width="100%" id="divtruelog" style="border-collapse:collapse;">
  <tr>
    ...
    <th width="6%">Date Uploaded</th>
    <th width="7%">User Name</th>
<!--<th width="8%">Upload To Dossier</th>
    <th width="8%">Doc Not Avail.</th>-->
    <th width="10%">Customer WWW</th>
  </tr>
   <form name="nr" method="post" action="">
  ...
  {{/if}}
    ...
    &nbsp;&nbsp;
<!--    <a href="{{$BASE_URL}}business.delete_proposal_doc/doc_id/{{$item.doc_id}}/bsn_id/{{$item.doc_bsn_id}}" onclick="javascript:if(!confirm('Are you sure you want to delete?')) return false;" title="Delete">
...
<input type="radio" name="not_required[{{$item.doc_id}}][cwww]" value="0"  {{if $item.doc_cust_www == 0}} checked="checked" {{/if}} /> NO 
  ...
  <td>{{$itemc.cdc_doc_name}}</td>
   ...
   {{if !empty($ipad)}} 
    <td style="text-align:left;"><a href="{{$BASE_URL}}{{$FILE_PATH}}files/document_check_list_files/{{$itemc.cdc_file_name}}?dummy={{$ran}}" class="action_checklist" title="{{$itemc.cdc_file_name}}" target="_blank">{{$itemc.cdc_file_name|truncate:"40"}}</a></td>
   
    {{else}}
   <td style="text-align:left;"><a href="javascript:parent.modelviewimages('{{$BASE_URL}}{{$FILE_PATH}}files/document_check_list_files/{{$itemc.cdc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$itemc.cdc_file_name}}">{{$itemc.cdc_file_name|truncate:"40"}}</a></td>
     {{/if}}
...
<input type="radio" name="not_required[{{$item.doc_id}}][cwww]" value="0"  {{if $item.doc_cust_www == 0}} checked="checked" {{/if}} /> NO 
  ...
  {{if !empty($ipad)}} 
    ...
    {{else}}
   <td style="text-align:left;"><a href="javascript:parent.modelviewimages('{{$BASE_URL}}{{$FILE_PATH}}files/document_check_list_files/{{$itemc.cdc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$item.doc_file_name}}">{{$itemc.cdc_file_name|truncate:"40"}}</a></td>
     {{/if}}
    ...
    <table cellpadding="0" cellspacing="0" class="table" style="font-size:12px;"  >
      ...
      <tr>
        ...
        <td><input type="file" name="custom_mini" id="cdc_file_name_mini" />
          ...
          <a href="javascript:parent.modelviewimages('{{$BASE_URL}}{{$FILE_PATH}}files/document_check_list_files/{{$cdetail.cdc_file_name}}?dummy={{$ran}}')" id="label_cdc_file_name_temp" target="_blank">{{$cdetail.cdc_file_name}}</a>
