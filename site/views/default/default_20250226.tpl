 ...
 <td valign="top" width="100%">
  ...
  <ul class="menu" style="z-index:222222" >
      ...
      <li>
          ...
          <ul>
               <li><a href="{{$BASE_URL}}construction_task_tracker.home">Construction Task Tracker</a></li>
               <li><a href="{{$BASE_URL}}construction_report.home">Construction Report</a></li>
               <li><a href="{{$BASE_URL}}construction_pipeline_report.home">Construction Pipeline Report</a></li>
               <li><a href="{{$BASE_URL}}quality_assurance_report.home">Quality Assurance Report</a></li>
               <li><a href="{{$BASE_URL}}quality_inspection_report.home">Quality Insurance Report</a></li>
               <li><a href="{{$BASE_URL}}progress_payment_report.home">Project Payment Report</a></li>
               <li><a href="{{$BASE_URL}}certifier_completion_report.home">Certifier Completion Report</a></li>
      ...
      <li>
          ...
          <ul>
               <li><a href="{{$BASE_URL}}construction_in_progress_report.home">Construction in Progress Report</a></li>
               <li><a href="{{$BASE_URL}}project_progress_report.home">Project Progress Report</a></li>
               <li><a href="#">Construction Timetable Report</a></li>
               <li><a href="#">Site Specific Safety And Compliance Report</a></li>
      ...
      <input type="checkbox" id="drop-11" />
      <ul>
        <li><a href="{{$BASE_URL}}street_sign.home">CGFB Street Signs</a></li>
        <li><a href="{{$BASE_URL}}street_sign_design.home">CGFB Street Signs Report Designs</a></li>
      </ul>
    </li> 
...
<li>
          <label for="drop-41" class="toggle">Gcon UserGuide</label>
          <a href="javascript:void();">Gcon UserGuide</a>
          <input type="checkbox" id="drop-41" />
          <ul>
               <li><a href="{{$BASE_URL}}gcon_guide.home">Gcon UserGuide</a></li>
          </ul>
      </li>
...
$(document).ready(function(){
    ...
    <tr>
      <td align="left" valign="top" colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" height="580">
          <tr>
            <td width="80%" align="center" valign="top" height="5"><div class="clipboard_call"><a href="javascript:clipbord();">Show clipboard ...</a></div>
