...
//public:
	...
	function __construct($options = null) {
		...
		$this->_options['userIdField'] = 'user_id';
		...
		$this->_options['expires'] = 172800*15;	// 30 days.
	...
	function startSession() {
		...
		session_start();
		if( !empty($this->_options['sessionVariable']) && isset($_SESSION[($this->_options['sessionVariable'])]) )  {$_SESSION[($this->_options['sessionVariable'])];  }
