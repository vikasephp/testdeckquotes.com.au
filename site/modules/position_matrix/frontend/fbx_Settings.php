...
// module names
$MODULE_SINGULAR = 'Position Matrix';
$MODULE_PLURAL = 'Position Matrix';
...
$PPTABLE = 'position_matrix_explanation';
$PPID = 'pme_id';
$fwViewData['PPTABLE'] = $PPTABLE;
$fwViewData['PPID'] = $PPID;

$BASEFOLDER = 'position_matrix';
...
$XFA['multiple_doc_col'] = $Fusebox['circuit'] . '.multiple_doc_col';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/meeting_minutes_doc/'.$zipfile, S3::ACL_PUBLIC_READ)) {
