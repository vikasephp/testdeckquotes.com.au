	...
	<input type="hidden" name="pm[pm_id]" value="{{$detail.$ID}}" id="dh_id"/>
     <table id="viewdoc-table" width="100%" cellpadding="0" cellspacing="0" height="500" style="border:1px solid #CCC;">
        ...
        <tr>
            ...
            <input type="text" name="pm[pm_recruitment_text_link]" value="{{$detail.pm_recruitment_text_link}}" style="width:800px;" />
            </td>
		</tr>
				...
				<table border="1">
					<tr>
						<td> Master Document Link:<br/>
							<input type="text" name="pm[pm_key_result_stm_link]" value="{{$detail.pm_key_result_stm_link}}" style="width:800px;" />
						</td>
					</tr>
					<tr>
						<td> Public Document:<br/>
							<input type="text" name="pm[pm_key_result_stm_link_public]" value="{{$detail.pm_key_result_stm_link_public}}" style="width:800px;" />
						</td>
					</tr>
				</table>
            </td>
       ...
       <tr>
            ...
            <input type="text" name="pm[pm_pos_agreement_link]" value="{{$detail.pm_pos_agreement_link}}" style="width:800px;" />
            </td>
        </tr>
		...
		<tr>
            ...
            <td> <!--<input type="file" name="docs_4" /> -->
				<table border="1">
					<tr>
						<td> Master Document Link:<br/>
							<input type="text" name="pm[pm_letter_of_offer_link]" value="{{$detail.pm_letter_of_offer_link}}" style="width:800px;" />
						</td>
					</tr>
					<tr>
						<td> Public Document:<br/>
							<input type="text" name="pm[pm_letter_of_offer_link_public]" value="{{$detail.pm_letter_of_offer_link_public}}" style="width:800px;" />
						</td>
					</tr>
				</table>
            </td>
		...
		<tr>
            ...
            <td colspan="3"> <!--<input type="file" name="docs_5" />-->
				<table border="1">
					<tr>
						<td> Master Document Link:<br/>
							<input type="text" name="pm[pm_training_plan_link]" value="{{$detail.pm_training_plan_link}}" style="width:800px;" />
						</td>
					</tr>
					<tr>
						<td> Public Document:<br/>
							<input type="text" name="pm[pm_training_plan_link_public]" value="{{$detail.pm_training_plan_link_public}}" style="width:800px;" />
						</td>
					</tr>
				</table>
            </td>
