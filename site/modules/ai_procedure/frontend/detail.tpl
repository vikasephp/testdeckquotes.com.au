...
<table id="list-table" width="100%">
   ...
   {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
    ...
    <tr>
     <th>Name</th>
     <td><input type="text" name="{{$TABLE}}[ph_name]" style ="width:700px" value="{{$detail.ph_name}}" />
      </td>
    </tr>
   
   <tr>
     <th>Company</th>
     <td><input  type="text" name="{{$TABLE}}[ph_company]"  value="{{$detail.ph_company}}" style="width:700px;" /> </td>
    </tr>
   
   
   <tr>
     <th>Phone</th>
     <td><input  type="text" name="{{$TABLE}}[ph_phone]"  value="{{$detail.ph_phone}}" style="width:700px;" /> </td>
    </tr>
    
    
    <tr>
     <th>Email</th>
     <td><input  type="text" name="{{$TABLE}}[ph_email]"  value="{{$detail.ph_email}}" style="width:700px;" /> </td>
    </tr>
    ...
    <!--  <textarea rows="5" name="{{$TABLE}}[ph_message]" id="editor1" class="ckeditor">{{$detail.ph_message|stripslashes}}</textarea>-->
      <textarea rows="5"  cols="150" name="{{$TABLE}}[ph_message]" >{{$detail.ph_message|stripslashes}}</textarea>
     </td>
    </tr>
    
    <tr>
     <th>Who For</th>
     <td><input  type="text" name="{{$TABLE}}[ph_who_for]"  value="{{$detail.ph_who_for}}" style="width:700px;" /> </td>
    </tr> 
     
     <!--<tr>
     <th>Responsible Staff</th>
     <td> 
        <select name="{{$TABLE}}[ph_resp_staff]" >
...
<!--  <tr>
    ...
    <tr>
     <th>Status </th>
     <td><select name="{{$TABLE}}[ph_status]" style="width:300px;"/>
