...
// module names
$MODULE_SINGULAR = 'AI Repository';
$MODULE_PLURAL = 'AI Repositories';
...
$XFA['review_queue'] = $Fusebox['circuit'] . '.review_queue';
$XFA['hitl_review'] = $Fusebox['circuit'] . '.hitl_review';
$XFA['hitl_action'] = $Fusebox['circuit'] . '.hitl_action';