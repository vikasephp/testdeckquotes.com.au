...
foreach($setdata2 as $k => $v)
{
		...
		$link2 = "http://www.documentclick.com.au/site.documents/bsn_id/".$v['bsn_id'];	
		 ...
		 $sqlwa = "Select dpn_water_ref , dpn_electric_ref, dpn_gas_ref, dpn_storm_ref, dpn_unique_id from document_proposal_name 
    ...
    $chk = $fwDb->query($sql_chk);
		...
		$setdata2[$k]['doc_date_uploaded_491'] = changedate_d_m_y($data491['doc_date_uploaded']);
		$setdata2[$k]['out_c'] = $outdata['out_c'];
