...
// module names
$MODULE_SINGULAR = 'Strategic Alliance';
$MODULE_PLURAL =   'Strategic Alliance';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'strategic_alliance';
$ID = 'sa_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/asset_list/'.$zipfile, S3::ACL_PRIVATE)) {
