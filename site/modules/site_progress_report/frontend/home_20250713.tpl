		...
		<tbody>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td>
					<form name="recmet2" method="post" action="">
						<select name="{{$TABLE}}[sp_task_name]" onchange="update_task({{$item.sp_id}}, this.value)">
							...
							<option value="{{$item2.tn_id}}" {{if $item2.tn_id eq $item.sp_task_name }}
				...
				<td>
					...
					<a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_1}}&module_name=site_progress_report.home"
						target="_blank">Download</a><br />
					{{/if}}

					{{if $item.sp_attachment_2}}
					<a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_2}}&module_name=site_progress_report.home"
						target="_blank">Download</a><br />
					{{/if}}

					{{if $item.sp_attachment_3}}
					<a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_3}}&module_name=site_progress_report.home"
						target="_blank">Download</a><br />
					{{/if}}

					{{if $item.sp_attachment_4}}
					<a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_4}}&module_name=site_progress_report.home"
						target="_blank">Download</a><br />
					{{/if}}

					{{if $item.sp_attachment_5}}
					<a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_5}}&module_name=site_progress_report.home"
