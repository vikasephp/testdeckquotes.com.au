...
&nbsp; &nbsp;<input type="button" name="component" value="Edit Task Name" onclick="javascript:add_task();" /> <br />
    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                   ...
                   <th class="topmenu" align="center" valign="middle" width="15%">Attachments </th>
 ...
 {{foreach from=$list key="key" item="item"}}
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <form name ="recmet2" method="post" action="">
       	<select name="{{$TABLE}}[sp_task_name]"  onchange="update_task({{$item.sp_id}}, this.value)" >
          ...
          <script>
			function update_task(id,value)
			{
					 $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}site_progress_report.update_task/sp_id/"+id+"/value/"+value,
        ...
        {{if $item.sp_attachment_1}}
         <a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_1}}&module_name=site_progress_report.home" >Download</a><br /> 
        {{/if}}
        
        {{if $item.sp_attachment_2}}
         <a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_2}}&module_name=site_progress_report.home" >Download</a><br /> 
        {{/if}}
        
        {{if $item.sp_attachment_3}}
         <a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_3}}&module_name=site_progress_report.home" >Download</a><br /> 
        {{/if}}
        
        {{if $item.sp_attachment_4}}
         <a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_4}}&module_name=site_progress_report.home" >Download</a><br /> 
        {{/if}}
        
        {{if $item.sp_attachment_5}}
         <a href="/site_progress_report.download_content?file_name={{$item.sp_attachment_5}}&module_name=site_progress_report.home" >Download</a> 
        {{/if}}
