...
<script type="text/javascript">
	...
	function showContent(id) {
		var viewurl = "{{$BASE_URL}}{{$BASEFOLDER}}.attachments-and-comments?id=" + id;
		// console.log(viewurl);
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
	...
	<table id="list-table" class="nav-back" width="100%">
		...
		<tbody>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td>
					<input type="button" name="Link" value="Link" onclick="javascript:showContent({{$item.$ID}});" style="width:75px; height:18px; font-size:11px; line-height:17px !important; padding:0px !important" />
				</td>
				<td>
