...
$fwViewData['construction_handover'] = MODULES_DIR.'construction_scheduler_report/frontend/construction_handover.tpl';
$fwViewData['calendar'] = MODULES_DIR.'construction_scheduler_report/frontend/calendar.tpl';
$fwViewData['floor_system'] = MODULES_DIR.'construction_scheduler_report/frontend/floor_system.tpl';
$fwViewData['close_up'] = MODULES_DIR.'construction_scheduler_report/frontend/close_up.tpl';
$fwViewData['walkthrough'] = MODULES_DIR.'construction_scheduler_report/frontend/walkthrough.tpl';
$fwViewData['purchase_order'] = MODULES_DIR.'quote_tracking_report/frontend/purchase_order.tpl';

$fwViewData['floorsystem'] = MODULES_DIR.'certifier_structural_engineer/frontend/floorsystem.tpl';
$fwViewData['pre_sheet'] =   MODULES_DIR.'certifier_structural_engineer/frontend/pre_sheet.tpl';
$fwViewData['final'] =   MODULES_DIR.'certifier_structural_engineer/frontend/final.tpl';

$fwViewData['project_view'] = MODULES_DIR.'property_sale_project_tracker/frontend/project_view.tpl';
$fwViewData['task_table'] =   MODULES_DIR.'property_sale_project_tracker/frontend/task_table.tpl';
$fwViewData['productpage'] =   MODULES_DIR.'business/frontend/productpage.tpl';
$fwViewData['json_script_data'] = '';
$fwViewData['blank_page'] = false;
