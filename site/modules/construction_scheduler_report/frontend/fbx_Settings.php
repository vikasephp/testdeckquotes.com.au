...
// module names
$MODULE_SINGULAR = 'Construction Scheduler Report';
$MODULE_PLURAL =   'Construction Scheduler Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'construction_scheduler_report';
$ID = 'cs_id';
	...
	include_once $filetoinclude;
        ...
        try {
          ...
          $s3 = new S3(ACCESS_KEY, SECRET_KEY);
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/roofing_report/'.$zipfile, S3::ACL_PRIVATE)) {
