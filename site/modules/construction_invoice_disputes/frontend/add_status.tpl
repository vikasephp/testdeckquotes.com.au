...
<script type="text/javascript">
	...
	window.location.href = "{{$BASE_URL}}{{ $BASEFOLDER }}.{{ $ATTRIBUTES.status.view_fle_name }}";
</script>
{{/if}}
		...
		<table id="list-table" width="100%">
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="task[{{ $ATTRIBUTES.status.option_col }}]" style="width:700px" value="{{ $detail.$option_col }}" />
				</td>
			</tr>
			<tr>
