<?php
$fwMainView = 'file:' . getcwd() . '/' . $ATTRIBUTES['severity']['add_file'];

$fwViewData['primary_id'] = $primary_id = $ATTRIBUTES['severity']['id'];
$tableTask = new Fw_Db_Table($ATTRIBUTES['severity']['table']);
