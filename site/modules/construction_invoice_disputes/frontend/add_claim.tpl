...
<script type="text/javascript">
	...
	window.location.href = "{{$BASE_URL}}{{ $BASEFOLDER }}.{{ $ATTRIBUTES.claim.view_fle_name }}";
</script>
{{/if}}
<div align="center" style="min-height:350px; margin-top:50px; z-index:999999 !important;">
	<h3 class="page-title">Add/Edit New {{ $ATTRIBUTES.claim.name }}</h3>
		...
		<table id="list-table" width="100%">
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="task[{{ $ATTRIBUTES.claim.option_col }}]" style="width:700px" value="{{ $detail.$option_col }}" />
				</td>
			</tr>
			<tr>
