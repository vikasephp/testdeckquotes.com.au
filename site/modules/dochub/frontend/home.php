...
if(!empty($submit))
	...
	else{$sql = "SELECT ".$TABLE.".*, users.user_name FROM ".$TABLE." LEFT JOIN users ON users.user_id = ".$TABLE.".dh_author ".$order;}
...
foreach($setdata as $k => $v)
		{
		$docid = $v['dh_id'];
		$sqldocs = "SELECT document_hub_docs.* FROM document_hub_docs WHERE document_hub_docs.dhd_dh_id = ".$docid;
...
$fwViewData['title'] = "Procedure Master List";