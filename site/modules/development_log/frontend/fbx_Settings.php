...
// module names
$MODULE_SINGULAR = 'Development Log';
$MODULE_PLURAL =   'Development Log';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/development_log/'.$zipfile, S3::ACL_PUBLIC_READ)) {
