...
<div id="">
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                <th class="topmenu" align="center" valign="middle" width="2%">CLID</th>   
                <th class="topmenu" align="center" valign="middle" width="30%">Overview</th> 
                <th class="topmenu" align="center" valign="middle" width="35%">Link</th>
...
<tbody>
 {{foreach from=$list key="key" item="item"}}
    ...
    <td style="color:#000;">{{$item.cl_id}}</td>
    <td style="color:#000;">{{$item.cl_overview}}</td> 
    <td style="color:#000;"><a href = "{{$item.cl_link}}" target="_blank"> {{$item.cl_link}} </a> </td>
