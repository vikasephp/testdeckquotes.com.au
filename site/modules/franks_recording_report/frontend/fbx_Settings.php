...
// module names
$MODULE_SINGULAR = 'Franks Recordings Report';
$MODULE_PLURAL =   'Franks Recordings Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'franks_recording_report';
$ID = 'fr_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/franks_recordings/'.$zipfile, S3::ACL_PRIVATE)) {
