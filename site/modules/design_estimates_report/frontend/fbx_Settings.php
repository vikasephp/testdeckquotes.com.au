...
// module names
$MODULE_SINGULAR = 'Design Estimates Report';
$MODULE_PLURAL = 'Design Estimates Report';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;
$fwViewData['BASEFOLDER'] = 'design_estimates_report';
...
$XFA['home_active'] = $Fusebox['circuit'] . '.home_active';
...
function dm_report($heading, $html)
		{
...
$pdf->SetTitle("CGFB");
$pdf->SetSubject('Design Management Report');
...
function merge_print_report($heading, $html, $project)
		{
...
$nameoffile = 'customer_design_update_letter_'.$project;
...
//$pdf->SetTitle('Answer - ".date("d/m/Y")."<br>TurnKeyStudios Project Sales');
$pdf->SetTitle("CGFB");
$pdf->SetSubject('Customer Design Update Letter');
$pdf->SetKeywords('GCON, PDF');
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, $headtext, "Canberra Granny Flat Builders");
...
function create_conversion_pdf($heading, $html, $fname)
		{
