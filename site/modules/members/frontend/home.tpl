    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                ...
                <th class="topmenu" align="center" valign="middle">Email</th>
                <th class="topmenu" align="center" valign="middle">Mobile</th>
                <th class="topmenu" align="center" valign="middle">Member Joined</th>
                <th class="topmenu" align="center" valign="middle">Last Activity</th>
                <th class="topmenu" align="center" valign="middle">Last Logon</th>
                <th class="topmenu" align="center" valign="middle">Member Status</th>
            </tr>
        </thead>
        <tbody>
			{{assign var="mem_count" value=1}}
            {{ foreach from=$list key="key" item="item" }}
            <tr bgcolor='{{ cycle values=" #D3E8D6,WHITE" advance=true }}'>
                <td data-col="sn">{{$mem_count}}</td>
				<td>{{$item.name}}</td>
				<td>{{$item.email}}</td>
				<td>{{$item.mobile}}</td>
				<td>{{$item.member_joined|date_format:"%d %b %Y"}}</td>
				<td>{{$item.last_activity}}</td>
				<td>{{$item.last_logon|date_format:"%d %b %Y"}}</td>
