...
// module names
$MODULE_SINGULAR = 'Weekly Payment Report';
$MODULE_PLURAL =   'Weekly Payment Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'weekly_payment_report';
$ID = 'wp_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/weekly_payment/'.$zipfile, S3::ACL_PRIVATE)) {
