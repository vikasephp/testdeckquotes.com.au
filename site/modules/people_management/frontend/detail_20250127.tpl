...
<div align="center">
  ...
  <form name="createadmin" id="createadmin" method="post" action="{{$BASE_URL}}{{$XFA.detail}}" enctype="multipart/form-data">
    ...
    <table id="EMP-list-table" width="100%" style="border-collapse:collapse;">
      ...
      <tr>
        ...
        <td><input class="input lrg" name="user_username" type="text" maxlength="132" value="{{$detail.user_username}}" autocomplete="off" /></td>
      ...
      <tr>
        ...
        <td colspan="3"><input class="input lrg" name="{{$TABLE}}[customer_tax_num]" type="text" maxlength="11" value="{{$detail.customer_tax_num}}"/></td>
      </tr>
      <tr>
        <th class="labelhead">Positions:</th>
        <td colspan="3"><select name="{{$TABLE}}[user_positions][]" multiple="multiple" size="10" class="vlrg" >
    ...
    <td>{{if $detail.customer_auscitizen_attached}}<div class="customer_auscitizen_attached"><a href="{{$BASE_URL}}files/user_docs/{{$detail.customer_auscitizen_attached}}" target="_blank" title="{{$detail.customer_auscitizen_attached}}">{{$detail.customer_auscitizen_attached|truncate:"35"}}</a>&nbsp;<a href="{{$BASE_URL}}people_management.del/delfield/customer_auscitizen_attached" class="del-docs" id="customer_auscitizen_attached"><img src="{{$BASE_URL}}images/DeleteRed_new.gif" width="20" /> </a></div>{{/if}}</td>		
</tr></table>
       </td>
      </tr>
    ...
    <td>{{if $detail.customer_white_card_attached}}<div class="customer_white_card_attached"><a href="{{$BASE_URL}}files/user_docs/{{$detail.customer_white_card_attached}}" target="_blank" title="{{$detail.customer_white_card_attached}}">{{$detail.customer_white_card_attached|truncate:"35"}}</a><a href="{{$BASE_URL}}people_management.del/delfield/customer_white_card_attached" id="customer_white_card_attached" class="del-docs">&nbsp;<img src="{{$BASE_URL}}images/DeleteRed_new.gif" width="20" /></a></div>{{/if}}</td>		
</tr></table>
       </td>
      </tr> 
        <tr>
      ...
      <tr>
       <th><strong>Number:</strong>&nbsp;</th><th><input class="input lrg" name="{{$TABLE}}[customer_dld_number]" type="text"  value="{{$detail.customer_dld_number}}"/></th></tr><tr>
       <th><strong>Class:</strong>&nbsp;</th><th><input class="input lrg" name="{{$TABLE}}[customer_dld_class]" type="text"  value="{{$detail.customer_dld_class}}"/></th></tr><tr>
       <th><strong>Restrictions:</strong>&nbsp;</th><th><input class="input lrg" name="{{$TABLE}}[customer_dld_rest]" type="text" value="{{$detail.customer_dld_rest}}"/></th></tr><tr><th><strong>Type:</strong>&nbsp;</th><th><select name="{{$TABLE}}[customer_dld_type]">
        ...
        <td width="40%"><strong>Upload</strong>:&nbsp;<input type="file" name="dfile" id="dfile" style="width:150px;" /><br /><br /><br />{{if $detail.customer_dld_attached}}<div class="customer_dld_attached"><a href="{{$BASE_URL}}files/user_docs/{{$detail.customer_dld_attached}}" target="_blank" title="{{$detail.customer_dld_attached}}">{{$detail.customer_dld_attached|truncate:"35"}}</a>&nbsp;&nbsp;<a href="{{$BASE_URL}}people_management.del/delfield/customer_dld_attached" class="del-docs" id="customer_dld_attached"><img src="{{$BASE_URL}}images/DeleteRed_new.gif" width="20" /></a></div>{{/if}}</td>
            </tr>
        	</table>
        </td>
      </tr> 
       ...
       <td>{{if $detail.customer_formail_qua}}<div class="customer_formail_qua"><a href="{{$BASE_URL}}files/user_docs/{{$detail.customer_formail_qua}}" target="_blank" title="{{$detail.customer_formail_qua}}">{{$detail.customer_formail_qua|truncate:"35"}}</a>&nbsp;&nbsp;<a href="{{$BASE_URL}}people_management.del/delfield/customer_formail_qua" class="del-docs" id="customer_formail_qua"><img src="{{$BASE_URL}}images/DeleteRed_new.gif" width="20" /></a></div>{{/if}}</td>
      </tr>
