      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
       ...
       <option value="5" {{if $item.meet eq 5}} selected="selected" {{/if}}> Email and Post Reports   </option>
        ...
        <td style="text-align:center;" >
           <!-- <a href = "https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$item.checklist44}}?dummy={{$ran}}" target="_blank">Download</a>-->
     <a href = "/planning_assesment_oldreport.download_content?file_name={{$item.checklist44}}&module_name=planning_assesment_oldreport.home" target="_blank">Download</a>       
        </td>
        {{else}}
	...
	function update(id,value)
	{
	 ...
	 $.ajax({
        ...
        <td style="text-align:center;" >
         ...
         <a href = "/planning_assesment_oldreport.download_content?file_name={{$item.checklist45}}&module_name=planning_assesment_oldreport.home" target="_blank">Download</a>   
       ...
       <a href = "/planning_assesment_oldreport.download_content?file_name={{$item.checklist2}}&module_name=planning_assesment_oldreport.home" target="_blank">Download</a>
      ...
      {{if $item.uid137complete eq 1 }}
       ...
       {{if $item.uid206complete eq 1 }}
        ...
        <td style="text-align:center;" >
          ...
          <a href = "/planning_assesment_oldreport.download_content?file_name={{$item.checklist412}}&module_name=planning_assesment_oldreport.home" target="_blank">Download</a>
        </td>
        {{else}}
        	<td style="background:#F00"> </td>
        {{/if}}
