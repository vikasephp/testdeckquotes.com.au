...
<script type="text/javascript">
	...
	function view_appoint_email() {
		var viewurl = "{{$BASE_URL}}upcoming_10_days_par_appointment.send_email_template" + "/random/" + Math.random();
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
				'height': '99%',
...
<form name="mshort" action="{{$BASE_URL}}{{$XFA.home}}" method="post">
	...
	<div style="float:right;">
		<input type="button" name="view_appoint_btn" value="Send Email" onclick="javascript:view_appoint_email();" />&nbsp;&nbsp;
