...
// module names
$MODULE_SINGULAR = 'Project Law';
$MODULE_PLURAL = 'Project Laws';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/business_laws/'.$zipfile, S3::ACL_PRIVATE)) {
