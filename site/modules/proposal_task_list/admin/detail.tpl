...
<!--            <tr>
          ...
          <td colspan="2">  
		   ...
		   <script type="text/javascript">
				...
				function update_subtask(bsst_id)
				{
				    ...
				    url: "{{$BASE_URL}}/proposal_task_listAdmin.subtask_save/bsst_id/"+bsst_id+"/value/"+value,
				   // data: "bsn_id =" + id,
		...
		function delete_link_proc_task(btp_id)
				{
				    ...
				    url: "{{$BASE_URL}}/proposal_task_listAdmin.delete_task_procedure/btp_id/"+btp_id,
				   // data: "bsn_id =" + id,
				   success: function(result){
					// $("#somewhere").html(result);
				   }
		...
		function delete_link_proc_subtask(bstlp_id)
				{
				    ...
				    url: "{{$BASE_URL}}/proposal_task_listAdmin.delete_subtask_lp/bstlp_id/"+bstlp_id,
				   // data: "bsn_id =" + id,
				   success: function(result){
					// $("#somewhere").html(result);
				   }
    ...
    {{if $subtask_detail}}
        ...
        {{foreach from=$subtask_detail item=item2 key=key2}}
         <a href="{{$BASE_URL}}proposal_task_listAdmin.delete_subtask/bsst_id/{{$item2.bsst_id}}/bst_id/{{$bst_id}}" title="Delete" >
       ...
       {{/if}}
			 ...
			 function update_emaillink(pel_id)
				{
				    ...
				    url: "{{$BASE_URL}}/proposal_task_listAdmin.emaillink_save/pel_id/"+pel_id+"/value/"+value,
				    success: function(result){
					// $("#somewhere").html(result);
				   }
				 });
        ...
        {{if $emaillink_detail}}
            ...
            {{foreach from=$emaillink_detail item=item3 key=key3}}
             <a href="{{$BASE_URL}}proposal_task_listAdmin.delete_emaillink/pel_id/{{$item3.pel_id}}/pel_task_id/{{$bst_id}}" title="Delete" >
                <img src="{{$BASE_URL}}css/admin/images/deletecross.png"/></a>
