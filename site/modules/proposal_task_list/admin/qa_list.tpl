<h3 class="page-title">Proposal Task List Question Answer</h3>
    ...
    <table id="list-table" class="nav-back" width="100%">
        ...
        {{foreach from=$list key="key" item="item"}}
            <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
             ...
             <td>
                    <a href="{{$BASE_URL}}proposal_task_listAdmin.qa_add/ps_id/{{$item.ps_id}}"><img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/edit.png"/></a>
