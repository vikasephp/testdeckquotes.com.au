...
$plinkedemail = new Fw_Db_Table('proposal_task_list_email_link');


$tableQA = new Fw_Db_Table('proposal_que_ans');
...
$sql = " Select  proposal_task_list.*, positions.p_name from  proposal_task_list
         Inner join positions on  proposal_task_list.bst_posid = positions.p_id 
		 " . $where . " Order by proposal_task_list.bst_order ";
...
//		}
		...
		$html .= "<p><b>Task Type</b> : Proposal </p>";
