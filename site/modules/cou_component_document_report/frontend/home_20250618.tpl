...
&nbsp; &nbsp;<input type="submit" name="print" value = "Merge Print" /> <br />
...
&nbsp; &nbsp;<strong> Filter By Sub Status: </strong> 
...
<div  style="float:left; width:100%;">
  ...
  <table  id="doclist-table" class="nav-back" width="100%">
    <thead>
      <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="3%">Building Approval</th>
        <th class="topmenu" align="center" valign="middle" width="3%">Commencement Notice</th>
        <th class="topmenu" align="center" valign="middle" width="3%">BA stamped plans</th>
        <th class="topmenu" align="center" valign="middle" width="3%">Latest Merged Plans</th>
        <th class="topmenu" align="center" valign="middle" width="3%">Certificate of Occupancy</th>
        <th class="topmenu" align="center" valign="middle" width="3%">Link</th>
 		<th class="topmenu" align="center" valign="middle" width="3%">Status</th>
        <th class="topmenu" align="center" valign="middle" width="3%">Customer Has<br />Taken The Occupancy</th>
        <th class="topmenu" align="center" valign="middle" width="3%">Sub Status</th>
        <th class="topmenu" align="center" valign="middle" width="3%">What is holding up your COO</th>
        <th class="topmenu" align="center" valign="middle" width="3%">COO Compliance Advice</th>
        <th class="topmenu" align="center" valign="middle" width="3%">Weekly Update Letters </th>
        <th class="topmenu" align="center" valign="middle" width="3%">Weekly Letter to be sent</th>
        <th class="topmenu" align="center" valign="middle" width="3%">Letter Text</th> 
        <th class="topmenu" align="center" valign="middle" width="3%">Notes</th>
    ...
    <tbody>
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
        ...
        <td {{if $item.cs_ch_user}} style="background: #0C3;" {{/if}}>
          <a href="{{$BASE_URL}}cou_component_document_report.qa_ch/bsn_id/{{$item.bsn_id}}" class="various">QA</a><br />
       ...
       <a href="{{$BASE_URL}}cou_component_document_report.colorbox/bsn_id/{{$item.bsn_id}}" class="various">Color</a>
       <br /><br />{{$item.bs_cou_tl_user }}<br />{{$item.bs_cou_tl_date}}<br />
        <a href="{{$BASE_URL}}cou_component_document_report.reason/bsn_id/{{$item.bsn_id}}" class="various">Read</a>
       </td>
       ...
       {{else }}
       <td>
       <a href="{{$BASE_URL}}cou_component_document_report.colorbox/bsn_id/{{$item.bsn_id}}" class="various">Color</a></td>
       {{/if}}
         
       
         
         
        <td {{if $item.doc_file_name_232}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_232 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond1{{$item.bsn_id}}">
       ...
       {{else}}
         <select name="cou32[{{$item.bsn_id}}]" onChange="update_req_notreq_1({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_232 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_232 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       {{/if}}
       </td>
       
        <td {{if $item.doc_file_name_235}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_235 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond1{{$item.bsn_id}}">
       ...
       {{else}}
         <select name="cou35[{{$item.bsn_id}}]" onChange="update_req_notreq_1({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_235 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_235 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       {{/if}}
       </td>
       
        <td {{if $item.doc_file_name_231}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_231 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond1{{$item.bsn_id}}">
       ...
       <a href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_231}}&module_name=cou_component_document_report.home" >Download</a>
        ...
        {{else}}
         <select  name="cou1[{{$item.bsn_id}}]" onChange="update_req_notreq_1({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_231 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_231 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
        ...
        <!--<td {{if $item.doc_file_name_491}} style="background:#0C0;" {{/if}}>-->
        
        <td {{if $item.doc_file_name_491}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_491 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond2{{$item.bsn_id}}">
        ...
        {{if $item.doc_file_name_491}}
         ...
         {{else}}
         <select name="cou1[{{$item.bsn_id}}]" onChange="update_req_notreq_2({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_491 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_491 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
        ...
        <td>{{if $item.doc_file_name_173}}
           <a href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_173}}&module_name=cou_component_document_report.home" >Download</a> <br /> {{$item.doc_date_uploaded_173}}
           {{/if}}
           </td>
        ...
        <form name ="recmet3" method="post" action="">
            ...
            <label class="switch">
            <input class="switch-input" type="checkbox"  name="occupancy[{{$item.bs_business_id}}]" value="1"  onclick="this.form.submit();" {{if $item.bs_cou_cust_occupancy eq 1 }} checked="checked" {{/if}} />
        ...
        <select name="sub_status[{{$item.bsn_id}}]" onchange="this.form.submit();">
         ...
         {{foreach from=$statusData key="key2" item="item2"}}
         	<option value="{{$item2.st_id}}" {{if $item.bs_cou_sub_status eq $item2.st_id }} selected="selected" {{/if}}>{{$item2.st_option}}</option>
         {{/foreach}}
         </select>
        ...
        <td>
            ...
            <div id="hold{{$item.bs_business_id}}">{{$item.bs_holding_user}} <br />{{$item.bs_holding_date}} </div> 
 ...
 <form name="ca" method="post" enctype="multipart/form-data"> 
        ...
        <div style="text-align:center;"> 
           <a href="/cou_component_document_report.download_content_we?file_name={{$item.bs_cou_comp_advice}}&module_name=cou_component_document_report.home" target="_blank">Download</a>
        
        <a href="{{$BASE_URL}}cou_component_document_report.delete_comp/bs_business_id/{{$item.bs_business_id}}" onclick="javascript:if(!confirm('Are you sure want to delete?')) return false;" title="Delete"><img src="{{$BASE_URL}}/images/delete_icon.png" width="20" /></a>
        <br />{{if $item.bs_cou_comp_advice}}{{$item.bs_cou_comp_user}}<br />{{$item.bs_cou_comp_date}} {{/if}}
         </div> {{/if}}
        <input type= "submit" name="save_compliance" title="Save" value="Upload" class="set2"> &nbsp; 
        </form>
        ...
        <a href="{{$BASE_URL}}cou_component_document_report.delete_cal/bs_business_id/{{$item.bs_business_id}}" onclick="javascript:if(!confirm('Are you sure want to delete?')) return false;" title="Delete"><img src="{{$BASE_URL}}/images/delete_icon.png" width="20" /></a>
        <br />{{if $item.bs_cou_weekly}}{{$item.bs_cou_weekly_user}}<br />{{$item.bs_cou_weekly_date}} {{/if}}
         </div> {{/if}}
        ...
        <td>
         <form name ="recmet3" method="post" action="">
            ...
            <label class="switch">
            <input class="switch-input" type="checkbox"  name="letter_tobe[{{$item.bs_business_id}}]" value="1"  onclick="this.form.submit();" {{if $item.bs_cou_letter_tobe eq 1 }} checked="checked" {{/if}} />
            <span class="switch-label" data-on="Yes" data-off="No"></span> 
            <span class="switch-handle"></span> <br />
            </label> 
            </form> 
        ...
        <td> <select name="letter[{{$item.bs_business_id}}]" Onchange = "update_letter({{$item.bs_business_id}},this.value)" >
           <option value="">Please Select</option>
          {{foreach from=$letterData key="key2" item="item2"}}
          <option value="{{$item2.lt_code}}"    {{if $item2.lt_code eq $item.bs_cou_letter_text}} selected="selected" {{/if}}>{{$item2.lt_code}}
          </option>
          {{/foreach}}
          </select>
         <div id="usr2{{$item.bs_business_id}}">{{$item.bs_cou_letter_text_date}}<br />{{$item.bs_cou_letter_text_user}} </div>
	 <script>
        ...
        <td>
        <textarea rows="4" cols="40" id="notes{{$item.bs_business_id}}" style="overflow-y: scroll;">{{$item.bs_cou_notes}}</textarea> 
            <div id="cond{{$item.bs_business_id}}">{{$item.bs_cou_notes_user}} <br />{{$item.bs_cou_notes_date}} </div> 
	   ...
	   function update_notes(id,value)
        ...
        <td>
         <a href="{{$BASE_URL}}cou_component_document_report.view_construction_alert/bsn_id/{{$item.bsn_id}}" class="various">Construction Alert</a>
        </td>
        

        <td {{if $item.doc_file_name_172}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_172 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond3{{$item.bsn_id}}">
          ...
          {{if $item.doc_file_name_172}}
           <a href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_172}}&module_name=cou_component_document_report.home" >Download</a>
            {{else}}
         <select name="cou3[{{$item.bsn_id}}]" onChange="update_req_notreq_3({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_172 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_172 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       ...
       <td {{if $item.doc_file_name_169}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_169 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond4{{$item.bsn_id}}">
          ...
          {{else}}
         <select name="cou4[{{$item.bsn_id}}]" onChange="update_req_notreq_4({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_169 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_169 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
        ...
        <td> 
            ...
            <label class="switch">
            <input class="switch-input" type="checkbox"  name="application[{{$item.bsn_id}}]" value="1"  onclick="this.form.submit();" {{if $item.bs_cou_application eq 1 }} checked="checked" {{/if}} />
            <span class="switch-label" data-on="Yes" data-off="No"></span> 
            <span class="switch-handle"></span> <br />
            </label> 
            </form>  
            {{if $item.bs_cou_application eq 1 }} {{$item.bs_cou_appl_date}}<br />{{$item.bs_cou_appl_user}} {{/if}}
        </td>
        
        <td {{if $item.doc_file_name_261}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_261 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond6{{$item.bsn_id}}">
         ...
         {{else}}
         <select name="cou6[{{$item.bsn_id}}]" onChange="update_req_notreq_6({{$item.bsn_id}}, this.value)" >
		...
		function update_req_notreq_6(id,value)
		{
          ...
          {{elseif $item.doc_not_required_155 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond7{{$item.bsn_id}}">
            ...
            {{else}}
         <select name="cou7[{{$item.bsn_id}}]" onChange="update_req_notreq_7({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_155 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_155 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       ...
       <td {{if $item.doc_file_name_295}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_295 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond8{{$item.bsn_id}}">
           ...
           {{else}}
         <select  name="cou8[{{$item.bsn_id}}]" onChange="update_req_notreq_8({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_295 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_295 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
        ...
        <td {{if $item.doc_file_name_413}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_413 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond9{{$item.bsn_id}}">
           ...
           {{else}}
         <select  name="cou9[{{$item.bsn_id}}]" onChange="update_req_notreq_9({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_413 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_413 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_9(id,value)
		{
           ...
           <td {{if $item.doc_file_name_156}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_156 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond10{{$item.bsn_id}}">
            ...
            {{else}}
         <select  name="cou10[{{$item.bsn_id}}]" onChange="update_req_notreq_10({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_156 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_156 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
        ...
        <td {{if $item.doc_file_name_735}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_735 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond21{{$item.bsn_id}}">
            ...
            {{else}}
         <select  name="cou21[{{$item.bsn_id}}]" onChange="update_req_notreq_21({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_735 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_735 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
        ...
        <td {{if $item.doc_file_name_736}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_736 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond22{{$item.bsn_id}}">
            ...
            {{else}}
         <select  name="cou22[{{$item.bsn_id}}]" onChange="update_req_notreq_22({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_736 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_736 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_22(id,value)
		{
         ...
         <td {{if $item.doc_file_name_737}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_737 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond26{{$item.bsn_id}}">
            ...
            {{else}}
         <select  name="cou26[{{$item.bsn_id}}]" onChange="update_req_notreq_26({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_737 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_737 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       ...
       <td {{if $item.doc_file_name_738}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_738 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond23{{$item.bsn_id}}">
            ...
            {{else}}
         <select name="cou23[{{$item.bsn_id}}]" onChange="update_req_notreq_23({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_738 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_738 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_23(id,value)
		{
          ...
          {{elseif $item.doc_not_required_289 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond11{{$item.bsn_id}}">
             ...
             {{else}}
         <select  name="cou11[{{$item.bsn_id}}]" onChange="update_req_notreq_11({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_289 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_289 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
        ...
        <td {{if $item.doc_file_name_162}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_162 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond12{{$item.bsn_id}}">
       ...
       {{else}}
         <select name="cou12[{{$item.bsn_id}}]" onChange="update_req_notreq_12({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_162 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_162 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       ...
       <td {{if $item.doc_file_name_163}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_163 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond13{{$item.bsn_id}}">
        ...
        {{else}}
         <select  name="cou13[{{$item.bsn_id}}]" onChange="update_req_notreq_13({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_163 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_163 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_13(id,value)
		{
           ...
           <td {{if $item.doc_file_name_296}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_296 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond14{{$item.bsn_id}}">
          ...
          {{else}}
         <select  name="cou14[{{$item.bsn_id}}]" onChange="update_req_notreq_14({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_296 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_296 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_14(id,value)
		{
          ...
          <td {{if $item.doc_file_name_713}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_713 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond24{{$item.bsn_id}}">
            ...
            {{else}}
         <select  name="cou24[{{$item.bsn_id}}]" onChange="update_req_notreq_24({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_713 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_713 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       ...
       <td {{if $item.doc_file_name_714}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_714 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond25{{$item.bsn_id}}">
            ...
            {{else}}
         <select name="cou25[{{$item.bsn_id}}]" onChange="update_req_notreq_25({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_714 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_714 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       ...
       <td {{if $item.doc_file_name_739}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_739 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond28{{$item.bsn_id}}">
            ...
            {{else}}
        <select  name="cou28[{{$item.bsn_id}}]" onChange="update_req_notreq_28({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_739 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_739 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_28(id,value)
		{
         ...
         <td {{if $item.doc_file_name_274}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_274 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond17{{$item.bsn_id}}">
            ...
            {{if $item.doc_file_name_274}}
             ...
             {{else}}
         <select  name="cou17[{{$item.bsn_id}}]" onChange="update_req_notreq_17({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_274 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_274 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_17(id,value)
		{
            ...
            <td {{if $item.doc_file_name_294}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_294 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond15{{$item.bsn_id}}">
         ...
         {{else}}
         <select name="cou15[{{$item.bsn_id}}]" onChange="update_req_notreq_15({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_294 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_294 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_15(id,value)
		{
           ...
           <td {{if $item.doc_file_name_167}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_167 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond16{{$item.bsn_id}}">
            ...
            {{else}}
         <select name="cou16[{{$item.bsn_id}}]" onChange="update_req_notreq_16({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_167 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_167 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       ...
       <td {{if $item.doc_file_name_749}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_749 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond29{{$item.bsn_id}}">
    	    {{if $item.doc_file_name_749}}
             ...
             {{else}}
        <select name="cou29{{$item.bsn_id}}]" onChange="update_req_notreq_29({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_749 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_749 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_29(id,value)
		{
         ...
         <td {{if $item.doc_file_name_626}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_626 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond27{{$item.bsn_id}}">
    	    {{if $item.doc_file_name_626}}
             ...
             {{else}}
        <select name="cou27{{$item.bsn_id}}]" onChange="update_req_notreq_27({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_626 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_626 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
		...
		function update_req_notreq_27(id,value)
		{
         ...
         <td {{if $item.doc_file_name_691}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_691 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond19{{$item.bsn_id}}">
    	    {{if $item.doc_file_name_691}}
             ...
             {{else}}
         <select name="cou19[{{$item.bsn_id}}]" onChange="update_req_notreq_19({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_691 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_691 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
        ...
        <td {{if $item.doc_file_name_637}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_637 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond19{{$item.bsn_id}}">
    	    {{if $item.doc_file_name_637}}
             ...
             {{else}}
         <select name="cou20[{{$item.bsn_id}}]" onChange="update_req_notreq_20({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_637 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_637 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
       ...
       <td {{if $item.doc_file_name_149}} style="background:#00CC33;" 
          {{elseif $item.doc_not_required_149 eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "cond18{{$item.bsn_id}}">
    	    {{if $item.doc_file_name_149}}
             ...
             {{else}}
         <select name="cou18[{{$item.bsn_id}}]" onChange="update_req_notreq_18({{$item.bsn_id}}, this.value)" >
        <option value="0" {{if $item.doc_not_required_149 eq 0 }} selected="selected" {{/if}}>Required</option>
        <option value="1" {{if $item.doc_not_required_149 eq 1 }} selected="selected" {{/if}}>Not Required</option>
        </select>
  	...
  	<label class="switch">
<input class="switch-input" type="checkbox"  name="rem_war[{{$item.bs_business_id}}]" value="1"  onclick="this.form.submit();" {{if $item.bs_cou_remove_warranty eq 1 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
       </label> 
       </form>  
  	...
  	<label class="switch">
<input class="switch-input" type="checkbox"  name="hide[{{$item.bsn_id}}]" value="1"  onclick="this.form.submit();" {{if $item.bs_cou_hide eq 1 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
       </label> 
       </form>  
