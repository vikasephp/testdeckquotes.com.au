...
<form name="mlist" method="post" enctype="multipart/form-data">
	...
	<div style="float:left; text-align:left;">
		...
		&nbsp; &nbsp; <input type="button" name="status_options" value="Sub Status Admin"
			onclick="javascript:add_status();" />
		&nbsp; &nbsp; <input type="button" name="Add New" value="Letter Text Admin"
			onclick="javascript:add_letter();" />
		...
		<option value="{{$item3.st_id}}" {{if $item3.st_id eq $status}} selected="selected" {{/if}}>{{$item3.st_name}}
		</option>
		{{/foreach}}
		</select>
		...
		<option value="{{$item4.st_id}}" {{if $item4.st_id eq $status}} selected="selected" {{/if}}>{{$item4.st_option}}
		</option>
		{{/foreach}}
		</select>
			...
			<table id="doclist-table" class="nav-back" width="100%">
				<thead>
					<tr>
						...
						<th class="topmenu" align="center" valign="middle" width="3%" data-col="urgency">Urgency</th>
						...
						<th class="topmenu" align="center" valign="middle" width="3%">Customer Has<br />Taken The
							Occupancy</th>
						...
						<th class="topmenu" align="center" valign="middle" width="6%">Wall and Roof Frames Detail Plans
						</th>
						...
						<th class="topmenu" align="center" valign="middle" width="6%">Slip Resistance Certificate-
							Interior Stairs</th>
						<th class="topmenu" align="center" valign="middle" width="6%">Slip Resistance Certificate-
							Exterior Stairs and Landing</th>
						<th class="topmenu" align="center" valign="middle" width="6%">Fire Rated Certificate</th>

						<th class="topmenu" align="center" valign="middle" width="6%">Application of certificate of
							occupancy - signed by customer</th>
						<th class="topmenu" align="center" valign="middle" width="6%">Certificate of Electrical Safety -
							Electrician</th>
						<th class="topmenu" align="center" valign="middle" width="6%">Certificate of Electrical Safety -
							Air Conditioning</th>
						...
						<th class="topmenu" align="center" valign="middle" width="6%">Post-Construction Dilapidation
							Report</th>
						<th class="topmenu" align="center" valign="middle" width="6%">Building Approval Amendment
							Authorisation</th>
						<th class="topmenu" align="center" valign="middle" width="6%">Amended Drainage Plan</th>
						<th class="topmenu" align="center" valign="middle" width="6%">Has Been Removed From Warranty
							List</th>
				...
				<tbody>
					...
					<tr bgcolor="{{cycle values=" #D3E8D6,WHITE" advance=true}}">
						...
						{{else }}
							...
							<td {{if $item.doc_file_name_232}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_232}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_235}} style="background:#00CC33;" {{elseif
								$item.doc_not_required_235 eq 0}} style="background:#F00;" {{else}}
								style="background:#999;" {{/if}} id="cond1{{$item.bsn_id}}">

								{{if $item.doc_file_name_235}}
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_235}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_231}} style="background:#00CC33;" {{elseif
								$item.doc_not_required_231 eq 0}} style="background:#F00;" {{else}}
								style="background:#999;" {{/if}} id="cond1{{$item.bsn_id}}">

								{{if $item.doc_file_name_231}}
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_231}}&module_name=cou_component_document_report.home">Download</a>
							...
							<td {{if $item.doc_file_name_491}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_491}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
									<select name="cou1[{{$item.bsn_id}}]"
							...
							<td>{{if $item.doc_file_name_173}}
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_173}}&module_name=cou_component_document_report.home">Download</a>
								<br /> {{$item.doc_date_uploaded_173}}
								{{/if}}
							</td>
							...
							<td>
								<textarea rows="4" cols="40" id="{{$item.bs_business_id}}"
									style="overflow-y: scroll;">{{$item.bs_what_is_holding}}</textarea>
								<div id="hold{{$item.bs_business_id}}">{{$item.bs_holding_user}}
									<br />{{$item.bs_holding_date}} </div>
							...
							<td>
								<form name="cal" method="post" enctype="multipart/form-data">
									...
									<div style="text-align:center;">
										<a href="/cou_component_document_report.download_content_we?file_name={{$item.bs_cou_weekly}}&module_name=cou_component_document_report.home"
											target="_blank">Download</a>
							...
							<td> <select name="letter[{{$item.bs_business_id}}]"
							...
							<td {{if $item.doc_file_name_172}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_172}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_169}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_169}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td data-col="pier_inspection_certficate">
							...
							<td {{if $item.doc_file_name_261}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_261}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
									<select name="cou6[{{$item.bsn_id}}]"
										onChange="update_req_notreq_6({{$item.bsn_id}}, this.value)">
										<option value="0" {{if $item.doc_not_required_261 eq 0 }} selected="selected"
											{{/if}}>Required</option>
										<option value="1" {{if $item.doc_not_required_261 eq 1 }} selected="selected"
											{{/if}}>Not Required</option>
									</select>
							...
							<td {{if $item.doc_file_name_155}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_155}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_295}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_295}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_413}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_413}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_156}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_156}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_735}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_735}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_736}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_736}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_737}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_737}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_738}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_738}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_289}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_289}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_162}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_162}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_163}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_163}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_296}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_296}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_713}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_713}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_714}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_714}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_739}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_739}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_274}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_274}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_294}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_294}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_167}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_167}}&module_name=cou_component_document_report.home">Download</a>
							...
							<td {{if $item.doc_file_name_749}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_749}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_626}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_626}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_691}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_691}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_637}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_637}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
							...
							<td {{if $item.doc_file_name_149}} style="background:#00CC33;" {{elseif
								...
								<a
									href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_149}}&module_name=cou_component_document_report.home">Download</a>
								{{else}}
