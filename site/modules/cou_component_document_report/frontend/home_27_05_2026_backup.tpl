	...
	<div style="display: flex; justify-content: space-between; align-items: end;">
		<div style="margin-left: 10px; text-align: left;">
			<div>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" name="View COU completion" value="COU Completion Performance Index" onclick="javascript:cou_completion();">
				&nbsp;&nbsp;
				<input type="button" name="View Walkthrough Completed" value="Walkthrough Completed" onclick="javascript:walkthrough_completed();">
			</div>
			<div>
			...
			<table id="doclist-table" class="nav-back" width="100%">
				<thead>
					<tr>
						...
						<th class="topmenu frozen-column" align="center" valign="middle" width="14%" style="z-index: 10000 !important;">Project Address</th>
						<th class="topmenu" align="center" valign="middle" width="3%">QA</th>
						<th class="topmenu" align="center" valign="middle" width="3%">The COU Process Has Commenced</th>
						...
						<th class="topmenu other-column" align="center" valign="middle" width="3%" data-col="cou-requirements">COU Requirements</th>
						...
						<th class="topmenu" align="center" valign="middle" width="3%" data-col="icon-water-condition">Icon Water Condition</th>
						<th class="topmenu" align="center" valign="middle" width="3%" data-col="tree-protection-condition">Tree Protection Condition</th>
						<th class="topmenu" align="center" valign="middle" width="3%" data-col="driveway">Driveway</th>
						...
						<th class="topmenu" align="center" valign="middle" width="6%" data-col="fic_signed_by_builder">Framing Installation Certificate - Signed by Builder</th>
						<th class="topmenu" align="center" valign="middle" width="6%">Insulation Certificate</th>
						<th class="topmenu" align="center" valign="middle" width="6%" data-col="iic_signed_by_builder">Insulation Installation Certificate - Signed by builder</th>
						<th class="topmenu" align="center" valign="middle" width="6%" data-col="us_insulation_certificate">Under Slab Insulation Certificate</th>
						...
						<th class="topmenu" align="center" valign="middle" width="6%" data-col="fic">Fireplace Installation Certificate</th>
				...
				<tbody>
					...
					<tr bgcolor="{{cycle values=" #D3E8D6,WHITE" advance=true}}">
						...
						<td {{if $item.cou_component_document_report_qa_log_user}} style="background: #0C3; white-space: nowrap;" {{/if}}>
							<a href="{{$BASE_URL}}cou_component_document_report.qa_ch/bsn_id/{{$item.bsn_id}}" class="various">QA</a>
							{{if $item.cou_component_document_report_qa_log_user}}
								<p>{{$item.cou_component_document_report_qa_log_user}}</p>
								<p>{{$item.cou_component_document_report_qa_log_date}}</p>
							{{/if}}
							<!--{{if $item.cs_ch_user}} {{$item.cs_ch_user}} <br />{{$item.cs_ch_date}} {{/if}}-->
						</td>
						<td>
							<form name="recmet3" method="post" action="">
								<input type="hidden" name="process_commenced[{{$item.bs_business_id}}]" value="0" />
								<label class="switch">
									<input class="switch-input" type="checkbox"
										name="process_commenced[{{$item.bs_business_id}}]" value="1"
										onclick="this.form.submit();" {{if $item.bs_cou_process_commenced eq 1 }}
										checked="checked" {{/if}}>
									<span class="switch-label" data-on="Yes" data-off="No"></span>
									<span class="switch-handle"></span> <br />
								</label>
							</form>
							{{if $item.bs_cou_process_commenced eq 1 }}
								{{$item.bs_cou_process_commenced_user}}<br/>
								{{$item.bs_cou_process_commenced_date}}
							{{/if}}
						</td>
						...
						<td class="other-column" data-col="building_approval" {{if $item.doc_file_name_232}} style="background:#00CC33;" {{elseif
							...
							<div style="margin-top: 15px;">
								{{assign var=ccdr_id value=$item.ccdr_ids[232]}}
								{{if $ccdr_id}}
						...
						<td class="other-column" {{if $item.doc_file_name_235}} style="background:#00CC33;" {{elseif
							...
							{{/if}}
							<div style="margin-top: 15px;">
								{{assign var=ccdr_id value=$item.ccdr_ids[235]}}
								{{if $ccdr_id}}
									{{assign var=suppliers value=$cou_component_document_report_companies.$ccdr_id}}
									{{foreach from=$suppliers key="index" item="row"}}
										{{assign var=ccdrc_co_id value=$row.ccdrc_co_id}}
						...
						<td class="other-column" {{if $item.doc_file_name_231}} style="background:#00CC33;" {{elseif
							...
							{{/if}}
							<div style="margin-top: 15px;">
								{{assign var=ccdr_id value=$item.ccdr_ids[231]}}
								{{if $ccdr_id}}
									{{assign var=suppliers value=$cou_component_document_report_companies.$ccdr_id}}
									{{foreach from=$suppliers key="index" item="row"}}
										{{assign var=ccdrc_co_id value=$row.ccdrc_co_id}}
						...
						<td class="other-column" {{if $item.doc_file_name_491}} style="background:#00CC33;" {{elseif
							...
							{{/if}}
							<div style="margin-top: 15px;">
								{{assign var=ccdr_id value=$item.ccdr_ids[491]}}
								{{if $ccdr_id}}
									{{assign var=suppliers value=$cou_component_document_report_companies.$ccdr_id}}
									{{foreach from=$suppliers key="index" item="row"}}
										{{assign var=ccdrc_co_id value=$row.ccdrc_co_id}}
						...
						<td class="other-column" data-col="cou-requirements" {{if $item.doc_file_name_655}} style="background:#00CC33;" {{elseif
							$item.doc_not_required_655 eq 0}} style="background:#F00;" {{else}}
							style="background:#999;" {{/if}} id="cond655{{$item.bsn_id}}">
							{{if $item.doc_file_name_655}}
							<a href="/cou_component_document_report.download_content?file_name={{$item.doc_file_name_655}}&module_name=cou_component_document_report.home">Download</a>
							{{else}}
								<select name="cou655[{{$item.bsn_id}}]"
									onChange="update_req_notreq_655({{$item.bsn_id}}, this.value)">
									<option value="0" {{if $item.doc_not_required_655 eq 0 }} selected="selected"
										{{/if}}>Required</option>
									<option value="1" {{if $item.doc_not_required_655 eq 1 }} selected="selected"
										{{/if}}>Not Required</option>
								</select>
								<script>
									function update_req_notreq_655(id, value) {
										var cond655 = '#cond655' + id;

										$.ajax({
											type: "GET",
											url: "{{$BASE_URL}}cou_component_document_report.update_req_notreq/bsn_id_655/" + id + "/value_655/" + value,
											success: function (result) {

												if (value == 0) {
													$(cond655).css("background", "#F00");
												} else {
													$(cond655).css("background", "#999");
												}
											}
							...
							{{/if}}
							<div style="margin-top: 15px;">
								{{assign var=ccdr_id value=$item.ccdr_ids[655]}}
								{{if $ccdr_id}}
									{{assign var=suppliers value=$cou_component_document_report_companies.$ccdr_id}}
									{{foreach from=$suppliers key="index" item="row"}}
										{{assign var=ccdrc_co_id value=$row.ccdrc_co_id}}
								...
								{{/if}}
								<p style="margin: 0; padding: 0; margin-top: 10px;">
									<a href="/cou_component_document_report.include_suppliers/ccdr_bsn_id/{{$item.bsn_id}}/ccdr_doc_id/655" class="various">Include Suppliers</a>
								</p>
							</div>
						</td>
						...
						<!--<td class="other-column">
							...
							{{/if}}
							<div style="margin-top: 15px;">
								{{assign var=ccdr_id value=$item.ccdr_ids[173]}}
								{{if $ccdr_id}}
									{{assign var=suppliers value=$cou_component_document_report_companies.$ccdr_id}}
									{{foreach from=$suppliers key="index" item="row"}}
										{{assign var=ccdrc_co_id value=$row.ccdrc_co_id}}
						...
						<td class="other-column" data-col="notes" style="min-width: 225px;">
							<div style="display: flex; gap: 10px; flex-direction: column;">
								<div>
									<a href="{{$BASE_URL}}cou_component_document_report.view_notes/bsn_id/{{$item.bs_business_id}}" class="various">Notes</a>
								</div>
								<div>
									<p>{{$item.cou_component_document_report_notes_note}}</p>
									<p style="font-weight: bold; margin-top: 4px;">{{$item.cou_component_document_report_notes_user}}</p>
									<p style="font-weight: bold;">{{$item.cou_component_document_report_notes_date}}</p>
								</div>
							</div>
							<!-- <textarea rows="4" cols="40" id="notes{{$item.bs_business_id}}" style="overflow-y: scroll;">{{$item.bs_cou_notes}}</textarea> -->
							<!-- {{if $item.cou_component_document_report_notes_user}} -->
						...
						{{if $item.doc_file_name_627 && $item.doc_not_required_627 eq 1}}
							{{assign var="bgcolor" value="#999"}}
						{{elseif $item.doc_file_name_627 && $item.doc_not_required_627 eq 0}}
							{{assign var="bgcolor" value="#00CC33"}}
						{{elseif empty($item.doc_file_name_627) && $item.doc_not_required_627 eq 1}}
							{{assign var="bgcolor" value="#999"}}
						{{elseif empty($item.doc_file_name_627) && $item.doc_not_required_627 eq 0}}
							{{assign var="bgcolor" value="#F00"}}
						{{/if}}
						<td data-col="icon-water-condition" style="background:{{$bgcolor}}" id="cond627{{$item.bsn_id}}">
									...
									function update_req_notreq_627(id, value) {
										...
										$.ajax({
											...
											success: function (result) {
												...
												if (value == 0) {
													$(cond627).css("background", "#F00");
												} else {
													$(cond627).css("background", "#999");
												}
											}
						...
						{{if $item.doc_file_name_382 && $item.doc_not_required_382 eq 1}}
							{{assign var="bgcolor" value="#999"}}
						{{elseif $item.doc_file_name_382 && $item.doc_not_required_382 eq 0}}
							{{assign var="bgcolor" value="#00CC33"}}
						{{elseif empty($item.doc_file_name_382) && $item.doc_not_required_382 eq 1}}
							{{assign var="bgcolor" value="#999"}}
						{{elseif empty($item.doc_file_name_382) && $item.doc_not_required_382 eq 0}}
							{{assign var="bgcolor" value="#F00"}}
						{{/if}}
						<td data-col="tree-protection-condition" style="background:{{$bgcolor}}" id="cond382{{$item.bsn_id}}">
									...
									function update_req_notreq_382(id, value) {
										...
										$.ajax({
											...
											success: function (result) {
												...
												if (value == 0) {
													$(cond382).css("background", "#F00");
												} else {
													$(cond382).css("background", "#999");
												}
											}
						...
						{{if $item.doc_file_name_272 && $item.doc_not_required_272 eq 1}}
							{{assign var="bgcolor" value="#999"}}
						{{elseif $item.doc_file_name_272 && $item.doc_not_required_272 eq 0}}
							{{assign var="bgcolor" value="#00CC33"}}
						{{elseif empty($item.doc_file_name_272) && $item.doc_not_required_272 eq 1}}
							{{assign var="bgcolor" value="#999"}}
						{{elseif empty($item.doc_file_name_272) && $item.doc_not_required_272 eq 0}}
							{{assign var="bgcolor" value="#F00"}}
						{{/if}}
						<td data-col="driveway" style="background:{{$bgcolor}}" id="cond272{{$item.bsn_id}}">
									...
									function update_req_notreq_272(id, value) {
										...
										$.ajax({
											...
											success: function (result) {
												...
												if (value == 0) {
													$(cond272).css("background", "#F00");
												} else {
													$(cond272).css("background", "#999");
												}
											}
