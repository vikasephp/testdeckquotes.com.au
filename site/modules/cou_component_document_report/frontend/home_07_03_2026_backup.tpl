			...
			<table id="doclist-table" class="nav-back" width="100%">
				...
				<tbody>
					...
					<tr bgcolor="{{cycle values=" #D3E8D6,WHITE" advance=true}}">
						...
						<td data-col="icon-water-condition" {{if $item.doc_file_name_627}} style="background:#00CC33;" {{elseif
							$item.doc_not_required_627 eq 0}} style="background:#F00;" {{else}}
							style="background:#999;" {{/if}} id="cond627{{$item.bsn_id}}">
						...
						<td data-col="tree-protection-condition" {{if $item.doc_file_name_382}} style="background:#00CC33;" {{elseif
							$item.doc_not_required_382 eq 0}} style="background:#F00;" {{else}}
							style="background:#999;" {{/if}} id="cond382{{$item.bsn_id}}">
						...
						<td data-col="driveway" {{if $item.doc_file_name_272}} style="background:#00CC33;" {{elseif
							$item.doc_not_required_272 eq 0}} style="background:#F00;" {{else}}
							style="background:#999;" {{/if}} id="cond272{{$item.bsn_id}}">
