...
window.location.href = "{{$BASE_URL}}cou_component_document_report.view_cou_completion";
</script>
{{/if}}
...
<h3 class="page-title"><br />COU Completion Performance Index Project List for {{$year}}</h3>
