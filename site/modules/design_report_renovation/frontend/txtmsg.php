...
if($submit)
{
	...
	if($table->rowExists())
	{
		$data['dpn_dr_survey_what'] = $textmsg;
...
$sql = "SELECT document_renovation_name.dpn_dr_survey_what from document_renovation_name where dpn_unique_id = ".$dpn_unique_id;	

$whatdata =  $fwDb->queryOne($sql);

$fwViewData['whatdata'] = $whatdata['dpn_dr_survey_what'];
