<?php
$fwMainView = 'file:' . getcwd() . '/txtmsg_ec.tpl';
...
$sql = "SELECT document_renovation_name.dpn_dr_ebc_comm from document_renovation_name where dpn_unique_id = ".$dpn_unique_id;	

$whatdata =  $fwDb->queryOne($sql);

$fwViewData['whatdata'] = $whatdata['dpn_dr_ebc_comm'];
