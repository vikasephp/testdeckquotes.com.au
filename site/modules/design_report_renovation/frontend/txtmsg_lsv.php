<?php
$fwMainView = 'file:' . getcwd() . '/txtmsg_lsv.tpl';
...
if($submit)
{
	...
	if($table->rowExists())
	{
		$data['dpn_dr_likey_comm'] = $textmsg;
...
$sql = "SELECT document_renovation_name.dpn_dr_likey_comm from document_renovation_name where dpn_unique_id = ".$dpn_unique_id;	

$whatdata =  $fwDb->queryOne($sql);

$fwViewData['whatdata'] = $whatdata['dpn_dr_likey_comm'];
