...
<form name="sort" method="post">
	<div style="float:left; text-align: left; margin-left:10px; text-align:left">
		...
		<div style="float:left;"> &nbsp; <strong>Search:</strong>&nbsp;&nbsp;
			<input type="text" name="searchkey" value="{{$searchkey}}" style="width:200px;"
...
<form name="mlist" method="post">
	<div style="float:right;">
		<input type="button" value="Export To XLS"
			onclick="document.location.href='{{$BASE_URL}}design_report_renovation.home_inactive/export/1'" /> &nbsp;
				...
				<tbody>
					...
					<tr {{if $item.dpn_dr_per_complete eq 100}} bgcolor="#99CC99" {{else}} bgcolor="{{cycle values="
						...
						<td>{{if $item.survey_uploaded}}
							<a href="/design_report_renovation.download_content_in_dc?file_name={{$item.survey_uploaded}}&module_name=design_report_renovation.home_inactive"
								target="_blank">Link</a>
							{{/if}}
						</td>
						<td>
							{{if $item.checklist179_file}}
							<a href="/design_report_renovation.download_content_in_dc?file_name={{$item.checklist179_file}}&module_name=design_report_renovation.home_inactive"
								target="_blank">Link</a>
							{{/if}}
						</td>
						...
						{{else }}
							...
							<td>
								{{if $item.lmpData && $item.lmpData.doc_file_name}}
									<a href="{{$BASE_URL}}files/document_check_list_files/{{$item.lmpData.doc_file_name}}" target="_blank">
										Download-{{$item.chknoData}}
									</a>
								{{/if}}
							</td>
							<td>
								<form name="pw" method="post" enctype="multipart/form-data">
									...
									<div style="text-align:center;">
										<a href="/design_report_renovation.download_content_in?file_name={{$item.dpn_dr_latest_letter}}&module_name=design_report_renovation.home_inactive"
											target="_blank">Download</a>

										<a href="{{$BASE_URL}}design_report_renovation.delete_w_in/dpn_unique_id/{{$item.chknoData}}"
