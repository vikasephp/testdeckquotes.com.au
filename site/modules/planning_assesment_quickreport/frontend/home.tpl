...
<form name="mshort" action="{{$BASE_URL}}{{$XFA.home}}" method="post">
	...
	<div style="float:left;">
		...
		{{if $view_meeting_occurred_records == 'on'}}
			<input type="hidden" name="view_meeting_occurred_records" value="off" />
			<input type="submit" value="Meeting Occurred" name="submit_view_meeting_occurred_records" style="background: green;" />
		{{else}}
			<input type="hidden" name="view_meeting_occurred_records" value="on" />
			<input type="submit" value="Meeting Occurred" name="submit_view_meeting_occurred_records" />
		{{/if}}	
		&nbsp;&nbsp;
				...
				<tbody>
					...
					<tr bgcolor="{{cycle values=" #D3E8D6,WHITE" advance=true}}">
						...
						<td id="update_alert_option_td_{{$item.bsn_id}}" data-col="alert" {{if $item.bs_paqr_alertoption eq 2}} style="background:#F00;" {{/if}} {{if $item.bs_paqr_alertoption eq 6}} style="background:#0F0;" {{/if}}>
							...
							<a href="{{$BASE_URL}}planning_assesment_quickreport.notes/bsn_id/{{$item.bsn_id}}" class="various">Notes</a>
						</td>
						<td>
						...
						{{if $item.checklist44}}
						<td style="text-align:center;">
							<a href="/planning_assesment_quickreport.download_content?file_name={{$item.checklist44}}&module_name=planning_assesment_quickreport.home">Download</a>
						...
						{{else}}
							...
							<td style="text-align:center;">
								<a href="/planning_assesment_quickreport.download_content?file_name={{$item.checklist705}}&module_name=planning_assesment_quickreport.home">Download</a>
