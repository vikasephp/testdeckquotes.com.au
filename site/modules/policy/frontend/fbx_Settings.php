...
$Document_path = "business_polices";
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/business_polices/'.$zipfile, S3::ACL_PRIVATE)) {
