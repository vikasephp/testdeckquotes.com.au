...
<h3 class="page-title">{{$title}}</h3>
 ...
 <input type="hidden" name="{{$TABLE}}[{{$ID}}]" value="{{$detail.$ID}}" id="dh_id"/>
     <table id="viewdoc-table" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <th>Supplier Name:</th>
            <td> <input type="text" name="{{$TABLE}}[bp_title]" value="{{$detail.bp_title}}" style="width:300px;"/></td>
        </tr>
<!--        <tr>
            <th> Summary :</th>
            <td><textarea rows="8" cols="60" name="{{$TABLE}}[bp_summery]">{{$detail.bp_summery}}</textarea> </td>
        </tr>-->   
<!--         <tr>
