...
<h3 class="page-title">Warranty Email Log - Customer</h3>
  ...
  <table id="doclist-table" class="nav-back" width="99%">
    ...
    <form name="mlist" method="post">
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
	    ...
	    <td>{{$item.wl_customer_name}}
        <td>{{$item.wl_email_to}}</td>
        <td>{{$item.wl_issue_included}}</td>
        <td><a href="{{$BASE_URL}}warranty_email_log.view_issue_customer/cust_email/{{$item.wl_email_to}}" class="various">View</a> </td>
