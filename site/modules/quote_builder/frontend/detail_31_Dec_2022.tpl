...
<table id="list-table" width="90%">
   ...
   {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
    ...
    <tr>
     ...
     <datalist id='sup'>
         ...
         <input type="text" list = 'sup' name="{{$TABLE}}[qb_supplier]" style ="width:700px" value="{{$detail.qb_supplier}}" />
         <input type="submit" name="show_contacts" value="Show Contacts"  />
    ...
    {{if $show }}
     ...
     <table id="list-table" class="nav-back" width="100%">
   	...
   	<td>{{$item.cs_first_name}} </td>
        ...
        <td> <input type="checkbox" name="{{$TABLE}}[cont][{{$cs_id}}]" value="{{$item.cs_primary_email}}" {{if strpos($detail.qb_supplier_email,$item.cs_primary_email)!==false}} checked="checked" {{/if}} /> 
        </td>
        </tr>
        {{/foreach}}
   ...
   <th>Due Date</th>
   <td> 
      <input type="text"  name="{{$TABLE}}[qb_due_date]"  value="{{$detail.qb_due_date}}" class="w16em dateformat-d-ds-m-ds-Y" id="demo4" />
   </td>
   </tr>
...
<td colspan="7">
  ...
  <td>
   {{if $detail.qb_attachment_1}}
     <div style="text-align:left;">Attachment 1 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_1}}" target="_blank">Preview</a>
   ...
   {{/if}}
    ...
    {{if $detail.qb_attachment_2}}
     <div style="text-align:left;">Attachment 2 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_2}}" target="_blank">Preview</a>
   ...
   {{/if}}
    ...
    {{if $detail.qb_attachment_3}}
     <div style="text-align:left;">Attachment 3 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_3}}" target="_blank">Preview</a>
   ...
   {{/if}}
    ...
    {{if $detail.qb_attachment_4}}
     <div style="text-align:left;">Attachment 4 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_4}}" target="_blank">Preview</a>
   ...
   {{/if}}
    ...
    {{if $detail.qb_attachment_5}}
     <div style="text-align:left;">Attachment 5 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_5}}" target="_blank">Preview</a>
   ...
   {{/if}} 
    ...
    {{if $detail.qb_attachment_6}}
     <div style="text-align:left;">Attachment 6 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_6}}" target="_blank">Preview</a>
     <a href="{{$BASE_URL}}quote_builder.docdelete/id/{{$detail.qb_id}}/p/5"><img src="{{$BASE_URL}}/css/admin/images/deletecross.png" /></a>
    </div>
   {{/if}} 
   
   {{if $detail.qb_attachment_7}}
     <div style="text-align:left;">Attachment 7 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_7}}" target="_blank">Preview</a>
     <a href="{{$BASE_URL}}quote_builder.docdelete/id/{{$detail.qb_id}}/p/5"><img src="{{$BASE_URL}}/css/admin/images/deletecross.png" /></a>
    </div>
   {{/if}} 
   
   {{if $detail.qb_attachment_8}}
     <div style="text-align:left;">Attachment 8 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_8}}" target="_blank">Preview</a>
     <a href="{{$BASE_URL}}quote_builder.docdelete/id/{{$detail.qb_id}}/p/5"><img src="{{$BASE_URL}}/css/admin/images/deletecross.png" /></a>
    </div>
   {{/if}} 
   
   {{if $detail.qb_attachment_9}}
     <div style="text-align:left;">Attachment 9 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_9}}" target="_blank">Preview</a>
     <a href="{{$BASE_URL}}quote_builder.docdelete/id/{{$detail.qb_id}}/p/5"><img src="{{$BASE_URL}}/css/admin/images/deletecross.png" /></a>
    </div>
   {{/if}} 
   
   {{if $detail.qb_attachment_10}}
     <div style="text-align:left;">Attachment 10 :  <a href="https://deckquote.s3.amazonaws.com/files/uploads_2023/{{$detail.qb_attachment_10}}" target="_blank">Preview</a>
     <a href="{{$BASE_URL}}quote_builder.docdelete/id/{{$detail.qb_id}}/p/5"><img src="{{$BASE_URL}}/css/admin/images/deletecross.png" /></a>
    </div>
   {{/if}} 
