...
window.location.href = "{{$BASE_URL}}quote_builder.view_component";
</script>
{{/if}}
...
<table id="list-table" width="100%">
   ...
   <tr>
     ...
     <td>
          ...
          <option value="{{$item.cs_position}} - {{$item.cs_primary_email}}" {{if $detail.qb_due_date_sod eq 1}} selected="selected"{{/if}}>
