...
function add_new()
 {
var viewurl = "{{$BASE_URL}}meeting_minutes.detail"+ "/random/" + Math.random();	
 $(document).ready(function () {
        $.fancybox({
				'width': '78%',
				'height': '80%',
...
{
	var viewurl = "{{$BASE_URL}}meeting_minutes.view_procedure"+ "/random/" + Math.random();	
...
<!--        <a href="https://deckquote.s3.amazonaws.com/files/meeting_minutes_doc/{{$item.mm_doc_pdf}}?dummy={{$ran}}" target="_blank">{{$item.mm_doc_pdf|truncate:70:"...":true}}</a> -->
        
        
        <a href="/meeting_minutes.download_content?file_name={{$item.mm_doc_pdf}}&module_name=meeting_minutes.home" target="_blank">{{$item.mm_doc_pdf|truncate:70:"...":true}}</a> 
...
<!--          <a href="https://deckquote.s3.amazonaws.com/files/meeting_minutes_doc/{{$item.mm_doc_word}}?dummy={{$ran}}"> {{$item.mm_doc_word|truncate:70:"...":true}} </a>-->
                
                
          <a href="/meeting_minutes.download_content?file_name={{$item.mm_doc_word}}&module_name=meeting_minutes.home"> {{$item.mm_doc_word|truncate:70:"...":true}} </a>        
