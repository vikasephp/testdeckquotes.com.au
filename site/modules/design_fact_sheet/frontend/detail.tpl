 ...
 <input type="hidden" name="fs[doc_id]" value="{{$detail.doc_id}}" id="dh_id"/>
	...
	<tr>
          ...
          <tr>
            ...
            <a href="{{$BASE_URL}}design_fact_sheet.detail/doc_id/{{$detail.$ID}}/docid/{{$detail.$ID}}" onclick="javascript:if(!confirm('Are you sure want to delete the image?')) return false;" title="Delete">
