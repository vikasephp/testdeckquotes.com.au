...
// module names
$MODULE_SINGULAR = 'Missing Plans Database';
$MODULE_PLURAL =   'Missing Plans Database';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'project_planning_checklist';
$ID = 'pc_id';
$fwViewData['TABLE'] = $TABLE;
$fwViewData['ID'] = $ID;

$PPTABLE = 'pp_missing_plans_database';
$PPID = 'pr_id';
...
$BASEFOLDER = 'missing_plans_database';
