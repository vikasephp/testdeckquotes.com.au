...
// module names
$MODULE_SINGULAR = 'Construction Alert Pending Report';
$MODULE_PLURAL =   'Construction Alert Pending Report';
...
function create_car2($heading, $html)
{
	require_once(BASE_DIR.'tcpdf/config/lang/eng.php');
	require_once(BASE_DIR.'tcpdf/tcpdf.php');
	//$PDF_PAGE_ORIENTATION = "R";
...
//Close and output PDF document
$filepath = 'reports/car_content/reportlist/'.$filename;
$filepath_save =BASE_DIR.$filepath;
$filepath_url =BASE_URL.$filepath;
