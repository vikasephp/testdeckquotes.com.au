  ...
  <table id="doclist-table" class="nav-back" width="100%">
    <thead>
      <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="3%">HIA Plans</th>
        <th class="topmenu" align="center" valign="middle" width="3%">MSTEAM Link </th>
        <th class="topmenu" align="center" valign="middle" width="3%">Plans Last Changed</th>
    ...
    <tbody>
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
        ...
        <a href="{{$BASE_URL}}files/document_check_list_files/{{$item.doc_file_name_526}}" target="_blank">Download{{/if}}</td>
        <td></td>
        <td></td>
