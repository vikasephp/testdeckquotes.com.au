    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                ...
                <th class="topmenu" align="center" valign="middle" width="16%">Design Image</th>  
                <th class="topmenu" align="center" valign="middle" width="30%">Style</th> 
                <th class="topmenu" align="center" valign="middle" width="25%">Link</th>
                <th class="topmenu" align="center" valign="middle" width="15%">Tags</th>           
                <th class="topmenu" align="center" valign="middle" width="6%">Status</th>   
                <th class="topmenu" align="center" valign="middle" width="16%">Action</th> 
            </tr>
        </thead>
<tbody>
 ...
 <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
    <td>{{counter}}</td>
    <td><div align="center"><a href="{{$BASE_URL}}files/design_examples/{{$item.de_design_image|default:'no_image.jpg'}}" class="fancybox"><img src="{{$BASE_URL}}files/design_examples/{{$item.de_design_image}}" width="100" /> </a>

    </td>
    <td> {{$item.de_style}} </td> 
    <td> <a href = "{{$item.de_link}}" target="_blank">{{$item.de_link}} </a></td>
    <td> {{$item.de_tags}}</td>
    <td>{{$item.de_status}}</td>
