...
<!--    <a href="https://deckquote.s3.amazonaws.com/files/business_documents/{{$item.bd_doc_name}}" title="{{$item.bd_doc_name}}" class="action_small" target="_blank">{{$item.bd_doc_name|truncate:"10"}}</a>-->
  
      <a href="/business.download_content_bd?file_name={{$item.bd_doc_name}}&module_name=business.home" title="{{$item.bd_doc_name}}" class="action_small" target="_blank">{{$item.bd_doc_name|truncate:"10"}}</a>
  ...
  <form name="bd" action="" method="post" enctype="multipart/form-data">
    ...
    <table cellpadding="0" cellspacing="0" class="table" style="border:1px solid #CCCCCC; padding:10px; width:100%; text-align:left;" >
      ...
      <tr>
       ...
       <!-- <a href="https://deckquote.s3.amazonaws.com/files/business_documents/{{$detail.bd_doc_name}}" target="_blank">{{$detail.bd_doc_name}}</a>-->
...
<!--    <a href="https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$item.doc_file_name}}" class="action_checklist" title="{{$item.doc_file_name}}" target="_blank">Link</a>-->
    
      <a href="/business.download_content?file_name={{$item.doc_file_name}}&module_name=business.home" class="action_checklist" title="{{$item.doc_file_name}}" target="_blank">Link</a>
        
    </td>
    {{else}}
    <td style="text-align:left;">
<!--    <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$item.doc_file_name}}')" class="action_checklist" title="{{$item.doc_file_name}}">Link</a>-->
   
       <a href="javascript:parent.modelviewimages('/business.download_content?file_name={{$item.doc_file_name}}&module_name=business.home')" class="action_checklist" title="{{$item.doc_file_name}}">Link</a> 
...
<!-- <a href = "https://deckquote.s3.amazonaws.com/files/purchase_order_quote/{{$item.po_quote1}}" target="_blank">View Quote</a> -->
  <a href = "/business.download_content_po?file_name={{$item.po_quote1}}&module_name=business.home" target="_blank">View Quote</a> 
...
<!--          <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$doc_data.doc_file_name}}')" id="label_doc_file_name_temp" target="_blank">{{$doc_data.doc_file_name}}</a>-->
           ...
           <a href="javascript:remove_img();" id="crossimg"><img src="{{$BASE_URL}}css/default/images/notdone-task.gif" id="crossimg" /></a> {{/if}} 
