...
<!--   <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$item.doc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$item.doc_file_name}}">{{$item.doc_file_name|truncate:"40"}}</a>-->
   ...
   {{/if}}
    ...
    <td style="text-align:center;"><input type="checkbox" {{if $item.doc_cons_calendar == 1}} checked="checked"{{/if}} disabled="disabled" /></td>
    <td style="text-align:left;">
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/1/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}

</form>
</div>
<table cellpadding="0" cellspacing="0" class="divtruelog_1" width="100%" id="divtruelog" style="border-collapse:collapse;">
  <tr>
    <th width="18%">Action</th>
    <th width="25%">Document Name</th>
    <th width="18%">File Name</th>
...
<!--    <a href="https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$itemc.cdc_file_name}}?dummy={{$ran}}" class="action_checklist" title="{{$itemc.cdc_file_name}}" target="_blank">{{$itemc.cdc_file_name|truncate:"40"}}</a>-->
      ...
      <a href="/business.download_content?file_name={{$item.cdc_file_name}}&module_name=business.home" class="action_checklist" title="{{$item.doc_file_name}}" target="_blank">{{$item.cdc_file_name|truncate:"40"}}</a> 
...
<!--   <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$itemc.cdc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$itemc.cdc_file_name}}">{{$itemc.cdc_file_name|truncate:"40"}}</a>-->
     ...
     <a href="javascript:parent.modelviewimages('/business.download_content?file_name={{$itemc.cdc_file_name}}&module_name=business.home')" class="action_checklist" title="{{$itemc.doc_file_name}}">{{$itemc.cdc_file_name|truncate:"40"}}</a>
...
&nbsp; &nbsp;Created Date 2 : <input type="text" name="proposal[dpn_created_date]" value="{{$dpn_created_date_2}}" style="width:100px;" readonly="readonly" placeholder="Date will appear after save"/>
<br />
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/2','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/2/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>

</div>
<table cellpadding="0" cellspacing="0" width="100%" id="divtruelog" class="divtruelog_2" style="border-collapse:collapse;">
  <tr>
    <th width="18%">Action</th>
    <th width="25%">Document Name</th>
    <th width="18%">File Name</th>
...
<!--    <a href="https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$itemc.cdc_file_name}}?dummy={{$ran}}" class="action_checklist" title="{{$itemc.cdc_file_name}}" target="_blank">{{$itemc.cdc_file_name|truncate:"40"}}</a>-->
     ...
     <a href="/business.download_content?file_name={{$itemc.cdc_file_name}}&module_name=business.home" class="action_checklist" title="{{$itemc.cdoc_file_name}}" target="_blank">{{$itemc.cdc_file_name|truncate:"40"}}</a>
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/3','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/3/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>

 </div>
<table cellpadding="0" cellspacing="0" width="100%" id="divtruelog" class="divtruelog_3" style="border-collapse:collapse;">
  <tr>
    <th width="18%">Action</th>
    <th width="25%">Document Name</th>
    <th width="18%">File Name</th>
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/4','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/4/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>
</div>

<table cellpadding="0" cellspacing="0" width="100%" id="divtruelog" class="divtruelog_4" style="border-collapse:collapse;">
  <tr>
    <th width="18%">Action</th>
    <th width="25%">Document Name</th>
    <th width="18%">File Name</th>
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/5','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/5/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>

</div>

<table cellpadding="0" cellspacing="0" width="100%" id="divtruelog" class="divtruelog_5" style="border-collapse:collapse;">
  <tr>
    <th width="18%">Action</th>
    <th width="25%">Document Name</th>
    <th width="18%">File Name</th>
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/6','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/6/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>

</div>

<table cellpadding="0" cellspacing="0" width="100%" id="divtruelog" class="divtruelog_6" style="border-collapse:collapse;">
  <tr>
    <th width="18%">Action</th>
    <th width="25%">Document Name</th>
    <th width="18%">File Name</th>
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/7','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/7/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>

</div>

<table cellpadding="0" cellspacing="0" width="100%" id="divtruelog" class="divtruelog_7" style="border-collapse:collapse;">
  <tr>
    <th width="18%">Action</th>
    <th width="25%">Document Name</th>
    <th width="18%">File Name</th>
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/8','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/8/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/9','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/9/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>
...
<input type="button" name="archive" value="Archive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/10','90%','90%', 'yes');" id="archive" class="vsml" />
{{else}} 
<input type="button" name="archive" value="Unarchive This Checlist" onclick="javascript:modelwindow('{{$BASE_URL}}business.archived/bus_id/{{$bsn_id_mini}}/dpn_pn/10/un/1','90%','90%', 'yes');" id="archive" class="vsml" />
{{/if}}
</form>
...
<!--          <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$doc_data.doc_file_name}}')" id="label_doc_file_name_temp" target="_blank">{{$doc_data.doc_file_name}}</a>-->
             ...
             <a href="javascript:parent.modelviewimages('/business.download_content?file_name={{$doc_data.doc_file_name}}&module_name=business.home')" class="action_checklist" title="{{$doc_data.doc_file_name}}" id="label_doc_file_name_temp">{{$doc_data.doc_file_name|truncate:"40"}}</a>
          ...
          <table width="991" cellpadding="0" cellspacing="0" style="border:none;">
            <tr>
              ...
              <td width="195"><strong>Construction Calendar:</strong>
                <input type="checkbox" {{if $doc_data.doc_cons_calendar == 1}} checked="checked" {{/if}} name="doc[doc_cons_calendar]" value="1" /></td>
              <td width="347">&nbsp;</td>
            </tr>
            <tr>
      ...
      <tr>
        ...
        <td><textarea cols="50" rows="5" class="doc_msg__kl" name="doc[doc_msg]">{{$doc_data.doc_msg}}</textarea></td>
      </tr>
      <tr>
        <td colspan="2" style="text-align:center;">
            <input type="submit"  value="Save" name="submit_iframe" id="uploadForm_submit_iframe" style="cursor:pointer;" />
...
<!--          <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$doc_data.doc_file_name}}?dummy={{$ran}}')" id="label_doc_file_name_temp" target="_blank">{{$doc_data.doc_file_name}}</a> -->
            ...
            <a href="javascript:parent.modelviewimages('/business.download_content?file_name={{$doc_data.doc_file_name}}&module_name=business.home')" id="label_doc_file_name_temp"  >{{$doc_data.doc_file_name|truncate:"40"}}</a>
      ...
      <tr>
        <td><strong>Note:</strong></td>
        <td><textarea cols="50" rows="5" class="doc_msg__kl_1" name="doc[doc_msg]">{{$doc_data.doc_msg}}</textarea></td>
      </tr>
      <tr>
...
function remove_img()
  ...
  <form action="" method="post" id="mini_cdc_doc_name_11" enctype="multipart/form-data" name="iframe-form">
    ...
    <input type="hidden" name="mini[doc_chk_list_chknm]" id="doc_chk_list_chknm"  value="{{$doc_chk_list_chknm}}" />
...
<!--          <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$cdetail.cdc_file_name}}?dummy={{$ran}}')" id="label_cdc_file_name_temp" target="_blank">{{$cdetail.cdc_file_name}}</a>-->
            ...
            <a href="javascript:parent.modelviewimages('/business.download_content?file_name={{$cdetail.cdc_file_name}}&module_name=business.home')" id="label_cdc_file_name_temp" target="_blank">{{$cdetail.cdc_file_name|truncate:"40"}}</a> 
...
<!--    <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$item.doc_file_name}}?dummy={{$ran}}')" class="action_checklist" title="{{$item.doc_file_name}}">{{$item.doc_file_name|truncate:"40"}}</a>-->
   ...
   <!-- <a href="https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$item.admin_doc_manual}}?dummy={{$ran}}" rel="nofollow">View</a>-->
    ...
    <a href="/business.download_content?file_name={{$item.admin_doc_manual}}&module_name=business.home" rel="nofollow">View</a>
...
function remove_img()
  ...
  <form action="" method="post" enctype="multipart/form-data" name="iframe-form">
    ...
    <table cellpadding="0" cellspacing="0" class="table"  >
      ...
      <tr>
        ...
        <td><input type="file" name="image" id="doc_file_name_mini" />
          ...
          <a href="javascript:parent.modelviewimages('https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$doc_data.doc_file_name}}?dummy={{$ran}}')" id="label_doc_file_name_temp" target="_blank">{{$doc_data.doc_file_name}}</a> 
             ...
             <a href="javascript:parent.modelviewimages('/business.download_content?file_name={{$doc_data.doc_file_name}}&module_name=business.home')"  id="label_doc_file_name_temp" target="_blank">{{$doc_data.doc_file_name|truncate:"40"}}</a>
      ...
      <tr>
        <td><strong>Note:</strong></td>
        <td><textarea cols="50" rows="5" class="doc_msg__kl_3" name="doc[doc_msg]">{{$doc_data.doc_msg}}</textarea></td>
      </tr>
      <tr>
...
<div id="checkListIframe" >
  <form action="" method="post" enctype="multipart/form-data" id="uploadForm11" >
    <input type="hidden" value="{{if $bus_id}}{{$bus_id}}{{else}}{{$detail.bd_bsi_id}}{{/if}}" id="business_id" name="data[bd_bsi_id]" />
  ...
  <a href="/business.download_content_bd?file_name={{$detail.bd_doc_name}}&module_name=business.home" target="_blank">{{$detail.bd_doc_name}}</a>  
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <table cellpadding="0" cellspacing="0" class="table" style="border:1px solid #CCCCCC; padding:10px; width:100%; text-align:left;" >
     ...
     <!-- <tr>
      ...
      <tr>
        <th>Values </th>
        <td><input type="text" name="data[va_values]" value="{{$detail.va_values}}" style="width:550px;" /></td>
      </tr>
...
<div id="checkListIframe" >
  <form action="" method="post" enctype="multipart/form-data">
    <input type="hidden" value="{{if $bus_id}}{{$bus_id}}{{else}}{{$detail.dp_bsn_id}}{{/if}}" name="data[dp_bsn_id]" />
    <input type="hidden" value="{{$detail.dp_id}}" name="data[dp_id]" />
  
    <table cellpadding="0" cellspacing="0" class="table" style="border:1px solid #CCCCCC; padding:10px; width:100%; text-align:left;" >
      <tr>
        <th width="100"> Document Name: </th>
        <td><input type="text" name="data[dp_design_plan]" value="{{$detail.dp_design_plan}}" style="width:550px;" />
        </td>
      </tr>
      ...
      <tr>
        ...
        <td><input type="button" value="cancel" onclick="parent.hideiFrame('adddesignplanIframe','');" />
        </td>
      </tr>
    </table>
  </form>
...
<div id="checkListIframe" >
  <form action="" method="post" enctype="multipart/form-data">
    <input type="hidden" value="{{if $bus_id}}{{$bus_id}}{{else}}{{$detail.lmp_bsn_id}}{{/if}}" name="data[lmp_bsn_id]" />
    <input type="hidden" value="{{$detail.lmp_id}}" name="data[lmp_id]" />
  
    <table cellpadding="0" cellspacing="0" class="table" style="border:1px solid #CCCCCC; padding:10px; width:100%; text-align:left;" >
      <tr>
        <th width="100"> Checklist Number LMP: </th>
        <td><input type="text" name="data[lmp_checklist_no]" value="{{$detail.lmp_checklist_no}}" style="width:550px;" />
        </td>
      </tr>
      
       <tr>
        <th width="100"> Date Uploaded: </th>
        <td><input type="text" name="data[lmp_date_uploaded]" value="{{$detail.lmp_date_uploaded}}" style="width:550px;" class="w16em dateformat-d-ds-m-ds-Y" id="demolmp{{$item.lmp_id}}" />
        </td>
      </tr>
...
<div id="checkListIframe" >
  <form action="" method="post" enctype="multipart/form-data">
    <input type="hidden" value="{{if $bus_id}}{{$bus_id}}{{else}}{{$detail.mm_bsn_id}}{{/if}}" name="data[mm_bsn_id]" />
    <input type="hidden" value="{{$detail.mm_id}}" name="data[mm_id]" />
  
    <table cellpadding="0" cellspacing="0" class="table" style="border:1px solid #CCCCCC; padding:10px; width:100%; text-align:left;" >
      <tr>
        <th width="100"> Meeting Name </th>
        <td><input type="text" name="data[mm_meeting_name]" value="{{$detail.mm_meeting_name}}" style="width:550px;" />
        </td>
      </tr>
      
       <tr>
        <th width="100">Meeting Date: </th>
        <td><input type="text" name="data[mm_meeting_date]" value="{{$detail.mm_meeting_date}}" style="width:550px;" class="w16em dateformat-d-ds-m-ds-Y" id="demomm{{$item.mm_id}}" />
        </td>
      </tr>
...
<!--    <a href="https://deckquote.s3.amazonaws.com/files/special_conditions_doc/{{$item.sp_word}}?dummy={{$ran}}" title="{{$item.sp_word}}" class="action_small" target="_blank">{{$item.sp_word|truncate:"30"}}</a>-->
  ...
  <a href="/business.download_content_sc?file_name={{$item.sp_word}}&module_name=business.home" title="{{$item.sp_word}}" class="action_small" target="_blank">{{$item.sp_word|truncate:"30"}}</a>
...
<!--     <a href="https://deckquote.s3.amazonaws.com/files/special_conditions_doc/{{$item.sp_pdf}}?dummy={{$ran}}" title="{{$item.sp_pdf}}" class="action_small" target="_blank">{{$item.sp_pdf|truncate:"30"}}</a>-->
    ...
    <a href="/business.download_content_sc?file_name={{$item.sp_pdf}}&module_name=business.home" title="{{$item.sp_pdf}}" class="action_small" target="_blank">{{$item.sp_pdf|truncate:"30"}}</a>   
...
<!--     <a href="https://deckquote.s3.amazonaws.com/files/variations_doc/{{$item.va_pdf}}?dummy={{$ran}}" title="{{$item.va_pdf}}" class="action_small" target="_blank">{{$item.va_pdf|truncate:"30"}}</a>-->
       ...
       <a href="/business.download_content_vd?file_name={{$item.va_pdf}}&module_name=business.home" title="{{$item.va_pdf}}" class="action_small" target="_blank">{{$item.va_pdf|truncate:"30"}}</a>
     </td>
...
<!--      <a href="https://deckquote.s3.amazonaws.com/files/variations_doc/{{$item.va_signed}}?dummy={{$ran}}" title="{{$item.va_signed}}" class="action_small" target="_blank">{{$item.va_signed|truncate:"30"}}</a>-->
       ...
       <a href="/business.download_content_vd?file_name={{$item.va_signed}}&module_name=business.home" title="{{$item.va_signed}}" class="action_small" target="_blank">{{$item.va_signed|truncate:"30"}}</a>  
      
      </td> 
    <td>{{$item.va_signed_date}}</td> 
     <td>
     <input type="text" name="data[va_sign_cust_date]" value="{{$item.va_sign_cust_date}}" class="w16em dateformat-d-ds-m-ds-Y"  style="width:60px;" id="demo25_99{{$item.va_id}}" onkeyup = "parent.update_va_signed_date({{$item.va_id}}, this.value);" />
     </td>
    <td style="text-align:center;">
    ...
    <select name="data[va_inv_created]" onchange="parent.update_invoice_created({{$item.va_id}}, this.value)" >
...
{{if $designplan_data}}
  ...
  <tr>
    <td> <a href="javascript:RequestcheckListIframe('adddesignplan','{{$item.dp_id}}','{{$divid}}','');" ><img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/edit.png"/></a>&nbsp;
     
       <a href="javascript:requestDeleteDocument('{{$item.dp_id}}','9');" > <img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/delete.png"/></a> 
   </td>
       
  <td>{{$item.dp_design_plan}}</td>  
  <td style="text-align:center;">
    <a href="/business.download_content_depl?file_name={{$item.dp_pdf_file}}&module_name=business.home" title="{{$item.dp_pdf_file}}" class="action_small" target="_blank">{{$item.dp_pdf_file|truncate:"30"}}</a>
    </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border:none;">
  <tr> {{if $last}}
    <td align="center"><div class='pagination'> {{if $pagenum == 1}} <span class='disabled'>&laquo; previous</span> {{else}} <a class="pagination" href="javascript:javascript:iframeRequest(9,{{math equation="x - y" x=$pagenum y=1}})" title="Previous">&laquo; previous</a> {{/if}}
        
        {{if $pagenum != 1}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(9,1)" title="{{$page_num}} Page">1</a></span> {{else}}<span class='current'>1</span> {{/if}}{{if $pagenum != 2}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(9,2)" title="{{$page_num}} Page">2</a></span> {{else}}<span class='current'>2</span> {{/if}}
        {{if $paginateprev.0 > 3}}
        ...
        {{/if}}
        {{foreach from=$paginateprev key="page_key" item="page_num"}}
        ...
        {{else}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(9,{{$page_num}})" title="{{$page_num}} Page">{{$page_num}}</a></span> {{/if}}
        {{/foreach}}
        ...
        {{elseif $page_num2 == 2}}
        {{else}}
        {{if $page_num2 == $pagenum OR $page_num2 <= 0}} <span class='current'> {{$page_num2}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(9,{{$page_num2}})" title="{{$page_num2}} Page">{{$page_num2}}</a> {{/if}}
        {{/if}}     
        {{/if}}
        {{/foreach}}
        {{if $page_num2 < $lasttow}}
        ...
        {{elseif $lastone == 2}}
        {{else}}
        {{if $pagenum == $lastone }} <span class='current'>{{$lastone}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(9,{{$lastone}})" title="{{$lastone}} Page">{{$lastone}}</a> {{/if}}
        {{/if}}
        {{if $last == 1}}
        {{elseif $last == 2}}
        {{else}}
        {{if $pagenum == $last}} <span class='current'>{{$last}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(9,{{$last}})" title="{{$last}} Page">{{$last}}</a> {{/if}}
        {{/if}}
        {{if $pagenum == $last}} <span class='disabled'>next &raquo;</span> {{else}} <a class="pagination" href="javascript:iframeRequest(9,{{math equation="x + y" x=$pagenum y=1}})" title="Next">next &raquo;</a></div>
      {{/if}} </td>
    {{else}}
    <td align="center" height="300">Record Not found... </td>
    {{/if}} </tr>
...
{{if $lmp_data}}
  ...
  <tr>
    <td> <a href="javascript:RequestcheckListIframe('addlmp','{{$item.lmp_id}}','{{$divid}}','');" ><img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/edit.png"/></a>&nbsp;
...
<!--       <a href="javascript:requestDeleteDocument('{{$item.lmp_id}}','10');" > <img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/delete.png"/></a> -->
  ...
  <td style="text-align:center;">
    <a href="/business.download_content_lmp?file_name={{$item.lmp_doc_name}}&module_name=business.home" title="{{$item.lmp_doc_name}}" class="action_small" target="_blank">{{$item.lmp_doc_name|truncate:"60"}}</a>
    </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border:none;">
  <tr> {{if $last}}
    <td align="center"><div class='pagination'> {{if $pagenum == 1}} <span class='disabled'>&laquo; previous</span> {{else}} <a class="pagination" href="javascript:javascript:iframeRequest(10,{{math equation="x - y" x=$pagenum y=1}})" title="Previous">&laquo; previous</a> {{/if}}
        
        {{if $pagenum != 1}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(10,1)" title="{{$page_num}} Page">1</a></span> {{else}}<span class='current'>1</span> {{/if}}{{if $pagenum != 2}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(10,2)" title="{{$page_num}} Page">2</a></span> {{else}}<span class='current'>2</span> {{/if}}
        {{if $paginateprev.0 > 3}}
        ...
        {{/if}}
        {{foreach from=$paginateprev key="page_key" item="page_num"}}
        ...
        {{else}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(10,{{$page_num}})" title="{{$page_num}} Page">{{$page_num}}</a></span> {{/if}}
        {{/foreach}}
        ...
        {{elseif $page_num2 == 2}}
        {{else}}
        {{if $page_num2 == $pagenum OR $page_num2 <= 0}} <span class='current'> {{$page_num2}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(10,{{$page_num2}})" title="{{$page_num2}} Page">{{$page_num2}}</a> {{/if}}
        {{/if}}     
        {{/if}}
        {{/foreach}}
        {{if $page_num2 < $lasttow}}
        ...
        {{elseif $lastone == 2}}
        {{else}}
        {{if $pagenum == $lastone }} <span class='current'>{{$lastone}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(10,{{$lastone}})" title="{{$lastone}} Page">{{$lastone}}</a> {{/if}}
        {{/if}}
        {{if $last == 1}}
        {{elseif $last == 2}}
        {{else}}
        {{if $pagenum == $last}} <span class='current'>{{$last}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(10,{{$last}})" title="{{$last}} Page">{{$last}}</a> {{/if}}
        {{/if}}
        {{if $pagenum == $last}} <span class='disabled'>next &raquo;</span> {{else}} <a class="pagination" href="javascript:iframeRequest(10,{{math equation="x + y" x=$pagenum y=1}})" title="Next">next &raquo;</a></div>
      {{/if}} </td>
    {{else}}
    <td align="center" height="300">Record Not found... </td>
    {{/if}} </tr>
...
{{if $mm_data}}
  ...
  <tr>
    <td> <a href="javascript:RequestcheckListIframe('addmm','{{$item.mm_id}}','{{$divid}}','');" ><img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/edit.png"/></a>&nbsp;
...
<!--       <a href="javascript:requestDeleteDocument('{{$item.lmp_id}}','10');" > <img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/delete.png"/></a> -->
  ...
  <td style="text-align:center;">
    <a href="/business.download_content_mm?file_name={{$item.mm_meeting_file}}&module_name=business.home" title="{{$item.mm_meeting_file}}" class="action_small" target="_blank">{{$item.mm_meeting_file|truncate:"60"}}</a>
    </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border:none;">
  <tr> {{if $last}}
    <td align="center"><div class='pagination'> {{if $pagenum == 1}} <span class='disabled'>&laquo; previous</span> {{else}} <a class="pagination" href="javascript:javascript:iframeRequest(11,{{math equation="x - y" x=$pagenum y=1}})" title="Previous">&laquo; previous</a> {{/if}}
        
        {{if $pagenum != 1}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(11,1)" title="{{$page_num}} Page">1</a></span> {{else}}<span class='current'>1</span> {{/if}}{{if $pagenum != 2}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(11,2)" title="{{$page_num}} Page">2</a></span> {{else}}<span class='current'>2</span> {{/if}}
        {{if $paginateprev.0 > 3}}
        ...
        {{/if}}
        {{foreach from=$paginateprev key="page_key" item="page_num"}}
        ...
        {{else}} <span class="paginate"><a class="pagination"  href="javascript:iframeRequest(11,{{$page_num}})" title="{{$page_num}} Page">{{$page_num}}</a></span> {{/if}}
        {{/foreach}}
        ...
        {{elseif $page_num2 == 2}}
        {{else}}
        {{if $page_num2 == $pagenum OR $page_num2 <= 0}} <span class='current'> {{$page_num2}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(11,{{$page_num2}})" title="{{$page_num2}} Page">{{$page_num2}}</a> {{/if}}
        {{/if}}     
        {{/if}}
        {{/foreach}}
        {{if $page_num2 < $lasttow}}
        ...
        {{elseif $lastone == 2}}
        {{else}}
        {{if $pagenum == $lastone }} <span class='current'>{{$lastone}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(11,{{$lastone}})" title="{{$lastone}} Page">{{$lastone}}</a> {{/if}}
        {{/if}}
        {{if $last == 1}}
        {{elseif $last == 2}}
        {{else}}
        {{if $pagenum == $last}} <span class='current'>{{$last}}</span> {{else}} <a class="pagination"  href="javascript:iframeRequest(11,{{$last}})" title="{{$last}} Page">{{$last}}</a> {{/if}}
        {{/if}}
        {{if $pagenum == $last}} <span class='disabled'>next &raquo;</span> {{else}} <a class="pagination" href="javascript:iframeRequest(11,{{math equation="x + y" x=$pagenum y=1}})" title="Next">next &raquo;</a></div>
      {{/if}} </td>
    {{else}}
    <td align="center" height="300">Record Not found... </td>
    {{/if}} </tr>
...
<!--    <a href="https://deckquote.s3.amazonaws.com/files/business_documents/{{$item.bpd_doc_name}}?dummy={{$ran}}" title="{{$item.bpd_doc_name}}" class="action_small" target="_blank">{{$item.bpd_doc_name|truncate:"30"}}</a>-->
      ...
      <a href="/business.download_content_bd?file_name={{$item.bpd_doc_name}}&module_name=business.home" title="{{$item.bpd_doc_name}}" class="action_small" target="_blank">{{$item.bpd_doc_name|truncate:"30"}}</a> 
    </td>
