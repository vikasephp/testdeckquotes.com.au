...
{{if $allTasks[0].bt_task_status_id eq 4 }}
<input type="button" value="Back To Construction Task Report" onclick="location.href='{{$BASE_URL}}complete_task_tracker.home';" /> 
{{/if}}
