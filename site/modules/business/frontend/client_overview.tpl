...
<form method="post" style="text-align: center;">
    ...
    <table id="client_overview_table">
        ...
        <tr>
            <th>Lot / DP</th>
            <td>
                <input type="text" name="client_overview[co_lot_dp]" value="{{ $client_overview_data.co_lot_dp }}">
            </td>
            <th>Applicable Planning Controls</th>
            <td>
                <input type="text" name="client_overview[co_applicable_planning_controls]" value="{{ $client_overview_data.co_applicable_planning_controls }}">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th>ACTMapi Link</th>
            <td>
                <textarea name="client_overview[co_actmapi_link]">{{ $client_overview_data.co_actmapi_link }}</textarea>
            </td>
        </tr>
        <tr>
            <th>Spatial Viewer Portal</th>
            <td>
                <input type="text" name="client_overview[co_spatial_viewer_portal]" value="{{ $client_overview_data.co_spatial_viewer_portal }}">
            </td>
            <th>Floor Space Ratio</th>
            <td>
                <input type="text" name="client_overview[co_floor_space_ratio]" value="{{ $client_overview_data.co_floor_space_ratio }}">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th>Design Agreement Signed</th>
            <td>
                <input type="text" name="client_overview[co_design_agreement_sign_link]" value="{{ $client_overview_data.co_design_agreement_sign_link }}">
            </td>
        </tr>
        <tr>
