...
<table cellpadding="3" cellspacing="3" width="98%" id="list-table" >
    ...
    <!--<a href = "{{$BASE_URL}}files/recorded_meetings/{{$item.rm_scribed_file}}" target="_blank">-->
    <a href="/business.download_content_rm?file_name={{$item.rm_scribed_file}}&module_name=business.home" >
