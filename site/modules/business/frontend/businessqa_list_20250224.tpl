...
<tr bgcolor="#CCCCCC"><th>Action</th><th>Customer</th><th>Question</th><th>Attachment For Enquries</th><th>Que. Date</th>
<th>Answer</th><th>Attachments For Answers</th><th>Business Stream</th><th> Source</th><th> Que User</th>    <th>Include in&nbsp;Report <button type="button" id="selectAll" class="main"> Select All</button> </th>
