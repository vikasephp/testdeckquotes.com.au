  ...
  <input type="checkbox" value="1" name="{{$TABLE}}[bsn_unsubscribe_email]" {{if $detail.bsn_unsubscribe_email eq 1}} checked="checked"  {{/if}}/> 
          ...
          <tr>
            ...
            <table id="none-table" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td width="155" style="padding-top: 25px !important;"><strong>Lot/DP:</strong></td>
					<th style="padding-top: 25px !important;">
						<input type="text"  name="{{$TABLE}}[bsn_lot_dp]" value="{{$detail.bsn_lot_dp}}" class="vsml" style="width:280px;" />
					</th>
				</tr>
    		</table></th>
         </tr>
