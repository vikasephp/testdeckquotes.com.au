        ...
        <table cellpadding="5" border="1" cellspacing="0" width="100%">
          ...
          <!--  <td style="text-align:center;">
            ...
            <td style="text-align:center;">
                ...
                <a href="/business.download_content?file_name={{ $item.checklist_entities_referral.assessment_doc }}&module_name=business.detail" target="_blank">Link</a>
              {{/if}}
            </td>
            
            <td>
                 {{if !empty($item.checklist_entities_referral.condition_snapshot) }}
                <a href="/business.download_content?file_name={{ $item.checklist_entities_referral.condition_snapshot }}&module_name=business.detail" target="_blank">Link</a>
                {{/if}}
            </td>
...
$("#checklist_entities_referral_btn_cancel").click(function(){  parent.hideiFrame('entitesListChecklist1');  })
