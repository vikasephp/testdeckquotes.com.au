 ...
 <input type="text" autocomplete="off"  name="{{$TABLE}}[bsn_advertLink]" value="{{$detail.bsn_advertLink}}" class="vsml" style="width:240px;" />
  ...
  <input type="checkbox" value="1" name="{{$TABLE}}[bsn_unsubscribe_email]" {{if $detail.bsn_unsubscribe_email eq 1}} checked="checked"  {{/if}}/> 
      ...
      <p id='op'><a href="{{$pro_street_checklist[0].pst_link}}" target="_blank">Click Here to open link</a> </p>
        ...
        {{elseif $detail.bsn_sales_pathway eq 2}}
         <input type="text" value="{{$pro_street_checklist[1].pst_link}}" id="box" style="width:300px;height:22px; display:inline-block; border:1px solid #666; background:#0C0;cursor:pointer;">
          <p id='op'><a href="{{$pro_street_checklist[1].pst_link}}"  target="_blank">Click Here to open link</a></a>
        ...
        {{elseif $detail.bsn_sales_pathway eq 3}}
         ...
         <p id='op'> <a href="{{$pro_street_checklist[2].pst_link}}"  target="_blank">Click Here to open link</a></a>
        ...
        {{elseif $detail.bsn_sales_pathway eq 4}}
           ...
           <p id='op'> <a href="{{$pro_street_checklist[3].pst_link}}"  target="_blank">Click Here to open link</a></a>
        ...
        <input type="text" value="{{$pro_street_checklist[4].pst_link}}" id="box" style="width:300px;height:22px; display:inline-block; border:1px solid #666; background:#b6b6b6;cursor:pointer;">
         <p id='op'> <a href="{{$pro_street_checklist[4].pst_link}}"  target="_blank">Click Here to open link</a></a>
        ...
        {{elseif $detail.bsn_sales_pathway eq 6}}
         ...
         <p id='op'> <a href="{{$pro_street_checklist[5].pst_link}}"  target="_blank">Click Here to open link</a></a>
        {{/if}}
        </td>
       ...
       <td colspan="2"><input type="text"  name="{{$TABLE}}[bsn_live_proj_calendar]" value="{{$detail.bsn_live_proj_calendar}}" class="vsml" style="width:480px;" /> </td>
        </tr>
        
        <tr>
        <td> </td>
        <td style="width:175px;" > <b>Site Camera:</b> </td>
       <td colspan="2"><input type="text"  name="{{$TABLE}}[bsn_site_camera]" value="{{$detail.bsn_site_camera}}" class="vsml" style="width:480px;" /> </td>
        </tr>
        
        <tr>
        <td> </td>
        <td style="width:175px;" > <b>Document Click :</b> </td>
       <td colspan="2"><input type="text"  name="{{$TABLE}}[bsn_document_click]" value="{{$detail.bsn_document_click}}" class="vsml" style="width:480px;" /> </td>
        </tr>
        </table>
        </td>
      </div>
    ...
    <tr>
      ...
      <div id="michael1" style="width: 1250px; background: #FFFFFF; display: block;" align="center">
            ...
            {{/if}} 
              ...
              <tr>
                <th colspan="10" bgcolor="#FFFFFF"> <iframe name="qaIframe_list" id="qaIframe_list"  src="" frameborder="0" scrolling="yes" hspace=10 vspace=5 width="100%" onload="javascript:closeTop();" style="overflow-x: hidden; overflow-y: scroll; " ></iframe>
                  <div id="divaqsection">
                    <iframe name="qaIframe" id="qaIframe" src="" frameborder="0" scrolling="no" height="600px;" hspace=10 vspace=5 width="100%" onload="javascript:closeTop();" ></iframe>
                  </div></th>
              </tr>
              {{else}}
              <tr>
...
{{/if}}
    ...
    {{if $detail.bsn_id}} 
              <table id="list-table2" width="100%" cellpadding="0" cellspacing="0" border="1" bgcolor="#FFFFFF" style="border:1px solid #999 !important">
                <tr>
                  ...
                  <th height="50" width="8%" style="text-align:center !important;">Invoice Sent</th>
                  <th height="50" width="8%" style="text-align:center !important;">Invoice Due Date</th>
                  <th height="50" width="8%" style="text-align:center !important;">When Payment Received</th>
                  <th height="50" width="6%" style="text-align:center !important;">Default Interest</th>
              ...
              {{foreach from=$progress_payment_detail item="pritem" key="prkey"}}
                <tr>
                  ...
                  <td> <input type="text"  name="payment[{{$pritem.ppd_id}}][ppd_percent]" value="{{$pritem.ppd_percent}}" id ="pr{{$pritem.ppd_id}}" style="width:35px;"  /> </td>
                  <td> <input type="text"  name="payment[{{$pritem.ppd_id}}][ppd_hia_value]" value="{{$pritem.ppd_hia_value}}" id ="pr{{$pritem.ppd_id}}" style="width:50px;"  /> </td>
                
                  <td> <input type="text"  name="payment[{{$pritem.ppd_id}}][ppd_value]" value="{{$pritem.ppd_value}}" id ="pr{{$pritem.ppd_id}}" style="width:50px;"  /> </td>
...
<hr />
      ...
      C <input type="text" name="payment[{{$pritem.ppd_id}}][ppd_completed_date]" value="{{$pritem.ppd_completed_date}}" id ="demo2_{{$pritem.ppd_id}}" class="w16em dateformat-d-ds-m-ds-Y" style="width:60px;" />
                  ...
                  <td><input type="file" name="doc_{{$pritem.ppd_id}}" style="width:110px;" id ="pr3{{$pritem.ppd_id}}"  /> <br />
                  {{if $pritem.ppd_signoff_doc}} <a href="{{$BASE_URL}}files/progress_payment_doc/{{$pritem.ppd_signoff_doc}}" target="_blank" >View/Download </a> {{/if}}
                  </td>
    
                  <td><input type="file" name="doc2_{{$pritem.ppd_id}}" style="width:110px;" /> <br />
                  {{if $pritem.ppd_invoice_sent}} <a href="{{$BASE_URL}}files/progress_payment_doc/{{$pritem.ppd_invoice_sent}}" target="_blank" >View/Download </a> {{/if}}
                  </td>
  <td> <input type="text" name="payment[{{$pritem.ppd_id}}][ppd_inv_due_date]" value="{{$pritem.ppd_inv_due_date}}" id ="demo4_{{$pritem.ppd_id}}" class="w16em dateformat-d-ds-m-ds-Y" style="width:60px;" />
  </td> 
                  <td><input type="text"  name="payment[{{$pritem.ppd_id}}][ppd_when_payrec]" value="{{$pritem.ppd_when_payrec}}" id ="demo3_{{$pritem.ppd_id}}"  class="w16em dateformat-d-ds-m-ds-Y" style="width:60px;"   />  </td>
                  <td>
...
{{/if}}
           ...
           <div id="country300" class="tabcontent"> {{if $detail.bsn_id}}
            <input type="button" name="addfile" value="Compose Email" onclick="javascript:modelwindow('{{$BASE_URL}}{{$XFA.checklistemail}}/bus_id/{{$detail.bsn_id}}','90%','90%', 'yes');" id="addfile" class="vsml" />
            &nbsp;
            ...
            <table id="none-table" width="100%" cellpadding="0" cellspacing="0" border="1" bgcolor="#FFFFFF">
              ...
              <tr>
                <th colspan="10">
                      ...
                      <th width="25%"> Document Attached </th>
                      <th width="25%"> Template Attached </th>
                       <th width="6%"> View Content </th>
                      </tr>
                     ...
                     <td style="text-align:left;">{{$item.elog_to}} {{if $item.elog_to_secondary}} <br /> {{$item.elog_to_secondary}} {{/if}} </td>
                     <td style="text-align:left;">{{$item.elog_subject}} </td>
                     <td style="text-align:left;">{{$item.elog_business}} </td>
                     <td style="text-align:left;">{{$item.elog_doc_attached}} </td>
                     <td style="text-align:left;">{{$item.elog_temp_attached}} </td>
...
<script type="text/javascript"> 
		...
		function process(bsn_id, doc_id)
		{
		...
		// $.ajax({
		//	   type: "GET",
		//	   url: "http://www.deckquotes.com.au/business.not_required_save/bsn_id/"+bsn_id+"/doc_id/"+doc_id+"/value/"+value,
			  //// data: "bsn_id =" + id,
		//	   success: function(result){
		//		//// $("#somewhere").html(result);
		//		////alert("Updated successfully");
