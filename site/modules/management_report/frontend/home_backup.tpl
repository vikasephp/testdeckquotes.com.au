...
.wrapper1, .wrapper2{width: 2000px; border: none 0px RED; overflow-x: scroll; overflow-y:hidden; scrollbar-color: yellow blue; }
.wrapper1{height: 20px; }
.wrapper2{ }
.div1 {width:3020px; height: 20px; }
.div2 {width:3020px;  overflow: auto;}   
...
<!--       {{if $item.bcust_mr_pr_readyfor eq 'No'}}
       ...
       <td>{{$item.doc_date_uploaded_73}}</td>
