...
{
	var viewurl = "{{$BASE_URL}}courierbox_design_brochures.view_procedure"+ "/random/" + Math.random();	
  ...
  <table id="doclist-table" class="nav-back" width="100%">
    <thead>
      <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="200">Design Number</th>
        <th class="topmenu" align="center" valign="middle" width="200">Brochures Sent </th>
        <th class="topmenu" align="center" valign="middle" width="100">Brochures Remaining</th>
    ...
    <form name="mlist" method="post">
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
        ...
        <td>{{$item.cb_design_number}}</td>
        <td>{{$item.cb_brochures_sent}}</td>
        <td>{{$item.cb_brochures_remaining}} [Printed]</td>
