...
<table cellpadding="0" cellspacing="0" width="100%" class="pur" >
 ...
 <!--   <th width="5%">Action</th>-->
    ...
    <th width="10%">Quote 1</th>
    <th width="10%">Quote 2</th>
    <th width="10%">Quote 3</th>
    <th width="10%">Selected Supplier</th>
    <th width="10%">Value</th>
    <th width="10%">Purchase Order</th>
    <th width="8%">Acceptance Date</th>
  </tr>
   <form name="nr" method="post" action="">
...
<input class="switch-input" type="checkbox"  name="hide[{{$item.po_id}}]" value="0"  onclick="this.form.submit();" {{if $item.po_relevant eq 0 }} checked="checked" {{/if}} />
    ...
    {{ if $item.po_supplier1}}<a href="javascript:modelwindow('{{$BASE_URL}}business.accept_quote/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/1','90%','90%', 'yes');">{{$item.po_supplier1}}</a>
 {{else}}
     <a href="javascript:modelwindow('{{$BASE_URL}}business.upload_quote/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/1','90%','90%', 'yes');">Upload Quote</a>   
    {{/if}}</td>
   <!-- <td style="text-align:center;">{{$item.doc_date_uploaded|date_format:"%d/%m/%Y"}}</td>-->
    <td style="text-align:center;">
     {{ if $item.po_supplier2}}<a href="javascript:modelwindow('{{$BASE_URL}}business.accept_quote/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/2','90%','90%', 'yes');">{{$item.po_supplier2}}</a>
 {{else}}
     <a href="javascript:modelwindow('{{$BASE_URL}}business.upload_quote/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/2','90%','90%', 'yes');">Upload Quote</a>   
    {{/if}}
    
    </td>
    <td style="text-align:center;">
     {{ if $item.po_supplier3}}<a href="javascript:modelwindow('{{$BASE_URL}}business.accept_quote/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/3','90%','90%', 'yes');">{{$item.po_supplier3}}</a>
 {{else}}
     <a href="javascript:modelwindow('{{$BASE_URL}}business.upload_quote/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/3','90%','90%', 'yes');">Upload Quote</a>   
    {{/if}}
    
    </td>
    <td style="text-align:center;">{{$item.po_accepted_supplier}}</td>
    <td style="text-align:center;">{{$item.po_accepted_value}}</td>
    ...
    <td style="text-align:center;">{{$item.po_acceptance_date}}</td>
...
<input class="switch-input" type="checkbox"  name="hide[{{$item.po_id}}]" value="0"  onclick="this.form.submit();" {{if $item.po_relevant eq 0 }} checked="checked" {{/if}} />
    ...
    {{ if $item.po_supplier1}}<a href="javascript:modelwindow('{{$BASE_URL}}business.accept_quote_custom/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/1','90%','90%', 'yes');">{{$item.po_supplier1}}</a>
 {{else}}
     <a href="javascript:modelwindow('{{$BASE_URL}}business.upload_quote_custom/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/1','90%','90%', 'yes');">Upload Quote</a>   
    {{/if}}</td>
   <!-- <td style="text-align:center;">{{$item.doc_date_uploaded|date_format:"%d/%m/%Y"}}</td>-->
    <td style="text-align:center;">
     {{ if $item.po_supplier2}}<a href="javascript:modelwindow('{{$BASE_URL}}business.accept_quote_custom/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/2','90%','90%', 'yes');">{{$item.po_supplier2}}</a>
 {{else}}
     <a href="javascript:modelwindow('{{$BASE_URL}}business.upload_quote_custom/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/2','90%','90%', 'yes');">Upload Quote</a>   
    {{/if}}
    
    </td>
    <td style="text-align:center;">
     {{ if $item.po_supplier3}}<a href="javascript:modelwindow('{{$BASE_URL}}business.accept_quote_custom/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/3','90%','90%', 'yes');">{{$item.po_supplier3}}</a>
 {{else}}
     <a href="javascript:modelwindow('{{$BASE_URL}}business.upload_quote_custom/bus_id/{{$item.po_bsn_id}}/poid/{{$item.po_id}}/qid/3','90%','90%', 'yes');">Upload Quote</a>   
    {{/if}}
