...
<input type="text" name="keyword" value="{{$keyword}}" style="width:400px;" placeholder="Search for Software"/>
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                   ...
                   <th class="topmenu" align="center" valign="middle" width="20%">Software Name</th>   
		   <th class="topmenu" align="center" valign="middle" width="60%">URL</th> 	
