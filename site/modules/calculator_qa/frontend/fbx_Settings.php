...
// module names
$MODULE_SINGULAR = 'Calculator Question Answer';
$MODULE_PLURAL = 'Calculator Questions Answers';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'calculator_question_answer';
$ID = 'qa_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/design_qa_doc/'.$zipfile, S3::ACL_PRIVATE)) {
