      ...
      <thead>
        <tr>
         <th align="center" width="20%">Search By Project Name:&nbsp;</th>
          <td><input type="text" style="width:200px;" name="{{$TABLE}}[bsn_name]" value="{{$detail.bsn_name}}"/></td>
          ...
          <th width="20%">Search By position:&nbsp;</th>
          <td><input type="text" style="width:200px;" name="{{$TABLE}}[p_name]" value="{{$detail.p_name}}" /></td>
          ...
          <td><div><input type="submit" value="Export Q/A" name="exportw" /></div></td>
        </tr>
      </thead>
    </form>
  </table>
