...
if (!empty($submit)) {
    ...
    $qandasql = "SELECT business.bsn_id, business.bsn_name, bus_customers.bcust_id, bus_customers.bcust_fname, bus_customers.bcust_lname, business_qa.bqa_id,
		     business_qa.bqa_unique_id, business_qa.bqa_bsn_id, business_qa.bqa_cust_id, business_qa.bqa_que, business_qa.bqa_ans,  business_qa.bqa_ans_plain, business_qa.bqa_created_date,
			 business_qa.bqa_ans_date, business_qa.bqa_notes, business_qa.bqa_status,  positions.p_name, business_qa.bqa_attachment_ques_1, business_qa.bqa_attachment_ques_2, business_qa.bqa_attachment_ques_3, business_qa.bqa_attachment_ques_4, business_qa.bqa_attachment_ques_5, business_qa.bqa_attachment_ans_1, business_qa.bqa_attachment_ans_2, business_qa.bqa_attachment_ans_3, business_qa.bqa_attachment_ans_4, business_qa.bqa_attachment_ans_5, business_qa.show_in_planning_approval
			 FROM business_qa 
    ...
    $qandasql = "SELECT business.bsn_id, business.bsn_name, bus_customers.bcust_id, bus_customers.bcust_fname, bus_customers.bcust_lname, business_qa.bqa_id,
             business_qa.bqa_unique_id, business_qa.bqa_bsn_id, business_qa.bqa_cust_id, business_qa.bqa_que, business_qa.bqa_ans_plain, business_qa.bqa_created_date, business_qa.bqa_ans,
			 business_qa.bqa_ans_date, business_qa.bqa_notes, business_qa.bqa_status,  positions.p_name, business_qa.bqa_attachment_ques_1, business_qa.bqa_attachment_ques_2, business_qa.bqa_attachment_ques_3, business_qa.bqa_attachment_ques_4, business_qa.bqa_attachment_ques_5, business_qa.bqa_attachment_ans_1, business_qa.bqa_attachment_ans_2, business_qa.bqa_attachment_ans_3, business_qa.bqa_attachment_ans_4, business_qa.bqa_attachment_ans_5, business_qa.show_in_planning_approval	
			FROM business_qa 
			LEFT JOIN bus_customers ON bus_customers.bcust_id = business_qa.bqa_cust_id 
			LEFT JOIN business ON business.bsn_id = business_qa.bqa_bsn_id
...
//$sql_ans = "SELECT bqa_id , bqa_ans  from business_qa";
//$dataans = $fwDb->query($sql_ans);
//
