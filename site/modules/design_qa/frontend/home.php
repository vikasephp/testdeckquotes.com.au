...
if(!empty($submit))
{
	$heading = "Design Questions ans Answer";

	$qasql = "SELECT design_question_answer.qa_id, design_question_answer.qa_question, design_question_answer.qa_answer, 
	          design_question_answer.qa_last_updated, design_question_answer.qa_qed from design_question_answer order by qa_id ASC ";	
...
$fwViewData['title'] = $MODULE_PLURAL;
	...
	$tabledoc = new Fw_Db_Table('design_fact_sheet_doc');
