...
{
	var viewurl = "{{$BASE_URL}}design_qa.view_procedure"+ "/random/" + Math.random();	
    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                ...
                <th class="topmenu" align="center" valign="middle" width="15%">Image</th> 
...
<tbody>
 ...
 {{/if}}    
    ...
    <td style="color:#000;">
        ...
        <a href="/design_qa.download_content?file_name={{$item.qa_attachment}}&module_name=design_qa.home" >{{ $item.qa_attachment}}</a>
       <!--  <a href = "https://deckquote.s3.amazonaws.com/files/design_qa_doc/{{$item.qa_attachment}}?dummy={{$ran}}" target="_blank">
         {{ $item.qa_attachment}}  </a> -->
        {{/if}}
    </td>
    <td>{{if $item.qa_image}}<img src="https://deckquote.s3.amazonaws.com/files/design_qa_doc/{{$item.qa_image}}"style="width:100%;cursor:pointer;" 
    onclick="onClick(this)" class="w3-hover-opacity"  /> {{/if}}</td>
