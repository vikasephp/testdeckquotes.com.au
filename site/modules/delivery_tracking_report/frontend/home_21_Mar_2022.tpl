...
.note {padding:0 !important; border-radius:0 !important; }
#list-table td {padding:2px !important; }
</style>
...
<div id="">
 ...
 {{foreach from=$list key="key" item="item"}}
     ...
     {{/if}}	
        ...
        <td style="background:{{$color[$item.dtr_windows_doors_opt]}}" id="lp_{{$item.dtr_id}}">
         <input type="text" name="delivery[dtr_windows_doors_notes][{{$item.dtr_id}}]"  value="{{$item.dtr_windows_doors_notes}}" class="note"  /> 
       ...
       <a href="javascript:appendRowLp({{$item.dtr_id}})"  value="Add New Feature" title="Add Feature">
                <img style="margin-top:0px;" src="{{$BASE_URL}}css/admin/images/add_notes.png"/></a>
                 <script type="text/javascript">
				var x=0;
				function appendRowLp(did)
				{
				 x=x+1;
				 var d = ' id='+'"demo99_'+did+'"';
				
				 var row='';
				 row =  row + '<input type="text" class="note">';
				 row =  row + '<input type="text" class="w16em dateformat-d-ds-m-ds-Y dtpic"' +d+'>';
                 		 var lp = "#lp_"+did;
				 alert(row);
				 $(lp).append(row);
				}
        ...
        <input type="text" name="delivery[dtr_wall_roof_frame_notes][{{$item.dtr_id}}]"  value="{{$item.dtr_wall_roof_frame_notes}}" class="note"  />
        ...
        <input type="text" name="delivery[dtr_floor_system_notes][{{$item.dtr_id}}]"  value="{{$item.dtr_floor_system_notes}}" class="note"  />
        ...
        <input type="text" name="delivery[dtr_bricks_notes][{{$item.dtr_id}}]"  value="{{$item.dtr_bricks_notes}}" class="note"  />
        ...
        <td style="background:{{$color[$item.dtr_bricks_acc_opt]}}">
         <input type="text" name="delivery[dtr_bricks_acc_notes][{{$item.dtr_id}}]"  value="{{$item.dtr_bricks_acc_notes}}" class="note"  />
         ...
         <input type="text" name="delivery[dtr_close_up_notes][{{$item.dtr_id}}]"  value="{{$item.dtr_close_up_notes}}" class="note"  />
        ...
        <td style="background:{{$color[$item.dtr_proj_incl_opt]}}">
         <input type="text" name="delivery[dtr_proj_incl_notes][{{$item.dtr_id}}]" value="{{$item.dtr_proj_incl_notes}}" class="note"/>
        ...
        <input type="text" name="delivery[dtr_proj_add_notes][{{$item.dtr_id}}]" value="{{$item.dtr_proj_add_notes}}" class="note"/>
        ...
        <td style="background:{{$color[$item.dtr_garage_door_opt]}}">
         <input type="text" name="delivery[dtr_garage_door_notes][{{$item.dtr_id}}]" value="{{$item.dtr_garage_door_notes}}" class="note"/>
        ...
        <input type="text" name="delivery[dtr_interior_fit_notes][{{$item.dtr_id}}]" value="{{$item.dtr_interior_fit_notes}}" class="note"/>
        ...
        <input type="text" name="delivery[dtr_wall_floor_tile_notes][{{$item.dtr_id}}]" value="{{$item.dtr_wall_floor_tile_notes}}" class="note"/>
        ...
        <input type="text" name="delivery[dtr_water_tank_notes][{{$item.dtr_id}}]" value="{{$item.dtr_water_tank_notes}}" class="note"/>
        ...
        <input type="text" name="delivery[dtr_window_cov_notes][{{$item.dtr_id}}]" value="{{$item.dtr_window_cov_notes}}" class="note"/>
        ...
        <input type="text" name="delivery[dtr_floor_cov_notes][{{$item.dtr_id}}]" value="{{$item.dtr_floor_cov_notes}}" class="note"/>
