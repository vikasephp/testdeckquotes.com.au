	    ...
	    if($status == 'Yes') {
			   ...
			   //$to = 'manojsoniephp@gmail.com';
		        ...
		        // Email To Customer Function Ends
				 ...
				 $message2 .= '<p>A new warranty issue has been lodged. The record number is '.$opr.'. Please review the new issue in the <a href="https://deckquotes.com.au/warranty_log.home">Warranty log.</a></p><br>'; 
