...
// module names
$MODULE_SINGULAR = 'Design Development';
$MODULE_PLURAL = 'Design Development';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'design_development';
$ID = 'dd_id';
	...
	include_once $filetoinclude;
        ...
        try {
           ...
           $s3 = new S3(ACCESS_KEY, SECRET_KEY);
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/mistake_log/'.$zipfile, S3::ACL_PRIVATE)) {
