    ...
    <tr>
     ...
     <td>
   	<datalist id='project'>
         ...
         <input type="text" list = 'project' name="{{$TABLE}}[cse_project]" style ="width:700px" value="{{$detail.cse_project}}" />
      </td>
    </tr>
   
    <tr>
     <th>Location</th>
     <td><select name="{{$TABLE}}[cse_location]"/>
          <option value="North" {{if $detail.cse_location  eq 'North'}} selected="selected" {{/if}}>North</option>
          <option value="South" {{if $detail.cse_location  eq 'South'}} selected="selected" {{/if}}>South</option>
         </select>  
    </td>
    </tr> 
