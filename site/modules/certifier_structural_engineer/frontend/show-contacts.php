...
//		  
	$matsql = "SELECT contacts.* , companies.co_company_name, type_options.to_option, contacts_position.cp_name from contacts 
		Inner join companies ON contacts.cs_company = companies.co_id 
		Left join type_options on contacts.cs_position = type_options.to_id 
		Left Join contacts_position on contacts_position.cp_id = contacts.cs_position_code 
		where companies.co_id = ".$co_id ." order by contacts.cs_is_primary desc ";	  
