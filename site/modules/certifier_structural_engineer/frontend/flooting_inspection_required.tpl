...
<div align="center" style="min-height:350px; z-index:9999999;">
    <h3 class="page-title"><br />Flooting Inspections - Required Documents</h3>    
...
<table id="list-table" width="99%">
        ...
        <td {{if  $data478.doc_not_required eq 1}} style="background:#999;"
            {{elseif $data478.doc_file_name}} style="background:#00CC33;"  {{else}} style="background:#F00;" {{/if}} id = "floorf{{$item.bsn_id}}">
