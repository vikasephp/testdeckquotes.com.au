<?php
$fwMainView = 'file:' . getcwd() . '/slab_inspection_required.tpl';
...
$sql_dataSupplier148 = "SELECT sa_include_supplier FROM supplier_certifier where sa_bsn_id = ".$bsn_id." and sa_car_id = 148";
$data_148 = $fwDb->query($sql_dataSupplier148);
$fwViewData['dataSupplier148'] = $data_148;
...
$fwViewData['insp_type'] = 'slab';
$fwViewData['return_fuse'] = 'slab_inspection_required';
$fwViewData['docdata'] = cse_load_extra_docs($fwDb, $bsn_id, 'slab');
