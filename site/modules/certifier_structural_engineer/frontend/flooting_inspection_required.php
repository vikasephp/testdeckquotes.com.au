<?php
$fwMainView = 'file:' . getcwd() . '/flooting_inspection_required.tpl';
...
$sql_653 = "select doc_not_required , doc_file_name from document_check_list where doc_bsn_id = ".$bsn_id. " and  	doc_name_id  = 653 ";
$fwViewData['data653'] = $fwDb->queryOne($sql_653);

$sql_478 = "select doc_not_required  , doc_file_name from document_check_list where doc_bsn_id = ".$bsn_id. " and  	doc_name_id  = 478 ";
$fwViewData['data478'] = $fwDb->queryOne($sql_478);
...
$sql_dataSupplier478 = "SELECT sa_include_supplier FROM supplier_certifier where sa_bsn_id = ".$bsn_id." and sa_car_id = 478";
$data_478 = $fwDb->query($sql_dataSupplier478);
$fwViewData['dataSupplier478'] = $data_478;

$sql_dataSupplier653 = "SELECT sa_include_supplier FROM supplier_certifier where sa_bsn_id = ".$bsn_id." and sa_car_id = 653";
$data_653 = $fwDb->query($sql_dataSupplier653);
$fwViewData['dataSupplier653'] = $data_653;
