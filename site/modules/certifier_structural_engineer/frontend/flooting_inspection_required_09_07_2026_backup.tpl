...
<table id="list-table" width="99%">
        ...
        <td style="width:40%"> 
        {{ $docIncludeSupplier[478] }} <br />
        <a href="{{$BASE_URL}}certifier_structural_engineer.include_suppliers/car_id/478" class="various kill_others">Include Supplier</a><br><br>
        </td>
