...
<table id="list-table" width="99%">
        ...
        <td style="width:40%"> 
        {{ $docIncludeSupplier[663] }} <br />
        <a href="{{$BASE_URL}}certifier_structural_engineer.include_suppliers/car_id/663" class="various kill_others">Include Supplier</a><br><br>
        </td>
