...
<div align="center" style="min-height:350px; z-index:9999999;">
    <h3 class="page-title"><br />Pier Inspections - Required Documents</h3>    
...
<table id="list-table" width="99%">
        ...
        <select name="pier_insp[cse_se_design]" onChange="update_doc_checklist({{$bsn_id}}, this.value, 116)" >
        ...
        <select name="pier_insp[cse_comm_notice]" onChange="update_doc_checklist({{$bsn_id}}, this.value, 235)">
