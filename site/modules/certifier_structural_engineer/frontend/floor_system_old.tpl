...
<div id="">
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                   ...
                   <th class="topmenu" align="center" valign="middle" width="5%">Surveyor Site Set Out</th> 
                   <th class="topmenu" align="center" valign="middle" width="5%">Site Setup Report</th> 
                   ...
                   <th class="topmenu" align="center" valign="middle" width="8%">Drainage Report</th> 
                   ...
                   <th class="topmenu" align="center" valign="middle" width="8%">Termite Protection Penetration</th>
                   <th class="topmenu" align="center" valign="middle" width="8%">Termite Protection Perimeter</th>
                   <th class="topmenu" align="center" valign="middle" width="8%">Slab Inspection</th>
                   <th class="topmenu" align="center" valign="middle" width="8%">Floor System Quality Assurance Report</th>
                   <th class="topmenu" align="center" valign="middle" width="8%">Post Slab Clean Report</th>
                   <th class="topmenu" align="center" valign="middle" width="8%">Survey ID Document</th> 
                   <th class="topmenu" align="center" valign="middle" width="8%">Site Works Complete Report</th>
                   <th class="topmenu" align="center" valign="middle" width="8%">Move To Close Up</th>
 ...
 {{foreach from=$list key="key" item="item"}}
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <td>{{$item.cs_id}}</td>
        <td {{if $item.cs_fs_user}} style="background: #0C3;" {{/if}}>
        ...
        <td>{{$item.pt_name}}</td>
        <td {{if $item.doc_file_name_254}} style="background:#00CC33;"  
        ...
        <td {{if $item.doc_file_name_647}} style="background:#00CC33;" 
       ...
       <select name name="fs_pier[{{$item.cs_id}}]" onChange="update_pier({{$item.cs_id}}, this.value)" >
   	 ...
   	 <td {{if $item.doc_file_name_654}} style="background:#00CC33;" 
  ...
  <!--    <td {{if $item.cs_termite_pro_para eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "tpp{{$item.cs_id}}"> -->
    ...
    {{/if}}
      ...
      {{if $item.doc_file_name_240}}
        ...
        <select name name="fs_slab[{{$item.cs_id}}]" onChange="update_slab_insp({{$item.cs_id}}, this.value)" >
       ...
       <td {{if $item.floor_system}} style="background:#00CC33;" 
       ...
       <select name name="fs_qa[{{$item.cs_id}}]" onChange="update_qa_ass({{$item.cs_id}}, this.value)" >
      ...
      <!-- <td  {{if $item.cs_fs_postslab eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "psc{{$item.cs_id}}">-->
       ...
       <td {{if $item.doc_file_name_665}} style="background:#00CC33;" 
       ...
       <select name name="fs_qa[{{$item.cs_id}}]" onChange="update_post_slab({{$item.cs_id}}, this.value)" >
      ...
      {{/if}}
       ...
       {{elseif $item.cs_survey_id eq 0}} style="background:#F00;" {{else}} style="background:#999;" {{/if}} id = "sid{{$item.cs_id}}">
        ...
        <select name name="fs_survid[{{$item.cs_id}}]" onChange="update_survey_id({{$item.cs_id}}, this.value)" >
       ...
       <td {{if $item.doc_file_name_656}} style="background:#00CC33;" 
