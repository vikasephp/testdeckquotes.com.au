...
<script type="text/javascript" language="javascript" >
    ...
    frmvalidator.addValidation("data[admin_doc_name]","req", "Please Enter Document Name");
	frmvalidator.addValidation("data[admin_doc_order]","req", "Please Enter Document Order");
	frmvalidator.addValidation("data[admin_doc_proj_type][]","selone_radio", "Please Select Project Type");
</script>