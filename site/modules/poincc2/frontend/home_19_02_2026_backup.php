	...
	if (!empty($startDownloadAndAssignPoNumber)) {
		...
		if ($tableCronJobs->rowExists()) {
			...
			$fwViewData['cron_job_response']['message'] = 'Request for download files and assign PO numbers is initiated, Files will be ready to download once processing completed.';
		}
	}
