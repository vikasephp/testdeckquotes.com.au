	...
	include_once $filetoinclude;
        ...
        try {
           ...
           $s3 = new S3(ACCESS_KEY, SECRET_KEY);
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/purchase_order_invoice/'.$zipfile, S3::ACL_PRIVATE)) {
...
function fetch_file_raw_data_2($folder_path,$object_name)
{
    $filetoinclude = $_SERVER['DOCUMENT_ROOT'].'/file_upload/server/s3/S3.php'; include_once $filetoinclude;
    $bucket_name  = "deckquote";   
    ...
    try {
           ...
           file_put_contents($_SERVER['DOCUMENT_ROOT'].'/files/po_files_list/'.$file, $file_raw_data);
           return $file_path = $_SERVER['DOCUMENT_ROOT'].'/files/po_files_list/'.$file;
...
function assign_po_number_to_pdf($po_invoice_doc_name,$print_text)
{
    $curl = curl_init();
            ...
            curl_setopt_array($curl, array(
                ...
                "url": "testdeckquotes.com.au/files/po_files_list/'.$po_invoice_doc_name.'",
