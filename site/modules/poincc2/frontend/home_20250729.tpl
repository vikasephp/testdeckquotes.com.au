...
&nbsp; &nbsp;<strong> Filter By : </strong> 
 ...
 Invoice Date Search :<input type="text" name="dt_date1" id="dt1" value="{{$dt_date1_ss}}" class="w16em dateformat-d-ds-m-ds-Y" style="width:70px;"/> TO     
<input type="text" name="dt_date2" id="dt2" value="{{$dt_date2_ss}}" class="w16em dateformat-d-ds-m-ds-Y" style="width:70px;"/>
 &nbsp; &nbsp;<input type="submit" value="Search" name="date_search" /> <br />

 Invoice Due Date Search :<input type="text" name="dt_due_date1" value="{{$due_dt1_ss}}" id="ddt1" class="w16em dateformat-d-ds-m-ds-Y" style="width:70px;"/> TO     
<input type="text" name="dt_due_date2" id="ddt2" value="{{$due_dt2_ss}}" class="w16em dateformat-d-ds-m-ds-Y" style="width:70px;"/>
...
<input type="submit" value="Download all files as zip" name="download_all_files_as_zip" {{$class8}}   id ="dafaz_submitBtn"/><br /><br />
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
        ...
        <td>
            ...
            {{if $item.po_invoice_doc}}
                <a href="/poincc2.download_content?file_name={{$item.po_invoice_doc}}&module_name=poincc2.home" >Download</a> 
