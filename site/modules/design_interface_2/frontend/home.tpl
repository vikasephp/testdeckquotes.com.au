...
function add_procedure()
{
 ...
 function add_type()
{
	var viewurl = "{{$BASE_URL}}design_interface_2.view_type"+ "/random/" + Math.random();	
...
<input class="switch-input" type="checkbox"  name="online[{{$item.di_id}}]" value="1"  onclick="this.form.submit();" {{if $item.di_online eq 1 }} checked="checked" {{/if}} />
   ...
   <td {{if $item.di_online_correct eq 'Yes'}} style="background:#FF0" {{elseif $item.di_online_correct eq 'No'}} style="background:#F00" {{/if}}>
    ...
    <!--<a href = 'https://deckquote.s3.amazonaws.com/files/design_interface/{{$item.di_master_project_calculator}}'>Download</a>-->
     <a href = '/design_interface_2.download_content?file_name={{$item.di_master_project_calculator}}&module_name=design_interface_2.home
'>Download</a>
    
    <br />{{$item.di_master_project_calculator_date}}{{/if}}</td>     
    <td>{{if $item.di_proposal}}
    <!--<a href = 'https://deckquote.s3.amazonaws.com/files/design_interface/{{$item.di_proposal}}'>Download</a>-->
    <a href = '/design_interface_2.download_content?file_name={{$item.di_proposal}}&module_name=design_interface_2.home'>Download</a>
    ...
    <a href = '/design_interface_2.download_content?file_name={{$item.di_brochure}}&module_name=design_interface_2.home'>Download</a>
   ...
   <!-- <a href = 'https://deckquote.s3.amazonaws.com/files/design_interface/{{$item.di_full_brochure}}'>Download</a>-->
     <a href = '/design_interface_2.download_content?file_name={{$item.di_full_brochure}}&module_name=design_interface_2.home'>Download</a>
    ...
    <a href = '/design_interface_2.download_content?file_name={{$item.di_design_summary}}&module_name=design_interface_2.home'>Download</a>
  ...
  <a href = '/design_interface_2.download_content?file_name={{$item.di_operations_calculator}}&module_name=design_interface_2.home'>Download</a> 
