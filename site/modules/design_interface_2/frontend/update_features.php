...
if(!empty($number))
{
    ...
    $sql = "Update design_interface_features_2 set dif_number = ".$value ." where dif_key_feature Like '".$feature."' Order by dif_id DESC Limit 1 ";	 
	$fwDb -> queryOne($sql);
}
...
$sql = "Update design_interface_features_2 set dif_notes = '".$value ."' where dif_key_feature Like '".$feature."' Order by dif_id DESC Limit 1 ";	 
$fwDb -> queryOne($sql);
}
