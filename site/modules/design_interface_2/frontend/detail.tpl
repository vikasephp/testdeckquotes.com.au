     ...
     <form name="detail" id="myForm" method="post" action="{{$XFA.detail}}"  enctype="multipart/form-data">
        <table id="di-table" width="90%">
            ...
            <tr>
                ...
                <td width="18">DO-<input type="text"  name="{{$TABLE}}[di_design_number_num]" value="{{$detail.di_design_number_num}}" /></td>
 ...
 row =  row + '<img style="margin-top:5px;" src="{{$BASE_URL}}css/admin/images/deletecross.png"/></a></th>';
		 ...
		 $("#lp").append(row);
				...
				function savekey(value,id,x)
				{
					...
					$(kf).attr('disabled','disabled');
					  ...
					  $.ajax({
						   type: "GET",
						   url: "{{$BASE_URL}}design_interface_2.update_features/key/"+id+"/value/"+value,
				...
				var feature = $(kf).val();
				  ...
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.update_features/number/"+id+"/value/"+value+"/feature/"+feature,
						   success: function(result){
					   }
					 });
				}
				...
				var feature = $(kf).val();
				  ...
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.update_features/notes/"+id+"/value/"+value+"/feature/"+feature,
						   success: function(result){
					   }
					 });
				}
				...
				function editnotes(value,id)
				{
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.edit_notes/id/"+id+"/value/"+value,
						   success: function(result){
					   }
					 });
				}
				...
				function editnumber(value,id)
				{
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.edit_number/id/"+id+"/value/"+value,
						   success: function(result){
					   }
					 });
				}
				...
				function update_key(kfid, value)
				{
					 $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.update_features/kfid/"+kfid+"/value/"+value,
						   success: function(result){
					   }
					 });
				...
				function delete_feature(dif_id)
				{
				    ...
				    url: "{{$BASE_URL}}design_interface_2.delete_feature/dif_id/"+dif_id,
				   // data: "bsn_id =" + id,
				   success: function(result){
             ...
             <tr>
                ...
                <td><select name="{{$TABLE}}[di_design_type]">
                 ...
                 <option value="{{$item.ta_option}}" {{if $detail.di_design_type eq $item.ta_option}} selected="selected" {{/if}}>{{$item.ta_option}}</option>
                 {{/foreach}}
          ...
          <tr> 
          <th>Live www </th>
          <td> <a href = "{{$detail.di_cgfb_design_link}}" target="_blank" > {{$detail.di_cgfb_design_link}} </a>
           <!--<input type="text"  name="{{$TABLE}}[di_cgfb_design_link]" value="{{$detail.di_cgfb_design_link}}" style="width:550px;" readonly="readonly" style="color:#F00!important;"  />--> </td>
          </tr> 
  ...
  <td> {{$last_priced_date}} </td>
       ...
       <th>Proposal</th>
          ...
          <!--<a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_proposal}}" target="_blank"> {{$detail.di_proposal}}</a>-->
          <a href = '/design_interface_2.download_content?file_name={{$detail.di_proposal}}&module_name=design_interface_2.home'>{{$detail.di_proposal}}</a>
          
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_proposal">
       ...
       <th>Brochure</th>
          ...
          <!--<a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_brochure}}" target="_blank"> {{$detail.di_brochure}}</a>-->
          <a href = '/design_interface_2.download_content?file_name={{$detail.di_brochure}}&module_name=design_interface_2.home'>{{$detail.di_brochure}}</a>
          
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_brochure"><img src="{{$BASE_URL}}images/delete-icon.png" /></a>{{/if}}
           </td>
       ...
       <!--   <a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_full_brochure}}" target="_blank"> {{$detail.di_full_brochure}}</a>
   -->      <a href = '/design_interface_2.download_content?file_name={{$detail.di_full_brochure}}&module_name=design_interface_2.home'>{{$detail.di_full_brochure}}</a>
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_full_brochure"><img src="{{$BASE_URL}}images/delete-icon.png" /></a>{{/if}}
           </td>
   ...
   <!-- <a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_design_summary}}" target="_blank">{{$detail.di_design_summary}} </a>-->
<a href = '/design_interface_2.download_content?file_name={{$detail.di_design_summary}}&module_name=design_interface_2.home'>{{$detail.di_design_summary}}</a>
       
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_design_summary" onclick="javascript:if(!confirm('Are you sure want to delete?')) return false;" title="Delete"><img src="{{$BASE_URL}}images/delete-icon.png" /></a>{{/if}} <br>
          </td>
          </tr>
...
<!--            <a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_operations_calculator}}" target="_blank">{{$detail.di_operations_calculator}}</a>--> 
            
            <a href = '/design_interface_2.download_content?file_name={{$detail.di_operations_calculator}}&module_name=design_interface_2.home'>{{$detail.di_operations_calculator}}</a>

            
            
           &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_operations_calculator" onclick="javascript:if(!confirm('Are you sure want to delete?')) return false;" title="Delete"><img src="{{$BASE_URL}}images/delete-icon.png" /></a> <br> {{/if}}
          </tr>
       ...
       <!--  <a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_master_project_calculator}}" target="_blank"> {{$detail.di_master_project_calculator}} </a>--> 
         
          <a href = '/design_interface_2.download_content?file_name={{$detail.di_master_project_calculator}}&module_name=design_interface_2.home'>{{$detail.di_master_project_calculator}}</a>
         
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_master_project_calculator"><img src="{{$BASE_URL}}images/delete-icon.png" /></a>{{/if}}
     ...
     <tr>
     <th>Case Studies:</th>
     <td colspan="2"> <input type="text"  name="{{$TABLE}}[di_case_studies]" value="{{$detail.di_case_studies}}" style="width:400px;" /></td>
     </tr>
     <tr>
     <th>MSTeams:</th>
     ...
     <td colspan="2"><a href ="{{$detail.di_brochure_link}}" target="_blank">{{$detail.di_brochure_link}} </a> </td>
        ...
        <td> 
         ...
         <a href="{{$BASE_URL}}design_interface_2.show/dd_id/{{$item.dd_id}}" class="variousnew" title="Show">
         
        <!-- <img src="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$item.di_design_image}}" height="110" />-->
         <img src="{{$item.di_design_img_data}}" height="110" />
         </a>
        
       <!--  <a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$item.di_design_image}}" download style="padding:5px;" title="download">-->
        <a href="/design_interface_2.download_content?file_name={{$item.di_design_image}}&module_name=design_interface_2.home" download style="padding:5px;" title="download">
         
         <img src="{{$BASE_URL}}images/download.png" width="16" /></a>
<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/dd_id_del/{{$item.dd_id}}" onclick="javascript:if(!confirm('Are you sure want to delete?')) return false;" title="Delete">
<img src="{{$BASE_URL}}images/delete-icon.png" style="padding-right:3px;" /></a>
       ...
       <!--  <a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_design_poster}}" target="_blank"> -->
          <a href="/design_interface_2.download_content?file_name={{$item.di_design_poster}}&module_name=design_interface_2.home" target="_blank">
         {{$detail.di_design_poster}}</a>
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_design_poster"><img src="{{$BASE_URL}}images/delete-icon.png" /></a>{{/if}}
        </td>
        <th>Design Flyer </th> <td> <input type= "file" name="a4_flyer"  />
         {{if $detail.di_a4_flyer}}
       <!--  <a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_a4_flyer}}" target="_blank"> -->
        <a href="/design_interface_2.download_content?file_name={{$item.di_a4_flyer}}&module_name=design_interface_2.home" target="_blank">
         
         {{$detail.di_a4_flyer}}</a>
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_a4_flyer"><img src="{{$BASE_URL}}images/delete-icon.png" /></a>{{/if}}
        </td>
        </tr>
        <tr> 
        <th>Design Postcard </th> <td> <input type= "file" name="design_postcard"  />
        {{if $detail.di_design_postcard}}
        <!--<a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_design_postcard}}" target="_blank">-->
        <a href="/design_interface_2.download_content?file_name={{$item.di_design_postcard}}&module_name=design_interface_2.home" target="_blank">
         
         {{$detail.di_design_postcard}}</a>
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_design_postcard"><img src="{{$BASE_URL}}images/delete-icon.png" /></a>{{/if}}
        
        </td>
        <th>Website Add </th> <td><input type= "file" name="website_add"  />
          {{if $detail.di_website_add}}
          <!--<a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_website_add}}" target="_blank">-->
           <a href="/design_interface_2.download_content?file_name={{$item.di_website_add}}&module_name=design_interface_2.home" target="_blank">
           
         {{$detail.di_website_add}}</a>
          &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_website_add"><img src="{{$BASE_URL}}images/delete-icon.png" /></a>{{/if}}
        ...
        <table width="90%" id="list-table" border="1">
				...
				if( v !== "" || x==0)
				{
					...
					row =  row + '</tr>';
					 ...
					 var insert="true";
					  $.ajax({
						   type: "GET",
						   url: "{{$BASE_URL}}/design_interface_2.save_edropbox/insert/"+insert+"/di_id/"+id,
							   success: function(result){
						   }
						 });
				  }
			  ...
			  function folder(value,id,x)
				...
				$("input").removeAttr('disabled');						
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.save_edropbox/value/"+value,
						   success: function(result){
					   }
					 });
				}
				...
				var fdv = $(fdi).val();
				  ...
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.save_edropbox/edf_value/"+edf_value+"/fdv/"+fdv,
						   success: function(result){
					   }
					 });
				}
				...
				var fdv = $(fdi).val();
				  ...
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.save_edropbox/qed_value/"+qed_value+"/fdv/"+fdv,
						   success: function(result){
					   }
					 });
				}
				...
				//alert(fp_value);
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.save_edropbox/fp_value/"+fp_value+"/fdv/"+fdv,
						   success: function(result){
					   }
					 });
				}
				...
				function update_edropbox1(fovalue,id)
				{
					  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.update_edropbox/fovalue/"+fovalue+"/id/"+id,
						   success: function(result){
					   }
					 });
				}
				...
				function update_edropbox2(fovalue,id)
				{
					if(fovalue == true) {   var edavalue = 1; 
					  ...
					  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.update_edropbox/edavalue/"+edavalue+"/id/"+id,
						   success: function(result){
					   }
					 });
				}
				...
				function update_edropbox3(fovalue,id)
				{
					if(fovalue == true) {   var qedvalue = 1; 
					  ...
					  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.update_edropbox/qedvalue/"+qedvalue+"/id/"+id,
						   success: function(result){
					   }
					 });
				}
				...
				function update_edropbox4(fpvalue,id)
				{
					...
					var fpvalue = fpvalue.replace(/\//g,'!');
					  ...
					  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.update_edropbox/fpvalue/"+fpvalue+"/id/"+id,
						   success: function(result){
					   }
					 });
				}
				...
				function delete_row(del_id)
				{
				    ...
				    url: "{{$BASE_URL}}design_interface_2.update_edropbox/del_id/"+del_id,
				   // data: "bsn_id =" + id,
				   success: function(result){
					// $("#somewhere").html(result);
				   }
			...
			function delete_folder(id)
				{
				    ...
				    url: "{{$BASE_URL}}design_interface_2.update_edropbox/dv/"+dv,
				   // data: "bsn_id =" + id,
				   success: function(result){
					// $("#somewhere").html(result);
				   }
   ...
   <script type="text/javascript"> 
		...
		if(col==4) {			
          ...
          $.ajax({
               type: "GET",
               url: "{{$BASE_URL}}design_interface_2.save_edropbox/value/"+value+"/row/"+row+"/di_id/"+di_id+"/col/"+col,
                  // data: "bsn_id =" + id,
               success: function(result){
                // $("#somewhere").html(result);
                  }
               ...
               <script type="text/javascript"> 
				...
				function savetotalprice(di_id)
				{
				 value = $("#tp").val();
				  ...
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface_2.updatetotalprice/di_id/"+di_id+"/value/"+value,
						  // data: "bsn_id =" + id,
					   success: function(result){
						// $("#somewhere").html(result);
						  }
 ...
 row =  row + '<img style="margin-top:5px;" src="{{$BASE_URL}}css/admin/images/deletecross.png"/></a></th>';
		 ...
		 $("#bfp").append(row);
			...
			function update_plan(value2, id, x)
			{
				 ...
				 $.ajax({
				   type: "GET",
				   url: "{{$BASE_URL}}design_interface_2.update_plan/id/"+id+"/value2/"+value2,
					   success: function(result){
						   //$('icn').html(result);
			...
			function updatenotes(value,id)
			{
			  ...
			  $.ajax({
				   type: "GET",
				   url: "{{$BASE_URL}}design_interface_2.update_notes/id/"+id+"/value/"+value,
					   success: function(result){
				   }
				 });
			}
			...
			function updatevalue(value,id)
			{
			  $.ajax({
				   type: "GET",
				   url: "{{$BASE_URL}}design_interface_2.update_value/id/"+id+"/value/"+value,
					   success: function(result){
				   }
				 });
			}
			...
			function delete_legend(dib_id)
			{
			     ...
			     $(dr).remove();
		            ...
		            $.ajax({
				    type: "GET",
				    url: "{{$BASE_URL}}design_interface_2.delete_legend/dib_id/"+dib_id,
		                    success: function(result){
				   }
				 });
        ...
        <!-- <a href="https://deckquote.s3.amazonaws.com/files/design_interface_2/{{$detail.di_qr_code}}">QR Code Link</a>-->
         <a href="/design_interface_2.download_content?file_name={{$detail.di_qr_code}}&module_name=design_interface_2.home">QR Code Link</a>
         
            &nbsp;<a href = "{{$BASE_URL}}design_interface_2.detail/di_id/{{$this_id}}/di_doc/di_qr_code" onclick="javascript:if(!confirm('Are you sure want to delete?')) return false;" title="Delete">
    ...
    &nbsp; &nbsp;<span id="confirm" style="display:none;"><strong>Confirmed...</strong> </span>
         ...
         <tr>
           ...
           QE'D : <label for="c2"></label> &nbsp; &nbsp;
             ...
             <a class="various" href="{{$BASE_URL}}design_interface_2.addtext/di_id/{{$this_id}}">
    ...
    <script type="text/javascript"> 
		...
		function process(di_id, dip_id)
		{
		 ...
		 $.ajax({
			   type: "GET",
			   url: "http://www.deckquotes.com.au/design_interface_2.price_approved_save/di_id/"+di_id+"/dip_id/"+dip_id+"/value/"+value,
			   // data: "bsn_id =" + id,
			   success: function(result){
				// $("#somewhere").html(result);
			   }
		...
		function savepraproved(di_id)
		{
		 ...
		 $.ajax({
			   type: "GET",
			   url: "http://www.deckquotes.com.au/design_interface_2.di_price_approved_save/di_id/"+di_id+"/value/"+pavalue,
			   // data: "bsn_id =" + id,
			   success: function(result){
				// $("#somewhere").html(result);
			   }
