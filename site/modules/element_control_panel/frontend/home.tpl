...
{
	var viewurl = "{{$BASE_URL}}element_control_panel.view_procedure"+ "/random/" + Math.random();	
...
<div id="">
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                   ...
                   <th class="topmenu" align="center" valign="middle" width="25%">Element Group</th>   
            	   <th class="topmenu" align="center" valign="middle" width="40%">Element</th>
 ...
 {{foreach from=$list key="key" item="item"}}
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <td style="text-align:center;">{{if $item.el_link}}<a href = "{{$item.el_link}}" target="_blank">Link</a>{{/if}}</td>
        <td>{{$item.el_order}}</td>
