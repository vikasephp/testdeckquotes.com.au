...
// module names
$MODULE_SINGULAR = 'Warranty Priority List';
$MODULE_PLURAL =   'Warranty Priority List';
...
$ATTRIBUTES = [
	'workmanship_defect' => [
		'name' => 'Workmanship Defect Type',
		'table' => 'warranty_log_workmanship_defect',
		'id' => 'wlwd_id',
		'option_col' => 'wlwd_name',
		'add_file' => 'add_workmanship_defect.tpl',
		'add_fle_name' => 'add_workmanship_defect',
		'view_file' => 'view_workmanship_defect.tpl',
		'view_fle_name' => 'view_workmanship_defect',
		'view_url' => BASE_URL . $BASEFOLDER . '.view_workmanship_defect',
		'delete_fle_name' => 'delete_workmanship_defect',
	]
];
$fwViewData['ATTRIBUTES'] = $ATTRIBUTES;

$BASEFOLDER = 'warranty_log2';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/warranty_log/'.$zipfile, S3::ACL_PRIVATE)) {
