    ...
    <table cellpadding="0" cellspacing="0" class="table" id="list-table" style="margin-bottom: 30px; width: 900px;">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<input type="button" name="customer_action[{{$data_log.wa_id}}]" value="Action" />
				</td>
			</tr>
			<tr>
				<td>Days Count</td>
			...
			<tr>
				...
				<td>
					...
					<a href="{{$BASE_URL}}warranty_log.reason/wa_id/{{$data_log.wa_id}}" class="various" style="display:none;">Read</a>
					<script>
