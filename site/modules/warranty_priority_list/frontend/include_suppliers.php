...
$sql2 = "SELECT companies.co_id, companies.co_company_name from companies ORDER By companies.co_company_name ASC"; 
...
if(!empty($add_suppliers))
{
	...
	foreach($supplier as $k => $v)
	{
	 ...
	 $sqlUn = "delete from supplier_email_warranty where se_wa_id = ".$wa_id." And se_co_id NOT IN ".$range;
...
$sqlc = "select wa_include_supplier from warranty_log where wa_id = ".$wa_id;
