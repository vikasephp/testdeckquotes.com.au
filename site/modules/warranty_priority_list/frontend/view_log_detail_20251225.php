...
// db($inspection_status_logs);
// $inspection_dates_array = array_column($inspection_status_logs, 'raw_date');
// array_multisort($inspection_dates_array, SORT_ASC, $inspection_status_logs);
