						...
						<div style="display: flex; gap: 10px;">
							<form style="margin: 0;" method="POST">
								{{if $data_log.wa_is_inspection_fee_required && $data_log.wa_inspection_proposed_fees == 75}}
									<input type="submit" name="paid_inspection[insepection_fee]" value="$75" style="background: green;">
								...
								{{else}}
									<input type="submit" name="paid_inspection[insepection_fee]" value="$75">
								...
								{{if $data_log.wa_is_inspection_fee_required && $data_log.wa_inspection_proposed_fees == 0}}
									<input type="submit" name="complimentary_inspection[insepection_fee]" value="Complimentary" style="background: green;">
								...
								{{else}}
									<input type="submit" name="complimentary_inspection[insepection_fee]" value="Complimentary">
