...
if(!empty($submit))
{
	...
	unset($detail[$ID]);
		...
		$detail['rr_intro_letter_link_date'] = date('d-m-Y');
		$detail['rr_intro_letter_link_user'] = $_SESSION['user']['user_name'];
		
		$detail['rr_insp_report_link_date'] = date('d-m-Y');
		$detail['rr_insp_report_link_user'] = $_SESSION['user']['user_name'];
		
		$detail['rr_work_word_link_date'] = date('d-m-Y');
		$detail['rr_work_word_link_user'] = $_SESSION['user']['user_name'];
		
		$detail['rr_work_pdf_link_date'] = date('d-m-Y');
		$detail['rr_work_pdf_link_user'] = $_SESSION['user']['user_name'];
		
		$detail['rr_ds_agr_link_date'] = date('d-m-Y');
		$detail['rr_ds_agr_link_user'] = $_SESSION['user']['user_name'];
