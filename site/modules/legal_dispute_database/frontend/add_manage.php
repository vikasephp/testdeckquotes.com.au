<?php
$fwMainView = 'file:' . getcwd() . '/' . $ATTRIBUTES['manage']['add_file'];

$fwViewData['primary_id'] = $primary_id = $ATTRIBUTES['manage']['id'];
$tableTask = new Fw_Db_Table($ATTRIBUTES['manage']['table']);
