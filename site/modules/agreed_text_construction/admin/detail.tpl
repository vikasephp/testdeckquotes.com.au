...
<input type="hidden" name="agreed_text_construction[ag_id]" value="{{$detail.$ID}}" id="eml_id"/>
...
{{if $message}} 
 ...
 {{/if}}
        ...
        <th>Agreed Text: &nbsp; </th>
        <td >
        <textarea id="editor1" class="ckeditor" name="agreed_text_construction[ag_text]">{{$detail.ag_text}}</textarea>
        </td>
        </tr>
          	
    	 <tr>
            <th>Uid:&nbsp; </th>
            <td><input type="text" name="agreed_text_construction[ag_uid]" value="{{$detail.ag_uid}}" style="width:350px;"/></td>
        </tr>
        <tr> 
