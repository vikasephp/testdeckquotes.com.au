...
$where = "WHERE 1=1 ";
if($keyword):
//$where .= "AND ".$TABLE.".sf_title LIKE '%".$keyword."'";
$where .= "AND style_formula.sf_title LIKE '%".$keyword."%'  OR style_formula.sf_component LIKE '%".$keyword."%'";
...
$matsql = "SELECT ".$TABLE.".*, style_formula_types.sft_title, style_formula.sf_timeatamp , users.user_name FROM ".$TABLE." 
LEFT JOIN style_formula_types ON style_formula_types.sft_id = ".$TABLE.".sftype_id 
LEFT JOIN users on users.user_id = style_formula.sf_user_id ".$where." ORDER BY ".$TABLE.".".$ID." ASC";	 
} 
