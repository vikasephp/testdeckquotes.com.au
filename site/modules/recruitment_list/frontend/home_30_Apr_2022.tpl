  ...
  <table id="doclist-table" class="nav-back" width="100%">
    <thead>
      <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="25%">Survey Link</th>
    ...
    <form name="mlist" method="post">
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
        ...
        <td>
           <div class="tooltip">
            {{if $item.re_survey_link}}<a href="{{$BASE_URL}}files/meeting_minutes_doc/{{$item.re_survey_link}}?dummy={{$ran}}" target="_blank" style="padding-bottom:2px;">{{$item.re_survey_link|truncate:70:"...":true}}</a>
              <span class="tooltiptext">{{$item.re_survey_link|stripslashes}}</span><br /> {{/if}} 
            </div> 
             <div class="tooltip"> 
              {{if $item.re_doc2}}<a href="{{$BASE_URL}}files/meeting_minutes_doc/{{$item.re_doc2}}?dummy={{$ran}}" target="_blank" style="padding-bottom:2px;">{{$item.re_doc2|truncate:70:"...":true}}</a>
              <span class="tooltiptext">{{$item.re_doc2|stripslashes}}</span> <br /> {{/if}}
              </div>
               <div class="tooltip">
              {{if $item.re_doc3}}<a href="{{$BASE_URL}}files/meeting_minutes_doc/{{$item.re_doc3}}?dummy={{$ran}}" target="_blank">{{$item.re_doc3|truncate:70:"...":true}}</a>
