...
// module names
$MODULE_SINGULAR = 'Finance Procedure Report';
$MODULE_PLURAL =   'Finance Procedure Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'finance_procedure';
$ID = 'fp_id';
	...
	$zipfile = $filename;
        ...
        try {
		 ...
		 $s3 = new S3(ACCESS_KEY, SECRET_KEY);
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/uploads_2024/'.$zipfile, S3::ACL_PRIVATE)) {
