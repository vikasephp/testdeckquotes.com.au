...
<table id="list-table" width="100%">
   ...
   {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
    ...
    <tr>
     <th>Document</th>
     <td><input  type="text" name="{{$TABLE}}[fp_document]"  value="{{$detail.fp_document}}" style="width:700px;" /> </td>
     </tr>
   
      
     <tr>
     <th>Link</th>
     <td><input  type="text" name="{{$TABLE}}[fp_link]"  value="{{$detail.fp_link}}" style="width:700px;" /> </td>
     </tr>  
