...
<table id="list-table" width="100%" >
     <tr>
                ...
                <th class="topmenu" align="center" valign="middle">Login Date time</th>
                <th class="topmenu" align="center" valign="middle">Logout Date Time</th>
                <th class="topmenu" align="center" valign="middle">Logged IP</th>
    ...
    <tr>
		...
		<td class="text2" align="left">{{$item.lu_login_date_time}}</td>
        <td class="text2" align="left">{{$item.lu_logout_date_time}}</td>
        <td class="text2" align="left">{{$item.lu_logged_ip }}</td>
      <!--  <td align="left">
            <a href="{{$BASE_URL}}{{$XFA.detail}}/{{$ID}}/{{$item.lu_id}}"><img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/edit.png"/></a> &nbsp;
 
            <a href="{{$BASE_URL}}{{$XFA.delete}}/{{$ID}}/{{$item.lu_id}}" onclick="javascript:if(!confirm('Are you sure you want to delete.?')) return false;">
