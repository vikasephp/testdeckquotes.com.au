...
{
	var viewurl = "{{$BASE_URL}}planning_progress_report.view_procedure"+ "/random/" + Math.random();	
  ...
  <table id="doclist-table" class="nav-back tableFixHead" width="100%">
    <thead>
      <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="8%">Hia Sign Date</th>
        <th class="topmenu" align="center" valign="middle" width="5%">Day Count</th>
        <th class="topmenu" align="center" valign="middle" width="5%">Progress</th>
        
        <th class="topmenu" align="center" valign="middle" width="7%">UID 555</th>
        <th class="topmenu" align="center" valign="middle" width="7%">UID 474</th>
        <th class="topmenu" align="center" valign="middle" width="7%">UID 312</th>
        <th class="topmenu" align="center" valign="middle" width="8%">UID 301</th>
        <th class="topmenu" align="center" valign="middle" width="8%">UID 330</th>
        <th class="topmenu" align="center" valign="middle" width="8%">UID 369</th>
        <th class="topmenu" align="center" valign="middle" width="8%">UID 340</th>
    ...
    <form name="mlist" method="post">
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
        ...
        <td style="text-align:center;" >{{$item.hia_sign_date}}</td>
        <td style="text-align:center;" >{{$item.dayscount}}</td>
        
         <td style="text-align:center;" >{{$item.task_pl_done}}/{{$item.total_pl_task}}</td>
		
        {{if $item.uid555complete eq 1 }}
        	<td style="text-align:center;" >{{$item.uid555}}</td>
        {{else}}
            <td style="background:#F00"></td>
        {{/if}}
        
        {{if $item.uid474complete eq 1 }}
        	<td style="text-align:center;" >{{$item.uid474}}</td>
        {{else}}
            <td style="background:#F00"></td>
        {{/if}}
        
        {{if $item.uid312complete eq 1 }}
        	<td style="text-align:center;" >{{$item.uid312}}</td>
        {{else}}
            <td style="background:#F00"></td>
        {{/if}}
       
        {{if $item.uid301complete eq 1 }}
        	<td style="text-align:center;" >{{$item.uid301}}</td>
        {{else}}
            <td style="background:#F00"></td>
        {{/if}}
       
        {{if $item.uid330complete eq 1 }}
        	<td style="text-align:center;" >{{$item.uid330}}</td>
        {{else}}
            <td style="background:#F00"></td>
        {{/if}}
        
        
        {{if $item.uid369complete eq 1 }}
        	<td style="text-align:center;" >{{$item.uid369}}</td>
        {{else}}
            <td style="background:#F00"></td>
        {{/if}}
        
        {{if $item.uid340complete eq 1 }}
        	<td style="text-align:center;" >{{$item.uid340}}</td>
        {{else}}
            <td style="background:#F00"></td>
        {{/if}}
