				...
				<div class='pagination'> {{if $pagenum == 1}} <span class='disabled'>
						<< previous</span>
							{{else}} <a class="pagination"
									href="{{$BASE_URL}}emaillibrary.email_log_op/pagenum/{{math equation=" x - y"
										...
										{{else}}<span class='current'>1</span> {{/if}}{{if $pagenum != 2}} <span
											...
											{{else}}<span class='current'>2</span> {{/if}}
												...
												{{else}} <span class="paginate"><a class="pagination"
															href="{{$BASE_URL}}emaillibrary.email_log_op/pagenum/{{$page_num}}"
													...
													{{else}}
														...
														{{if $page_num2 == $pagenum OR $page_num2 <= 0}} <span
															...
															{{$page_num2}}</span>
														{{else}} <a class="pagination"
																href="{{$BASE_URL}}emaillibrary.email_log_op/pagenum/{{$page_num2}}"
															...
															{{else}}
																...
																{{else}} <a class="pagination"
																		href="{{$BASE_URL}}emaillibrary.email_log_op/pagenum/{{$lastone}}"
																	...
																	{{else}}
																		...
																		{{else}} <a class="pagination"
																				href="{{$BASE_URL}}emaillibrary.email_log_op/pagenum/{{$last}}"
																			...
																			{{else}} <a class="pagination"
																					href="{{$BASE_URL}}emaillibrary.email_log_op/pagenum/{{math equation="
																					x + y" x=$pagenum y=1}}"
