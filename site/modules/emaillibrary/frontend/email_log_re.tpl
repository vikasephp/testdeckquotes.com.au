				...
				<div class='pagination'> {{if $pagenum == 1}} <span class='disabled'>
						<< previous</span>
							{{else}} <a class="pagination"
									href="{{$BASE_URL}}emaillibrary.email_log_re/pagenum/{{math equation=" x - y"
										...
										{{else}}<span class='current'>1</span> {{/if}}{{if $pagenum != 2}} <span
											...
											{{else}}<span class='current'>2</span> {{/if}}
												...
												{{else}} <span class="paginate"><a class="pagination"
															href="{{$BASE_URL}}emaillibrary.email_log_re/pagenum/{{$page_num}}"
													...
													{{else}}
														...
														{{else}} <a class="pagination"
																href="{{$BASE_URL}}emaillibrary.email_log_re/pagenum/{{$page_num2}}"
															...
															{{else}}
																...
																{{else}} <a class="pagination"
																		href="{{$BASE_URL}}emaillibrary.email_log_re/pagenum/{{$lastone}}"
																	...
																	{{else}}
																		...
																		{{else}} <a class="pagination"
																				href="{{$BASE_URL}}emaillibrary.email_log_re/pagenum/{{$last}}"
																			...
																			{{else}} <a class="pagination"
																					href="{{$BASE_URL}}emaillibrary.email_log_re/pagenum/{{math equation="
																					x + y" x=$pagenum y=1}}"
