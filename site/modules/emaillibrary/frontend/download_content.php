<?php
      ...
      if( !empty($postedData['file_name']) && !empty($postedData['module_name']) )
      {
          ...
          if($postedData['module_name'] == "emaillibrary.email_log_ms.document_check_list_files")
          {
              $folder_path = "files/document_check_list_files/";
          }
          if($postedData['module_name'] == "emaillibrary.email_log_op")
          {
              $folder_path = "files/document_check_list_files/";
          }
           if($postedData['module_name'] == "emaillibrary.email_log_re")
          {
              $folder_path = "files/document_check_list_files/";
          }
