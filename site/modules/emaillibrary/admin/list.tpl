...
{
	var viewurl = "{{$BASE_URL}}emaillibraryAdmin.show-email-content"+ "/eid/" + eid;	
...
<div style="float:left; width:100%;">
  ...
  <table id="list-table" width="99%">
    ...
    <thead>
      ...
      <tr>
        <th class="topmenu" align="center" valign="middle" width="4%">EID.</th>
        <th class="topmenu" align="center" valign="middle" width="10%">Email Code</th>
        <th class="topmenu" align="center" valign="middle" width="10%">Email Content </th>
        <th class="topmenu" align="center" valign="middle" width="7%">Business stream </th>
        <th class="topmenu" align="center" valign="middle" width="8%">I/O Email </th>
        <th class="topmenu" align="center" valign="middle" width="34%">URL </th>
        <th class="topmenu" align="center" valign="middle" width="10%">Signature </th>
        <th class="topmenu" align="center" valign="middle" width="8%">Owner</th>       
        <th class="topmenu" align="center" valign="middle" width="10%">Email Count </th>
 ...
 <td><input type="button" name="View Content" value="View Content" onclick="javascript:show_email_conent({{$item.eml_id}});" style="width:116px; height:18px; font-size:11px; line-height:17px !important; padding:0px !important" /></td>
	    ...
	    <td><a href = "{{$item.eml_url}}" target="_blank"> {{$item.eml_url}} </a></td>
     

		<td>{{$item.eml_signarure_block}}</td>
        <td>{{$item.eml_owner}}</td>
        <td>{{$item.eml_count}}</td>
