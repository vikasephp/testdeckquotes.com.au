...
{
	var viewurl = "{{$BASE_URL}}email_list.view_procedure"+ "/random/" + Math.random();	
...
<input type="text" name="keyword" value="{{$keyword}}" style="width:400px;" placeholder="Search for Email id"/>
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                   ...
                   <th class="topmenu" align="center" valign="middle" width="55%">Email</th>   
