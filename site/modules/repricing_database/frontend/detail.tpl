...
<div align="center" style="min-height:350px;">
    ...
    <!--<select name="key" id="kf" onchange="update_key({{$itemf.dif_id}}, this.value)" >-->
...
<script type="text/javascript">
 ...
 row =  row + '<img style="margin-top:5px;" src="{{$BASE_URL}}css/admin/images/deletecross.png"/></a></th>';
		...
		/* row =  row + '<td><select name="key3"  onchange="saveicon(this.value,'+id+','+x+')" disabled="disabled"><option value="0">Please Select </option>{{foreach from=$iconlists key="key2" item ="item2"}}';
		 row =  row + '<option value="{{$item2.ic_icon_name}}|Manoj"> {{$item2.ic_icon_name}}</option>' ;
		 row =  row + '{{/foreach}}</td>';*/
		 ...
		 $("#lp").append(row);
				...
				alert(value);
				  $.ajax({
					   type: "GET",
					   url: "{{$BASE_URL}}/design_interface.update_features/icon/"+id+"/value/"+value+"/feature/"+feature,
						   success: function(result){
					   }
					 });
				}*/
          ...
          <td> <a href = "{{$detail.di_cgfb_design_link}}" target="_blank" > {{$detail.di_cgfb_design_link}} </a>
           <!--<input type="text"  name="{{$TABLE}}[di_cgfb_design_link]" value="{{$detail.di_cgfb_design_link}}" style="width:550px;" readonly="readonly" style="color:#F00!important;"  />--> </td>
            ...
            <th>Last Priced: </th>
  <td> {{$last_priced_date}} 
  <!--<input type="text"  name="{{$TABLE}}[di_last_priced_date]" value="{{$detail.last_priced_date}}" id="demo3" class="w16em dateformat-d-ds-m-ds-Y" readonly="readonly" />-->
  <!--<input type="text"  name="{{$TABLE}}[di_last_priced_date]" value="{{$last_priced_date}}"  readonly="readonly" />-->
  </td>
            </tr>
          ...
          <th> Total Price </th>
          <td>  {{$total_price}}
          <!--<input type="text"  name="{{$TABLE}}[di_total_price]" value="{{$total_price}}" id="tp" onKeyUp="savetotalprice({{$detail.$ID}})" readonly="readonly" />--> </td>
        ...
        <td><input type="text" name="{{$TABLE}}[di_audited]" value="{{$detail.di_audited}}" size="20" maxlength="25" id="demo4" class="w16em dateformat-d-ds-m-ds-Y" readonly="readonly"/> </td>
         ...
         <td><input type="text"  name="{{$TABLE}}[di_checklist_number]" value="{{$detail.di_checklist_number}}" /> </td>
         </tr>
     ...
     <td colspan="2"><a href ="{{$detail.di_brochure_link}}" target="_blank">{{$detail.di_brochure_link}} </a> </td>
        ...
        <td> 
         ...
         <img src="https://deckquote.s3.amazonaws.com/files/design_interface/{{$item.di_design_image}}" height="110" /></a>
        
         <a href="https://deckquote.s3.amazonaws.com/files/design_interface/{{$item.di_design_image}}" download style="padding:5px;" title="download"><img src="{{$BASE_URL}}images/download.png" width="16" /></a>
...
<img src="{{$BASE_URL}}images/delete-icon.png" style="padding-right:3px;" /></a>
        ...
        {{if $detail.di_design_poster}}<a href="https://deckquote.s3.amazonaws.com/files/design_interface/{{$detail.di_design_poster}}" target="_blank"> 
        ...
        <th>Design Flyer </th> <td> <input type= "file" name="a4_flyer"  />
         {{if $detail.di_a4_flyer}}<a href="https://deckquote.s3.amazonaws.com/files/design_interface/{{$detail.di_a4_flyer}}" target="_blank"> 
        ...
        {{if $detail.di_design_postcard}}<a href="https://deckquote.s3.amazonaws.com/files/design_interface/{{$detail.di_design_postcard}}" target="_blank"> 
        ...
        <th>Website Add </th> <td><input type= "file" name="website_add"  />
          {{if $detail.di_website_add}}<a href="https://deckquote.s3.amazonaws.com/files/design_interface/{{$detail.di_website_add}}" target="_blank"> 
        ...
        <!-------Electronic Dropbox New Ends -------->
        
<!--        
        <table width="90%" id="di-table">
        <tr><th width="42%">Folder Name</th><th width="8%">EDF's Available </th> <th width="8%">QE'd</th>  <th width="42%">File Path </th></tr>
        
        <tr>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,1,{{$this_id}},1)" value="{{$di_dropbox[0].didb_foldername}}" /></th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,1,{{$this_id}},2)" {{if $di_dropbox[0].didb_edf_available eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,1,{{$this_id}},3)" {{if $di_dropbox[0].didb_qed eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,1,{{$this_id}},4)" value="{{$di_dropbox[0].didb_filepath}}" /> </th>
        </tr>
       
       <tr>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,2,{{$this_id}},1)" value="{{$di_dropbox[1].didb_foldername}}" /></th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,2,{{$this_id}},2)" {{if $di_dropbox[1].didb_edf_available eq 1}} checked="checked" {{/if}}  /> </th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,2,{{$this_id}},3)" {{if $di_dropbox[1].didb_qed eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,2,{{$this_id}},4)" value="{{$di_dropbox[1].didb_filepath}}" /> </th>
        </tr>
        
        <tr>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,3,{{$this_id}},1)" value="{{$di_dropbox[2].didb_foldername}}" /></th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,3,{{$this_id}},2)" {{if $di_dropbox[2].didb_edf_available eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,3,{{$this_id}},3)" {{if $di_dropbox[2].didb_qed eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,3,{{$this_id}},4)"  value="{{$di_dropbox[2].didb_filepath}}"/> </th>
        </tr>
        
        <tr>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,4,{{$this_id}},1)" value="{{$di_dropbox[3].didb_foldername}}" /></th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,4,{{$this_id}},2)" {{if $di_dropbox[3].didb_edf_available eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,4,{{$this_id}},3)" {{if $di_dropbox[3].didb_qed eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,4,{{$this_id}},4)" value="{{$di_dropbox[3].didb_filepath}}" /> </th>
        </tr>
        
        <tr>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,5,{{$this_id}},1)" value="{{$di_dropbox[4].didb_foldername}}"/></th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,5,{{$this_id}},2)" {{if $di_dropbox[4].didb_edf_available eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="checkbox" onclick="save_edropbox(this.checked,5,{{$this_id}},3)" {{if $di_dropbox[4].didb_qed eq 1}} checked="checked" {{/if}} /> </th>
            <th><input type="text" size="90" onkeyup="save_edropbox(this.value,5,{{$this_id}},4)" value="{{$di_dropbox[4].didb_filepath}}" /> </th>
        </tr>                
