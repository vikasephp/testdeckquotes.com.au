...
// module names
$MODULE_SINGULAR = 'Recorded Meeting File List';
$MODULE_PLURAL = 'Recorded Meeting File List';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'recorded_meeting';
$ID = 'rm_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/recorded_meetings/'.$zipfile, S3::ACL_PRIVATE)) {
