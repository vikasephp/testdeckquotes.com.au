...
// module names
$MODULE_SINGULAR = 'New Product Report';
$MODULE_PLURAL =   'New Product Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'new_product_report';
$ID = 'np_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/general_uploads/'.$zipfile, S3::ACL_PRIVATE)) {
