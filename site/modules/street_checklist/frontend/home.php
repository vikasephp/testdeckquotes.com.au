...
if($keyword):
$where .= "AND ".$TABLE.".sc_position LIKE '%".$keyword."%' "  ;
$_SESSION['keyword'] = $keyword;
$fwViewData['keyword']=$_SESSION['keyword'];
elseif($_SESSION['keyword'] && $pagenum > 0):
$where .= "AND ".$TABLE.".sc_position LIKE '%".$_SESSION['keyword']."%' ";
$fwViewData['keyword']=$_SESSION['keyword'];
endif;
}
...
//	else{$tdsql = "SELECT ".$TABLE.".* FROM ".$TABLE." ".$where;}
 ...
 $tdsql = "SELECT ".$TABLE.".* FROM ".$TABLE." ".$where;
...
$fwViewData['title'] = "Process Checklist Link";
