...
<form action="{{$BASE_URL}}{{$XFA.list}}" method="post" name="send_form">
    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            ...
            <th class="topmenu_list"  valign="middle" width="11%"><div align="center">Status</div></th>   
              ...
              <th class="topmenu_list" align="center" valign="middle" width="11%"><div align="center">Project Type</div></th>     
