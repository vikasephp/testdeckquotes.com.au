...
elseif($_SESSION['cbs'])
...
else
	{
		...
		$bst_business_status_id = $first_status['pt_id'];	
	}
...
$bstasksql = "SELECT ".$TABLE.".*, project_type.*, authorizearea.*, datafields.* FROM ".$TABLE." 
LEFT JOIN project_type ON ".$TABLE.".bst_business_status_id = project_type.pt_id
