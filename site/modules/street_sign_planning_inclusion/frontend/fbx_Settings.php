...
// module names
$MODULE_SINGULAR = 'Cgfb Street Sign Report Planning Inclusions';
$MODULE_PLURAL = 'Cgfb Street Sign Report Planning Inclusions';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'street_sign_pl_in';
$ID = 'ss_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/street_sign_planning_inclusions/'.$zipfile, S3::ACL_PRIVATE)) {
...
function create_ss_PDF($heading, $html, $fname)
{
$PDF_PAGE_ORIENTATION = "L";			
//$nameoffile = str_replace(" ", "_",$fname);		
$nameoffile = 'street_sign_design_report';
