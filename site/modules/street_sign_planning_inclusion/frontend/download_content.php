<?php
      ...
      if( !empty($postedData['file_name']) && !empty($postedData['module_name']) )
      {
          ...
          if($postedData['module_name'] == "street_sign_planning_inclusion.home")
          {
              $folder_path = "files/street_sign_planning_inclusions/";
          }
		...
		$object_name  = $postedData['file_name'];  $my_file_name = $postedData['file_name'];
