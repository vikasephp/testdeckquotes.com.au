...
// module names
$MODULE_SINGULAR = 'AR Invoice Q/A report';
$MODULE_PLURAL =   'AR Invoice Q/A report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'ar_invoice_qa_report';
$ID = 'ar_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/ar_invoice_qa_report/'.$zipfile, S3::ACL_PRIVATE)) {
