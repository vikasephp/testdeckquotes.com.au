...
<script type="text/javascript">
	    ...
	    var geturl= "{{$BASE_URL}}planning_meeting_minutes.doclist/mid/"; // The server-side script
	    var getdelurl= "{{$BASE_URL}}planning_meeting_minutes.docdelete/mid/"; // The server-side script
...
<div align="center">
<h3 class="page-title">Add Planning Meeting Minutes</h3>
