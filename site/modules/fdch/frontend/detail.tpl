...
<!-- <tr>
     <th> Project Name </th>
     <td> <input id="pname" type="text" name="{{$TABLE}}[cqa_project_name]" value="{{$detail.cqa_project_name}}" style="width:400px;"  /> </td>
    </tr>  
   -->
    <tr>
        ...
        <td><textarea cols="120" name="{{$TABLE}}[cqa_question]" >{{$detail.cqa_question}} </textarea>
        </td></tr></table>
         </td>
    </tr>        
    <tr>
        ...
        <td width="500">
        <table  width="500" id="none-table22"><tr><td>
        <textarea cols="120" rows="2" name="{{$TABLE}}[cqa_answer]" class="tinymce" style="height:10px;">{{$detail.cqa_answer|stripslashes}}</textarea>    
        </td></tr></table>
        </td>
    </tr>
