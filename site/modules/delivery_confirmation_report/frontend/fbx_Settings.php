...
// module names
$MODULE_SINGULAR = 'Delivery Confirmation Report';
$MODULE_PLURAL =   'Delivery Confirmation Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'delivery_confirmation_report';
$ID = 'dc_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/uploads_2023/'.$zipfile, S3::ACL_PRIVATE)) {
...
function create_warranty_PDF($heading, $html)
{
...
$nameoffile = 'home_warranty_database';
...
$pdf->SetTitle("CGFB");
$pdf->SetSubject('Home Warrany Database');
