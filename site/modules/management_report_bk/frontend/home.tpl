    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
		   ...
		   <th class="topmenu" align="center" valign="middle" width="3%">Id</th>  	            
                   <th class="topmenu" align="center" valign="middle" width="20%">Mistake</th>   
                   ...
                   <th class="topmenu" align="center" valign="middle" width="6%">Document</th>
 ...
 {{foreach from=$list key="key" item="item"}}
	...
	<td>{{$item.ml_id}}</td> 
        ...
        <select name="{{$TABLE}}[ml_priority]"  Onchange = "update_priority({{$item.ml_id}},this.value)">
          ...
          <option value="High"   {{if $item.ml_priority eq 'High'}} selected="selected" {{/if}}>High</option>
          <option value="Medium" {{if $item.ml_priority eq 'Medium'}} selected="selected" {{/if}}>Medium</option>
          <option value="Low" {{if $item.ml_priority eq 'Low'}} selected="selected" {{/if}}>Low</option>
          <option value="Not Applicable" {{if $item.ml_priority eq 'Not Applicable'}} selected="selected" {{/if}}>Not Applicable</option> 
        ...
        <td>{{if $item.ml_document}}<a href="https://deckquote.s3.amazonaws.com/files/mistake_log/{{$item.ml_document}}" /> Download {{/if}}</td>
