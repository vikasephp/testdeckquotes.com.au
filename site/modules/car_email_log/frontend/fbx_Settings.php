...
// module names
$MODULE_SINGULAR = 'Warranty Email Log';
$MODULE_PLURAL =   'Warranty Email Log';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
	    ...
	    $s3 = new S3('AKIA2AMNCYNN5VRBSNNU', '5ys4bfLGJQDLgX/Pc+E66/2Yo8jpMgjcdAn1jGKg');
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/warranty_log/'.$zipfile, S3::ACL_PUBLIC_READ)) {
