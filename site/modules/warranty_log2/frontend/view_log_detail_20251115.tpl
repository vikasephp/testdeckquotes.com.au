		...
		<tbody>
			...
			<tr>
				...
				<div class="ml-20">
					...
					<span class="ml-20">{{$data_log.wa_status_changed_date|date_format:"%d-%m-%Y"}}</span>
				</div>
				<script>
			...
			<tr>
				<td>Add Customer Action</td>
				<td>
					<input type="button" name="customer_action[{{$data_log.wa_id}}]" value="Action" onclick="window.open('{{$BASE_URL}}sales_phase_logon.warranty/bsn_id/{{$bsn_id}}/login_type/customer/type/customer-action', '_blank')" style="display:none;"/>
					<a href="{{$BASE_URL}}warranty_log2.log_customer_action/bsn_id/{{$bs_business_id}}/wa_id/{{$data_log.wa_id}}" class="various customer_action_logview">Action</a>
				</td>
			</tr>
			<tr>
				<td>Days Count</td>
			...
			<tr>
				...
				<td>
					...
					<p>
						<input type="button" name="$75" value="$75">&nbsp;&nbsp;
						<input type="button" name="a" value="A">&nbsp;&nbsp;
						<input type="button" name="complimentary" value="Complimentary">&nbsp;&nbsp;
						<input type="button" name="a" value="A">
					</p>
					<table class="ac75" id="list-table" style="display:none;width:300px;">
						<thead>
							<tr>
								<th>Action</th>
								<th>Date</th>
