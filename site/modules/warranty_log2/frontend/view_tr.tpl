	...
	<form name="detail" method="post" action="" enctype="multipart/form-data">
		...
		<table id="list-table" width="99%">
			...
			<tr>
				...
				<td><a href="{{$BASE_URL}}warranty_log.view_issue/sup_email/{{$item.se_email}}/status/Open"
						class="various" title="View">View</a></td>
				<td>{{$item.pending_alerts}}</td>
				<td><a href="{{$BASE_URL}}warranty_log.view_issue/sup_email/{{$item.se_email}}/status/Pending"
						class="various" title="View">View</a></td>
