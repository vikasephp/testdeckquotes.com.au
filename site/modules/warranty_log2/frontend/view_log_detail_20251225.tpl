		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<!-- <table class="ac75" id="list-table" style="width: 400px;">
						<thead>
							<tr>
								<th>Action</th>
								<th>Date</th>
						...
						<tbody>
							{{if $data_log.wa_is_inspection_fee_required}}
								<tr>
									...
									<td>
										{{if $data_log.wa_inspection_proposed_fees == 75}}
										$75
										{{else}}
										Complimentary
										{{/if}}
							...
							{{if $data_log.wa_is_inspection_fee_required_cancelled}}
								<tr>
									<td>Cancelled</td>
									<td>{{$data_log.wa_is_inspection_fee_required_cancelled_date}}</td>
									<td></td>
								</tr>
							{{/if}}
					...
					{{if $data_log.wa_is_inspection_fee_required}}
						<table id="view_status_at{{$item.wa_id}}" style="display: none; width: 400px; margin-top: 40px;">
							<tr>
								<th>Status</th>
								<th>Date</th>
								<th>Inspection Type</th>
							...
							<tr>
								...
								<td style="white-space: nowrap;">{{$data_log.wa_is_inspection_fee_required_date}}</td>
								<td>
									{{if $data_log.wa_inspection_proposed_fees == 75}}
									$75
									{{else}}
							...
							{{if $data_log.wa_is_inspection_fee_required_accepted}}
								<tr>
									...
									<td style="white-space: nowrap;">{{$data_log.wa_is_inspection_fee_required_accepted_date}}</td>
									<td></td>
								</tr>
								<tr>
							...
							{{if $data_log.wa_is_inspection_fee_required_scheduled}}
								<tr>
									...
									<td style="white-space: nowrap;">{{$data_log.wa_is_inspection_fee_required_scheduled_at}}</td>
									<td></td>
								</tr>
								<tr>
