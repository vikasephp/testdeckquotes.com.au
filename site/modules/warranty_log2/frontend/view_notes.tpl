		...
		<table id="list-table" width="99%">
			...
			{{if $dataN}}
				...
				<tr date-diff="{{$itemN.diff_date}}" {{if $itemN.resolved_status eq 1 }}style="background:#FFF;"{{elseif $itemN.diff_date lt 0 }} style="background:#F00;" {{/if}}>
					...
					<td>
					{{if $itemN.source_table == 'warranty_supplier_update' }}

						{{if $itemN.attachment}}
							<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/{{$itemN.attachment}}" target="_blank">Download 1</a>
						{{/if}}
						
						{{if $itemN.attachment2}}
							<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/{{$itemN.attachment2}}" target="_blank">Download 2</a>
						{{/if}}
						
						{{if $itemN.attachment3}}
							<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/{{$itemN.attachment3}}" target="_blank">Download 3</a>
						{{/if}}
						
						{{if $itemN.attachment4}}
							<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/{{$itemN.attachment4}}" target="_blank">Download 4</a>
						{{/if}}
						
						{{if $itemN.attachment5}}
							<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/{{$itemN.attachment5}}" target="_blank">Download 5</a>
						{{/if}}
					...
					{{else}}
						...
						{{if $itemN.attachment}}
							<a href="{{$BASE_URL}}files/uploads/{{$itemN.attachment}}" target="_blank">Download</a>
						{{/if}}
						
						{{if $itemN.attachment2}}
							<a href="{{$BASE_URL}}files/uploads/{{$itemN.attachment2}}" target="_blank">Download</a>
						{{/if}}
						
						{{if $itemN.attachment3}}
							<a href="{{$BASE_URL}}files/uploads/{{$itemN.attachment3}}" target="_blank">Download</a>
						{{/if}}
						
						{{if $itemN.attachment4}}
							<a href="{{$BASE_URL}}files/uploads/{{$itemN.attachment4}}" target="_blank">Download</a>
						{{/if}}
						
						{{if $itemN.attachment5}}
							<a href="{{$BASE_URL}}files/uploads/{{$itemN.attachment5}}" target="_blank">Download</a>
						{{/if}}
						
						{{if $itemN.attachment6}}
							<a href="{{$BASE_URL}}files/uploads/{{$itemN.attachment6}}" target="_blank">Download</a>
						{{/if}}
					{{/if}}
					</td>
					<td>
