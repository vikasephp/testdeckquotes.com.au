		...
		<td>
			...
			<form name="mshort" action="{{$BASE_URL}}{{$XFA.home}}" method="post">
				...
				<div style="float:left; margin-left:8px;">
					...
					&nbsp;&nbsp; <span style="border:1px solid #0CF; padding:3px;"> Open Logs : {{$tot_open.open}}
					</span>
					&nbsp;&nbsp; <span style="border:1px solid #0CF; padding:3px;">7 Day Logs : {{$tot_seven.seven}}
					</span>
					&nbsp;&nbsp; <span style="border:1px solid #0CF; padding:3px;">90 Day + Logs :
						{{$tot_ninety.ninety}} </span><br />
					<!--<strong> Supplier Search  : </strong> <input type="text" name="supp_name" width="100" /> <input type="submit" name="supplier_o" value = "Search" />-->
					<input type="submit" name="printOP" value="Print Merge Of Search result open and Pending"
						style="background:#00CC33;" /> <br />
