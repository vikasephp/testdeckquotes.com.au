...
$sql_778 = "SELECT dcl.doc_name_id, dcl.doc_file_name, dcl.doc_date_uploaded, adcl.admin_doc_name FROM `document_check_list` as dcl left join admin_document_check_list as adcl on adcl.admin_doc_id = dcl.doc_name_id where dcl.doc_bsn_id = ". $data_bsn['bs_business_id'] ." and dcl.doc_name_id = 778";
$data_778 = $fwDb->queryOne($sql_778);
$fwViewData['file_778'] = $data_778['doc_file_name'];
