					...
					<p>
						<div style="display: flex; gap: 10px;">
							<form style="margin: 0;" method="POST">
								...
								{{if $data_log.wa_is_inspection_fee_required && $data_log.wa_inspection_proposed_fees == 75}}
								...
								{{if $data_log.wa_is_inspection_fee_required && $data_log.wa_inspection_proposed_fees == 0}}
