   ...
   {{if !$opr}}
     ...
     <table id="viewdoc-table" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td> <input type="text" name="da_tracker[da_lessee_fullname]" value="{{$detail.da_lessee_fullname}}" style="width:500px;"/></td>
        </tr>
        
        <tr>
            <th> Applicant Phone:</th>
            <td> <input type="text" name="da_tracker[da_lessee_phone]" value="{{$detail.da_lessee_phone}}" style="width:300px;" /></td>
        </tr>
       
        <tr>
            <th> Applicant Email:</th>
            <td> <input type="text" name="da_tracker[da_lessee_email]" value="{{$detail.da_lessee_email}}" style="width:300px;"/></td>
        </tr> 
        <tr>
            <th> Applicant Company: </th>
            <td> <input type="text" name="da_tracker[da_lessee_company]" value="{{$detail.da_lessee_company}}"  style="width:500px;"/></td>
        </tr>
