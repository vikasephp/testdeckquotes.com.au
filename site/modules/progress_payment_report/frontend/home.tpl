...
{
	var viewurl = "{{$BASE_URL}}progress_payment_report.view_procedure"+ "/random/" + Math.random();	
...
<div style="float:left; width:100%;">
  <table id="doclist-table" class="nav-back" width="100%">
    <thead>
      <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="5%">Link</th>
   	    <th class="topmenu" align="center" valign="middle" width="5%">Floor System</th>
        <th class="topmenu" align="center" valign="middle" width="5%">Wall and Roof</th>
        <th class="topmenu" align="center" valign="middle" width="5%">Cloose Up</th>
        <th class="topmenu" align="center" valign="middle" width="5%">Fixing</th>
        <th class="topmenu" align="center" valign="middle" width="5%">Painting</th>
    ...
    <form name="mlist" method="post" enctype="multipart/form-data">
  	...
  	<label class="switch">
<input class="switch-input" type="checkbox"  name="hide[{{$item.bsn_id}}]" value="1"  onclick="this.form.submit();" {{if $item.bsn_ppr_hide  eq 1 }} checked="checked" {{/if}} />
