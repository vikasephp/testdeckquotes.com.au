...
<div style="float:right; margin-right:5%;">
 <input type="button" name="emllibrary" value="Back To Home" onclick="document.location.href='{{$BASE_URL}}planning_dates_central_database.home'" />
 </div>
...
<datalist id='project'>
   {{foreach from=$projdetail2 key="key3" item="item3"}}
    ...
    {{/foreach}}
         ...
         <!--<input type="text"  name="projname1" style ="width:700px" value="{{$p_c_name}}" />-->
         
         <input type="text"  name="projname1" style ="width:700px" value="{{$bsn_name}}" readonly="readonly" />
...
<div>
 ...
 <tr>
  <th> To (Other) </th>
  <td colspan="7"> <input type="text" name="emailData[to2]" id ="to" value="{{$bcust_misc_email1}}" style="width:700px;"   />
 </td>
