...
<table id="list-table" width="100%">
   ...
   {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
     ...
     <tr>
     <th>Document</th>
     <td><input type="text" name="{{$TABLE}}[sd_document]" style ="width:800px" value="{{$detail.sd_document}}" ></td>
    </tr>
   
   
    <tr>
    <th>Explained</th>
    <td><input type="text" name="{{$TABLE}}[sd_explained]" style ="width:800px" value="{{$detail.sd_explained}}" /></td>
    </tr>
