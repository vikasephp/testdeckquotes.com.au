...
<div id="">
 ...
 {{foreach from=$list key="key" item="item"}}
    ...
    <tr bgcolor="#FFFFFF">
        ...
        {{if $item.sd_link}}
         <a href="/sales_document_explained.download_content?file_name={{$item.sd_link}}&module_name=sales_document_explained.home" >Download</a>
         <a href="{{$BASE_URL}}sales_document_explained.delete_link/sd_id/{{$item.sd_id}}" onclick="javascript:if(!confirm('Are you sure want to delete?')) return false;" title="Delete"><img src="{{$BASE_URL}}/images/delete_icon.png" width="20" /></a>
        <br />
