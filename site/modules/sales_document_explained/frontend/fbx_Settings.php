...
// module names
$MODULE_SINGULAR = 'Sales Document Explained';
$MODULE_PLURAL =   'Sales Document Explained';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'sales_document_explained';
$ID = 'sd_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/sales_document_explained/'.$zipfile, S3::ACL_PRIVATE)) {
