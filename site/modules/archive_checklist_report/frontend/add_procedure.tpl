...
window.location.href = "{{$BASE_URL}}archive_checklist_report.view_procedure";
</script>
{{/if}}
...
<table id="list-table" width="100%">
   ...
   {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
    ...
    <tr>
     <th>Procedure </th>
     <td>
          <input type="text"  name="task[pr_procedure]" style ="width:700px" value="{{$detail.pr_procedure}}" required/>
      </td>
    </tr>
