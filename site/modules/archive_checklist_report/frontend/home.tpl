...
{
	var viewurl = "{{$BASE_URL}}archive_checklist_report.view_procedure"+ "/random/" + Math.random();	
    ...
    <table id="list-table" class="nav-back" width="100%" >
        <thead>
            <tr>
                ...
                <th class="topmenu" align="center" valign="middle" width="14%">Archived</th>
        </tr>
        </thead>
<tbody>
 ...
 <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
    ...
    <td>
     ...
     <input type="hidden" name="archive[{{$item.dpn_unique_id}}]" value="0" />
  	<label class="switch">
<input class="switch-input" type="checkbox"  name="archive[{{$item.dpn_unique_id}}]" value="1"  onclick="this.form.submit();" {{if $item.dpn_archived eq 1 }} checked="checked" {{/if}} />
