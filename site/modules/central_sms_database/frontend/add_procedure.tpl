...
<div align="center" style="min-height:350px; margin-top:50px; z-index:999999 !important;">
	<h3 class="page-title">{{$title}} - Procedure Panel</h3>
	...
	<script type="text/javascript" language="javascript">
		...
		frmvalidator.addValidation("task[pr_procedure]", "req", "Please specify Procedure Name");
		frmvalidator.addValidation("task[pr_link]", "req", "Please specify Procedure Link");
	</script>
</div>