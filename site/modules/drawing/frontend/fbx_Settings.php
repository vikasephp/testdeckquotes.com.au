...
// module names
$MODULE_SINGULAR = 'Drawing and Design';
$MODULE_PLURAL = 'Drawing and Designs';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/drawing_designs/'.$zipfile, S3::ACL_PRIVATE)) {
