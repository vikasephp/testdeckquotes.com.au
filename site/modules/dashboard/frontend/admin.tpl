 ...
 <tr><td align="left" style="padding-left:1px" valign="top" bgcolor="#FFFFFF" width="250">
  <DIV class="dtree">
		<p><a href="javascript: d.openAll();">open all</a> | <a href="javascript: d.closeAll();">close all</a></p>
            ...
            d.add(998,1201,'View/Edit','{{$BASE_URL}}proposal_task_listAdmin.list');
            d.add(999,1201,'Add','{{$BASE_URL}}proposal_task_listAdmin.detail');
...
<!--        d.add(714,712,'Add','{{$BASE_URL}}project_types_taskAdmin.detail');
 -->
         ...
         <!--   d.add(220,115,'View/Edit','{{$BASE_URL}}design_interfaceAdmin.list');-->
			...
			d.add(1202,1,'<B>Email Signature</B>');
            d.add(2003,1202,'View/Edit','{{$BASE_URL}}email_signatureAdmin.list');
            d.add(2004,1202,'Add','{{$BASE_URL}}email_signatureAdmin.detail');
