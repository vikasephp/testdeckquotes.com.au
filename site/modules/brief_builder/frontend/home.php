...
if ($wdoc) {
	...
	foreach ($imageData as $k1 => $v1) {
		$folder_path = "files/brief_builder/";
		$object_name = $v1['bb_image'];
...
$matsql = "SELECT brief_builder.* , brief_builder_catergory.* FROM brief_builder INNER JOIN brief_builder_catergory ON brief_builder.bb_catergory2 = brief_builder_catergory.bbc_id " . $where . " order by bb_label";
