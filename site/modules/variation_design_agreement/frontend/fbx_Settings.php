...
// module names
$MODULE_SINGULAR = 'Variation Design Agreement';
$MODULE_PLURAL =   'Variation Design Agreement';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'variation_design_agreement';
$ID = 'vd_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/variation_design_agreement/'.$zipfile, S3::ACL_PRIVATE)) {
