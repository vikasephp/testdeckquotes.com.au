...
if(!empty($submit))
{
	...
	{	$detail['aapl_user_created'] = $user;
		 $detail['aapl_date_time'] = $cd;
		 ...
		 $from_name = "Auction Advantage Phone Log Alert";
		 $from = "cgfb@deckquotes.com.au";
		 $subject = "New entry has been created in auction advantage phone log form";
			 
		 $html = "<html><body>";
		 $html .= "<p>Hello Team Member, </p><br>";
		 $html .= "<p>A new entry has been added in Auction Advantage Phone Log Form </p>";
		 $html .= "https://www.deckquotes.com.au/auction_advantage_phone_log.home</p><br>";
...
//		 send_email($to_name, $to9, $from_name, $from, $subject, $html, $attachment='');
		 ...
		 // $password = "3d420fed";
		  ...
		  $message  = "A new entry has been added in Auction Advantage Phone Log Form";
		  $type     = "1-way";
		  $senderid = "CGFB";
		  //$to       = "919823868963";
