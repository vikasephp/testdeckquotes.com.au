...
$tableTask = new Fw_Db_Table('auction_advantage_phone_log_call_types');
...
if ($this_id > 0)
{
	...
	$fwViewData['detail'] = $detail;
        $fwViewData['title'] = 'Edit Call Type ';//.$MODULE_SINGULAR;
}
else
{
    $fwViewData['title'] = 'Add New Call Type ';//.$MODULE_SINGULAR;
}	
