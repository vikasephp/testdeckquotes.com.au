...
<form name="template" method="post" action="{{$BASE_URL}}{{$XFA.detail}}" enctype="multipart/form-data">
    ...
    <tr>    
			<th class="labelhead" width="10%">Name:</th>
			<td><input type="text" name="{{$TABLE}}[autha_name]" value="{{$detail.autha_name}}" style="width:300px;" /></td>
	</tr>
...
<script type="text/javascript" language="javascript" >
    ...
    frmvalidator.addValidation("{{$TABLE}}[autha_name]",   "req", "Please specify Name.");
</script>
