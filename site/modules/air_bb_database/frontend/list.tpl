               ...
               <td>{{if $item.dh_access == 1}}All Access{{else}}Users{{/if}}</td>
                ...
                <td>{{if $item.dh_last_update !== '0000-00-00 00:00:00'}}{{$item.dh_last_update|date_format:"%d/%m/%Y %H:%M"}}{{else}}
                 ...
                 {{foreach from=$item.doc_files key="keyfiles" item="itemfiles"}}
                 	...
                 	<td><a href="{{$BASE_URL}}files/business_documents_hub/{{$itemfiles.dhd_name}}" target="_blank" title="Start download">
                    <img src="{{$itemfiles.iconpath}}" width="40" /></a><br />
                    <a href="{{$BASE_URL}}files/business_documents_hub/{{$itemfiles.dhd_name}}" title="{{$itemfiles.dhd_name}}" target="_blank">{{$itemfiles.dhd_name|truncate:"9"}}</a>
                    </td>
                 {{if $count % 3 == 0}}</tr><tr>
                 {{/if}}
                 {{counter}}
                 ...
                 <a href="{{$BASE_URL}}{{$XFA.upload}}/{{$ID}}/{{$item.$ID}}" title="Quick Add New" class="addfile">
                    ...
                    <a href="{{$BASE_URL}}{{$XFA.upload}}/{{$ID}}/{{$item.$ID}}" title="Quick Add New" class="addfile">Add New</a>
                    </td>
                    </tr>
                    </table>
                    </div>
