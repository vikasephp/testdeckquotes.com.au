...
// module names
$MODULE_SINGULAR = 'Air BB Database';
$MODULE_PLURAL = 'Air BB Database';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'air_bb_database';
$ID = 'ab_id';
...
function upload($filename, $tmpname,$bucket)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/air_bb_database/'.$zipfile, S3::ACL_PRIVATE)) {
