...
<div style="float:left; width:100%;">
    <table id="doclist-table" class="nav-back" width="100%">
                ...
                <td>{{if $item.dh_last_update !== '0000-00-00 00:00:00'}}{{$item.dh_last_update|date_format:"%d/%m/%Y %H:%M"}}{{else}}
                 ...
                 {{foreach from=$item.doc_files key="keyfiles" item="itemfiles"}}
                    ...
                    <li><img src="{{$itemfiles.iconpath}}" width="20" /> <br />
                      ...
                      <ul class="small-menu">
                        <li> {{if $itemfiles.dhd_docs_status == 0}}<a href="{{$BASE_URL}}{{$FILE_PATH}}files/template_ohs_docs/{{$itemfiles.dhd_name}}" title="{{$itemfiles.dhd_name}}" target="_blank" style="color:#FFFFFF;">{{else}}<a href="{{$BASE_URL}}dochub.open/fileid/{{$itemfiles.dhd_docs_path}}"  class="shofile" style="color:#FFFFFF;" >{{/if}}View/Edit</a></li>
                        <li>{{if $itemfiles.dhd_docs_status == 0}}<a href="{{$BASE_URL}}{{$FILE_PATH}}files/template_ohs_docs/{{$itemfiles.dhd_name}}" title="{{$itemfiles.dhd_name}}" target="_blank" style="color:#FFFFFF;">{{else}}<a href="{{$BASE_URL}}dochub.open/download/1/fileid/{{$itemfiles.dhd_docs_path}}"  title="Start Download" style="color:#FFFFFF;">{{/if}}Download</a></li>
                      </ul>
                    </li>
                  </ul>
     ...
     <a href="{{$BASE_URL}}{{$XFA.delete}}/{{$ID}}/{{$item.$ID}}" onclick="javascript:if(!confirm('Are you sure want to delete? Because it will delete all related documents.')) return false;" title="Delete"><img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/delete.png"/></a>
     {{/if}}
     </td></tr>
