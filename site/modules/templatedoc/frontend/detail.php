			...
			if($this_id)
				{
							...
							$docs2['dhd_link_pdf'] =  $detail['dh_link_pdf'];
							$docs2['dhd_link_word'] =  $detail['dh_link_word'];
							$tabledoc->setWhere("dhd_dh_id = ".$id);
							$tabledoc->updateRow($docs2); 	
				}
			else
				{
							...
							$docs2['dhd_dh_id']= $this_id;      
							$docs2['dhd_link_pdf'] =  $detail['dh_link_pdf'];
							$docs2['dhd_link_word'] =  $detail['dh_link_word'];  
							$tabledoc->insertRow($docs2); 			
				}		
		if($docfile)
		{
			...
			$docs['dhd_link_pdf'] =  $detail['dh_link_pdf'];
			$docs['dhd_link_word'] =  $detail['dh_link_word'];
			...
			$tabledoc->setWhere("dhd_dh_id = ".$didid);
