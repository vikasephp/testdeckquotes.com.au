...
$where .= "AND style_formula_fpl.sf_title LIKE '%".$keyword."%'  OR style_formula_fpl.sf_component LIKE '%".$keyword."%'";
...
$matsql = "SELECT ".$TABLE.".* FROM ".$TABLE. $where." ORDER BY ".$TABLE.".uv_id ASC";	 
} 
