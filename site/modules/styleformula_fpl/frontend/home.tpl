    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                ...
                <th class="topmenu" align="center" valign="middle" width="5%">Cost Price</th>
                <th class="topmenu" align="center" valign="middle" width="5%">Unit Type</th>
                <th class="topmenu" align="center" valign="middle" width="5%">Link Image</th>
...
<tbody>
 ...
 <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
    ...
    <td>${{$item.sf_cost_price|string_format:"%.2f"}}</td>
    <td>{{$item.sf_unit_type}}</td>
    <td style="text-align:center;">
    
    <a href="{{$BASE_URL}}{{$XFA.image_link}}/{{$ID}}/{{$item.$ID}}" class="various" title="Edit">Link</a>
    </td>
