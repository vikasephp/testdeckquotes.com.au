...
// module names
$MODULE_SINGULAR = 'Employee Document Center';
$MODULE_PLURAL = 'Employee Document Center';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'empl_doc_center';
$ID = 'edc_id';
	...
	include_once $filetoinclude;
        ...
        try {
	      ...
	      // $s3 = new S3('AKIA2AMNCYNN5VRBSNNU', '5ys4bfLGJQDLgX/Pc+E66/2Yo8jpMgjcdAn1jGKg');
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/employee_documents/'.$zipfile, S3::ACL_PRIVATE)) {
