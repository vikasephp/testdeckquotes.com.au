...
// module names
$MODULE_SINGULAR = 'Post HIA Design Report';
$MODULE_PLURAL =   'Post HIA Design Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'post_hia_design_report';
$ID = 'ph_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/post_hia_design/'.$zipfile, S3::ACL_PRIVATE)) {
