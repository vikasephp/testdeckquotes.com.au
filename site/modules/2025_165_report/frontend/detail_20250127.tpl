		...
		<table id="list-table" width="100%">
			...
			<tr>
				...
				<td>
					...
					<input type="text" list='project' name="{{$TABLE}}[os2_project]" style="width:700px" value="{{$detail.os2_project}}" />
				</td>
			</tr>
			...
			<tr>
                ...
                <option value="{{$item2.st_id}}" {{if $item2.st_id eq $detail.os2_stage}} selected="selected" {{/if}}>{{$item2.st_option}}</option>
                {{/foreach}}
			...
			<tr>
				<th>How Many</th>
				<td><input type="text" name="{{$TABLE}}[os2_how_many]" style="width:300px" value="{{$detail.os2_how_many}}" /> </td>
			</tr>

			<tr>
				<th>Supporting Document</th>
				<td><input type="text" name="{{$TABLE}}[os2_supporting_document]" style="width:300px" value="{{$detail.os2_supporting_document}}" /> </td>
			</tr>
