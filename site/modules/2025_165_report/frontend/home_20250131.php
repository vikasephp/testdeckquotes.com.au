...
$matsql = "SELECT 2025_165_report.*, planning_project_checklist_admin.ppc_document FROM 2025_165_report left JOIN planning_project_checklist_admin ON 2025_165_report.os2_doc_plan = planning_project_checklist_admin.ppc_id" . $where . ' ' . $ord;
...
if(!empty($submit))
{
 	...
 	$printed_r_sql = "SELECT record_id FROM `2025_165_report_manage_reports` WHERE is_printed = 1"; $total_printed_ids = [];
    ...
    // 		$html .= '<th colspan="2">Rec. No. '.$lv["os2_id"].' </th>';
    		...
    		$html .= '</tr>';
    		$html .= '<tr><td colspan="2" style="color: #000; font-size: 14pt; font-weight: bold;">Document or Plan: '.$lv["ppc_document"].'</td></tr>';
    		...
    		if ($total_counted > 27){ break; } $total_counted++;
        }
	}
	$html .= '</table>';
