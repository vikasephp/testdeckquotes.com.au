...
echo $matsql = "SELECT 2025_165_report.*, planning_project_checklist_admin.ppc_document FROM 2025_165_report left JOIN planning_project_checklist_admin ON 2025_165_report.os2_doc_plan = planning_project_checklist_admin.ppc_id" . $where . ' ' . $ord;
