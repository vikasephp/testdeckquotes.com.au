    ...
    <form name="mlist2" method="post">
      ...
      <style>
        .custom-btn_dpr {
          ...
          -webkit-border-radius: 4px; margin-bottom: 5px; background: url('/css/default/images/button1_bg.gif') top repeat-x;
          font-size: 14px; color: #fff; line-height: 25px; text-decoration: none; padding: 0 10px;
          text-transform: uppercase; position: relative; cursor: pointer; font-style: italic; height: 27px; display: inline-block;
        }
      </style>
      &nbsp; &nbsp;&nbsp;<span class="custom-btn_dpr" onclick="javascript:download_print_msg();">Download Print Report</span>
      {{ /if }}
	...
	<table id="doclist-table" class="nav-back tableFixHead" width="100%">
		<thead>
			<tr>
				...
				<th class="topmenu" align="center" valign="middle" width="15%" data-title="plan_breach">Relevant Document or Plan</th>
		...
		<tbody>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td data-title="plan_breach">
					<form name="recmet2" method="post" action="">
						<select name="plan[{{$item.os2_id}}]" onChange="update_plan({{$item.os2_id}}, this.value)" style="width: 150px;">
				...
				<td>
					<textarea style="width: 250px;" rows="4" onblur="updateBreachTest('{{ $item.os2_id }}', this)">{{ $item.os2_breach_test }}</textarea>
				</td>
			</tr>
...
<div style="display: none; position: fixed; min-height:350px; z-index:9999999; width: 90%; height: 90%; top: 30px; left: 5%; background: white;" id="plan_breach">
	<h3 class="page-title">
        <br />
        Plan Breach
    </h3> 
        ...
        <tr>
            ...
            <td style="text-align: center;">
                <form name="recmet2" method="post" action="{{ $BASE_URL }}{{ $XFA.home }}" style="margin: 0;">
                    ...
                    <input type= "submit" name="filter_plan_breach" title="View {{ $item.ppc_document }}" value="{{ $item.total }}" style="margin: 0; width: 40px; text-align: center;">
                </form>
            </td>
        </tr>
        {{ /foreach }}
		<tr>
			...
			<td style="text-align: center;">
                <form name="recmet2" method="post" action="{{ $BASE_URL }}{{ $XFA.home }}" style="margin: 0;">
                    ...
                    <input type= "submit" name="filter_plan_breach" title="View Please Select" value="{{ $no_plan_total }}" style="margin: 0; width: 40px; text-align: center;">
                </form>
            </td>
		</tr>
		<tr>
...
<div style="display: none; position: fixed; min-height: 50px; z-index: 9999999; width: 35%; top: 25vh; left: 0px; background: white; right: 0px; margin: 0px auto; border: 3px solid red; padding: 20px; line-height: 2; border-radius: 3px;" id="download_print_msg">
	<h3 class="page-title">
        Total Printed Records must be equal to Total Records
    </h3> 
