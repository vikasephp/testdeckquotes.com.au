...
if($notesdetail)
{
	...
	if($table->rowExists())
	{
		$notes['dpn_err_service_notes'] = $notesData;
	...
	$fwViewData['opr'] = "Close";	
     ...
     $sqlnotes = "Select dpn_err_service_notes   from  document_proposal_name
	           where dpn_unique_id = ".$dpn_unique_id;
     
     $notesData = $fwDb->queryOne($sqlnotes);
	
     $fwViewData['notesData'] = $notesData['dpn_err_service_notes'];
