...
if(empty($pagenum))
 ...
 $sql = "Select  dpn_id, dpn_bsn_id, dpn_unique_id, dpn_proposal_number, dpn_err_service_req, dpn_err_hide , dpn_appl_submitted,
	 ...
	 dpn_add_to_er_date, dpn_er_type, dpn_er_tree_survey,  	dpn_er_app_sub_date, dpn_er_app_sub_user
...
{	
	// if(isset($_SESSION['projectname'])) { $projectname = $_SESSION['projectname']; }
