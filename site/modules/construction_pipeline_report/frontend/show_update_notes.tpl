...
<form name="detail" method="post" action=""  enctype="multipart/form-data">
  ...
  <table id="doclist-table"  width="95%" cellpadding="0" cellspacing="0" style="border:1px solid #999;">
   ...
   <textarea name="updateNote" cols="150" rows="5">{{$planNotes}}</textarea> 
    ...
    <input type="submit" name="updateNotes" value="Update" onclick="javascript:parent.$.fancybox.close();" class="vsml" />
