...
<form name="mlist" method="post">
			...
			<table id="doclist-table" class="nav-back" width="100%">
				...
				<tbody>
					...
					<tr {{if $item.dpn_dr_per_complete eq 100}} bgcolor="#99CC99" {{else}} bgcolor="{{cycle values="
						...
						<td data-col="customer_objectives" style="white-space: nowrap;">
 ...
 --> <input type="text" name="ssod[{{$item.chknoData}}]" class="w16em dateformat-d-ds-m-ds-Y dtpic"
						...
						<td>
							<input type="text" name="general_hours[{{$item.chknoData}}]"
								id="h1{{$item.chknoData|ltrim:'0'}}" value="{{$item.dpn_dr_general_hours}}"
								onkeyup="update_gen_hours({{$item.chknoData|ltrim:'0'}},this.value)"
								style="width:40px" />
							<div id="gh{{$item.chknoData|ltrim:'0'}}">
								{{$item.dpn_dr_gen_hour_date}}<br />{{$item.dpn_dr_gen_hour_user}} </div>
						...
						<td>
							<input type="text" name="cust_design_hours[{{$item.chknoData}}]"
								id="h2{{$item.chknoData|ltrim:'0'}}" value="{{$item.dpn_dr_cust_des_hour}}"
								onkeyup="update_cdh({{$item.chknoData|ltrim:'0'}},this.value)" style="width:40px" />

							<div id="usr{{$item.chknoData|ltrim:'0'}}">
								{{$item.dpn_dr_cdh_date}}<br />{{$item.dpn_dr_cdh_user}} </div>
							<script>
						...
						<td>
							...
							<input type="text" name="overseas_hours[{{$item.chknoData}}]"
								id="h3{{$item.chknoData|ltrim:'0'}}" value="{{$item.dpn_dr_overhour}}"
								onkeyup="update_oah({{$item.chknoData|ltrim:'0'}},this.value)" style="width:40px" />
							<div id="usr2{{$item.chknoData|ltrim:'0'}}">
								{{$item.dpn_dr_oah_date}}<br />{{$item.dpn_dr_oah_user}} </div>
							<script>
  ...
  -->
							...
							<input type="text" name="total_hours[{{$item.chknoData}}]"
								id="th{{$item.chknoData|ltrim:'0'}}" value="{{$item.total_hours}}"
								onchange="update_tot_hours({{$item.chknoData|ltrim:'0'}},this.value)"
								style="width:40px" />
						...
						{{else }}
							...
							<td><input type="text" name="dt" class="w16em dateformat-d-ds-m-ds-Y dtpic"
									id="demo452_{{$item.chknoData}}{{$item.bsn_id}}"
									onfocus="update_next_date({{$item.chknoData|ltrim:'0'}}, this.value);"
									value="{{$item.dpn_dr_next_date}}" /><br />
								...
								<input type="text" name="tim" placeholder="Time" value="{{$item.dpn_dr_next_time}}"
									onkeyup="update_next_time({{$item.chknoData|ltrim:'0'}}, this.value);" /><br />
								<script>
								...
								<input type="text" name="location" placeholder="Location"
									value="{{$item.dpn_dr_next_location}}"
...
--><input class="switch-input" type="checkbox" value="1" name="hide[{{$item.chknoData}}]" onclick="this.form.submit();"
										{{if $item.dpn_dr_hide eq 1 }} checked="checked" {{/if}} />
