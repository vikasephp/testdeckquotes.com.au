...
$sql = "Select SQL_CALC_FOUND_ROWS null as row_name,  dpn_bsn_id, dpn_unique_id, dpn_budget, dpn_dr_type, dpn_dr_what, dpn_dr_survey_imple, dpn_dr_est_cname, dpn_dr_likely_cname, dpn_dr_reno_cname,
	  ...
	  dpn_dr_gen_hour_date, dpn_dr_gen_hour_user, dpn_customer_designer, dpn_dr_next_date, dpn_dr_next_time, dpn_dr_next_location, dpn_dr_next_meeting, dpn_dr_next_link,
	  dpn_dr_ec_cmt, dpn_dr_ec_date, dpn_dr_likely_cmt, dpn_dr_likely_date, dpn_dr_erc_cmt, dpn_dr_erc_date, dpn_dr_ut_cname, dpn_dr_ut_cmt, dpn_dr_ut_date, dpn_customer_objectives, dpn_customer_objectives_date, dpn_customer_objectives_user
...
// $qry = "SELECT be_business_id, count(*) as tot from business_alert where business_alert.be_alert_active = 'Yes' GROUP BY be_business_id";
// $res = $fwDb->query($qry);
// $alertData = [];
// foreach($res as $row) {
// 	$alertData[$row['be_business_id']] = $row;
// }
...
if ($export > 0) {
	...
	$objPHPExcel->setActiveSheetIndex(0)
		...
		->setCellValue('AI1', 'Unit Title Costs')
		->setCellValue('AJ1', 'Rev-Unit Title Costs')
		->setCellValue('AK1', 'Building File')
	;
	...
	foreach ($setdata2 as $k => $v) {
		...
		$objPHPExcel->getActiveSheet()
			...
			->setCellValue('AI' . $row, $v['dpn_dr_r_plus_e'])
			->setCellValue('AJ' . $row, $v['dpn_dr_ut_cmt'])
			->setCellValue('AK' . $row, $v['dpn_dr_building_file'])
