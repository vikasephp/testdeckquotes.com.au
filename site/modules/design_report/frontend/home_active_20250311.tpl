	...
	function update_sqm2(id,value)
      ...
      <a href="{{$BASE_URL}}design_report.txtmsg_ec/dpn_unique_id/{{$item.chknoData|ltrim:'0'}}" class="various">
       {{if $item.dpn_dr_ebc_comm}}<img src="{{$BASE_URL}}images/textmsgyellow.png" />{{else}}<img src="{{$BASE_URL}}images/textmsgblue.png" />{{/if}}
         ...
         <input type="text" name="estimate_cmt[{{$item.chknoData}}]" value="{{$item.dpn_dr_ec_cmt|urldecode}}" onkeyup = "update_estimate_cmt({{$item.chknoData|ltrim:'0'}},this.value)" style="width: 120px;"/> <br />
      {{$item.dpn_dr_ec_date}}
...
<input type="text" name="likelyvalue[{{$item.chknoData}}]" value="{{$item.dpn_dr_likely_value|urldecode}}" onkeyup = "update_likely_value2({{$item.chknoData|ltrim:'0'}},this.value)" style="width:150px !important;"/>
 ...
 <span title="planningapprovalcanberra">REV </span><input type="text" name="likely_com[{{$item.chknoData}}]" value="{{$item.dpn_dr_likely_cmt|urldecode}}" onkeyup = "update_likely_cmt({{$item.chknoData|ltrim:'0'}},this.value)" style="width: 120px;"/> <br />
    ...
    <span title="planningapprovalcanberra">REV </span><input type="text" name="reno_com[{{$item.chknoData}}]" value="{{$item.dpn_dr_erc_cmt|urldecode}}" onkeyup = "update_reno_cmt({{$item.chknoData|ltrim:'0'}},this.value)" style="width: 120px;"/> <br />
