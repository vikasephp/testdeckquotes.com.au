			...
			<table id="doclist-table" class="nav-back" width="100%">
				<thead>
					<tr>
						...
						<th class="topmenu" align="center" valign="middle" style="width:40px;">Upload Weekly Letter</th>
						...
						<td data-col="upload_weekly_letter">
							<form name="mlist123" method="post" enctype="multipart/form-data">
								...
								<div style="text-align:center;">
									<a href="/planning_only_task_tracker.download_content_wl?file_name={{$item.bc_ptt_letter}}&module_name=planning_only_task_tracker.home"
										target="_blank">
										Download</a>
								</div> {{/if}}
