 ...
 <br>
        <table cellpadding="5" border="1" cellspacing="0" width="100%">
          ...
          {{foreach from=$item_c.checklist_entities_referral item=item key=key}}
           ...
           <td style="text-align:center;">
                    <a href="javascript:requestProjectChecklistEntitiesList('ppchecklist_entites_edit','{{$bsn_id}}','{{ $item.checklist_entities_referral.id }}','{{ $item.er_document }}','{{ $item.er_id }}','{{ $item_c.dpn_unique_id }}');">
                       <img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/edit.png">
                    </a>
                    <!--https://newdeckquote.com/planning_task_tracker.detail/pc_id/"-->
           </td>
