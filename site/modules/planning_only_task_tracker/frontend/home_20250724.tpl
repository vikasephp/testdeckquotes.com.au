			...
			<table id="doclist-table" class="nav-back" width="100%">
				<thead>
					<tr>
						...
						<th class="topmenu" align="center" valign="middle" style="width:150px;" data-col="alert">Alert</th>
						...
						<th class="topmenu" align="center" valign="middle" style="width:50px;" data-col="da_docs">DA Docs</th>
						<th class="topmenu" align="center" valign="middle" style="width:50px;" data-col="ba_docs">BA Docs</th>
						...
						<th class="topmenu" align="center" valign="middle" style="width:195px;" data-col="original_gcn">
							Original GCN</th>
						<th class="topmenu" align="center" valign="middle" style="width:195px;" data-col="latest_gcn">
							Latest GCN</th>
					...
					<tr bgcolor="{{cycle values=" #D3E8D6,WHITE" advance=true}}">
						...
						<script>
							function update_num_projects(id,value)
							{
								$.ajax({
									type: "GET",
									url: "{{$BASE_URL}}planning_only_task_tracker.update_num_projects/bs_business_id/"+id+"/value/"+value,
										success: function(result){
										}
									});
							}
						...
						<td>
							<form name="recmet3" method="post" action="">
								...
								{{else}}								
									...
									{{if $item.bsn_ptt_override eq 1}}
										{{$item.bsn_ptt_override_user}}
									{{/if}}
								{{/if}}
