...
<script type="text/javascript">
	function add_letter() {
		var viewurl = "{{$BASE_URL}}planning_only_task_tracker.viewletter" + "/random/" + Math.random();
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
				'height': '99%',
	...
	function add_pc() {
		var viewurl = "{{$BASE_URL}}planning_only_task_tracker.view_pc" + "/random/" + Math.random();
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
				'height': '99%',
	...
	function add_type() {
		var viewurl = "{{$BASE_URL}}planning_only_task_tracker.viewtype" + "/random/" + Math.random();
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
				'height': '99%',
	...
	function add_project_type() {
		var viewurl = "{{$BASE_URL}}planning_only_task_tracker.view_project_type" + "/random/" + Math.random();
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
				'height': '99%',
	...
	function add_phr(bsn_id) {
		var viewurl = "{{$BASE_URL}}planning_only_task_tracker.add_phr" + "/bsn_id/" + bsn_id;
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
				'height': '99%',
	...
	function add_procedure() {
		var viewurl = "{{$BASE_URL}}planning_only_task_tracker.view_procedure" + "/random/" + Math.random();
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
				'height': '99%',
	...
	function proj_panel() {
		var viewurl = "{{$BASE_URL}}planning_only_task_tracker.project_panel" + "/random/" + Math.random();
		$(document).ready(function () {
			$.fancybox({
				'width': '90%',
				'height': '99%',
...
&nbsp;<input type= "submit" name="amberlight" title="Save" value="Filter Amber Light Projects"> &nbsp; &nbsp;-->
			...
			<div>
				<input type="submit" value="Alert Projects" name="filter_alert_projects" />
		...
		<table id="doclist-table" class="nav-back" width="100%">
				<thead>
					<tr>
						...
						<th class="topmenu" align="center" valign="middle" style="width:6%;">Hide From Report</th>
						<th class="topmenu" align="center" valign="middle" style="width:50px;">Address</th>
						<th class="topmenu" align="center" valign="middle" style="width:50px;">Checklist</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;">View Project</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;">Sub Status</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;" data-col="alert">Alert</th>
						<th class="topmenu" align="center" valign="middle" style="width:20px;">Order</th>
						<th class="topmenu" align="center" valign="middle" style="width:30px;">Days At Sub Status</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;">Add To Post HIA Report</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;">Planning Plans</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;" data-col="da_docs">DA Docs</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;" data-col="ba_docs">BA Docs</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;">Entities</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;">D Type</th>
						<th class="topmenu" align="center" valign="middle" style="width:15px;">Planning Manager</th>
						<th class="topmenu" align="center" valign="middle" style="width:10px;">Latest Merged Plans</th>
						<th class="topmenu" align="center" valign="middle" style="width:5px;">HIA Days</th>
						<th class="topmenu" align="center" valign="middle" style="width:50px;">Letter Text</th>
						<th class="topmenu" align="center" valign="middle" style="width:50px;" data-col="original_gcn">Original GCN</th>
						<th class="topmenu" align="center" valign="middle" style="width:50px;" data-col="latest_gcn">Latest GCN</th>
						<th class="topmenu" align="center" valign="middle" style="width:45px;">Day Difference</th>
						<th class="topmenu" align="center" valign="middle" style="width:50px;">Task Count</th>
						<th class="topmenu" align="center" valign="middle" style="width:40px;">Planning Only proposal (PDF ) </th>
				...
				<tbody>
					<!--<tr data-col="first_row">
						...
						<script>
							function update_ts(id, value) {
								$.ajax({
									type: "GET",
									url: "{{$BASE_URL}}planning_only_task_tracker.update_ts/bst_task_id/" + id + "/value/" + value,
					...
					<tr bgcolor="{{cycle values=" #D3E8D6,WHITE" advance=true}}">
							...
							<form name="recmet" method="post" action="">
								...
								<label class="switch">
									<input class="switch-input" type="checkbox" name="hide[{{$item.bsn_id}}]" value="1"
										onclick="this.form.submit();" {{if $item.bs_pott_hide eq 1 }} checked="checked"
										{{/if}} />
						...
						<td>
							<a href='{{$BASE_URL}}planning_only_task_tracker.view_project/bsn_id/{{$item.bsn_id}}'
						...
						<td>
							...
							<div id="usr{{$item.bs_business_id}}">
								{{$item.bs_ptt_sub_status_date}}<br />{{$item.bs_ptt_sub_status_user}}
							</div>
							<script>
								function update_sub_status(id, value) {
									...
									$.ajax({
										type: "GET",
										url: "{{$BASE_URL}}planning_only_task_tracker.update_sub_status/bs_business_id/" + id + "/value/" + value,
										success: function (result) {
											$(tana).html(result);
										}
									});
						...
						<td data-col="alert"
							{{ if $item.total_active_alert > 0 }} style="background:#F00 !important;" {{ /if }}
						>
							<a href="{{$BASE_URL}}planning_only_task_tracker.add_alert/bsn_id/{{ $item.bsn_id }}" class="various" title="Add" style="text-decoration: none;">
								<span style="width: 20px; height: 20px; line-height: 20px; text-align: center; color: #000; border: 1px solid #000; font-size: 20px; display: inline-block; margin-bottom: 5px;">+</span>
							</a>
							<br>
							{{ $item.total_active_alert }}
							<br>
							<a href="{{$BASE_URL}}planning_only_task_tracker.view_alert/bsn_id/{{ $item.bsn_id }}" class="various" title="Read">Read</a>
						</td>
						...
						<td>
							<form name="recmet3" method="post" action="">
								...
								<div id="pp{{$item.bsn_id}}"> {{if $item.bsn_ptt_planning_plans eq 1}}
									{{$item.bsn_ptt_pp_user}}<br />{{$item.bsn_ptt_pp_date}}{{/if}}
								</div>
								<script>
									function update_plan_plans(id, value) {
										...
										$.ajax({
											type: "GET",
											url: "{{$BASE_URL}}planning_only_task_tracker.update_plan_plans/bsn_id/" + id + "/value/" + val,
											success: function (result) {
												$(tana2).html(result);
											}
										});
						...
						<td data-col="da_docs">{{$item.totalDAll}}/{{$item.totalDA}}</td>
						<td data-col="ba_docs">{{$item.totalBAll}}/{{$item.totalBA}}</td>
						<td>
							...
							<div class="ent" {{if $item27.dpn_water_ref eq 'Fails' }} style="background: #F00;" {{elseif
								...
								<a href="/planning_only_task_tracker.download_content?file_name={{$item.doc_file_name_627}}&module_name=planning_only_task_tracker.home"
							...
							<div class="ent" {{if $item28.dpn_electric_ref eq 'Fails' }} style="background: #F00;"
								...
								<a href="/planning_only_task_tracker.download_content?file_name={{$item.doc_file_name_628}}&module_name=planning_only_task_tracker.home"
									target="_blank"
							...
							<div class="ent" {{if $item29.dpn_gas_ref eq 'Fails' }} style="background: #F00;" {{elseif
								...
								<a href="/planning_only_task_tracker.download_content?file_name={{$item.doc_file_name_629}}&module_name=planning_only_task_tracker.home"
							...
							<div class="ent" {{if $item30.dpn_storm_ref eq 'Fails' }} style="background: #F00;" {{elseif
								...
								<a href="/planning_only_task_tracker.download_content?file_name={{$item.doc_file_name_630}}&module_name=planning_only_task_tracker.home"
							...
							<div class="ent" {{if $item31.dpn_heritage_ref eq 'Fails' }} style="background: #F00;"
								...
								<a href="/planning_only_task_tracker.download_content?file_name={{$item.doc_file_name_716}}&module_name=planning_only_task_tracker.home"
									target="_blank"
							...
							<div class="ent" {{if $item32.dpn_heritage_ref eq 'Fails' }} style="background: #F00;"
								...
								<a href="/planning_only_task_tracker.download_content?file_name={{$item.doc_file_name_717}}&module_name=planning_only_task_tracker.home"
						...
						<td>
							...
							<script>
								function update_d_type(id, value) {
									$.ajax({
										type: "GET",
										url: "{{$BASE_URL}}/planning_only_task_tracker.update_d_type/bsn_id/" + id + "/value/" + value,
										success: function (result) {
										}
									});
								}
						...
						<td>
							...
							<a href="/planning_only_task_tracker.download_content?file_name={{$item.doc_file_name_491}}&module_name=planning_only_task_tracker.home"
								target="_blank">
						...
						<td>
							...
							<div id="usr2{{$item.bs_customers_id}}">
								{{$item.bcust_ptt_letter_text_date}}<br />{{$item.bcust_ptt_letter_text_user}}
							</div>
							<script>
								function update_letter(id, value) {
									...
									$.ajax({
										type: "GET",
										url: "{{$BASE_URL}}planning_only_task_tracker.update_lettertext/id/" + id + "/value/" + value,
										success: function (result) {
											$(tana2).html(result);
										}
									});
						...
						<td> {{$item.dd}}</td>
						<td>{{$item.out_c}}</td>
						<td data-col="planning_only_proposal">
							{{if $item.doc_file_name_525}}
								<a href="/planning_only_task_tracker.download_content?file_name={{$item.doc_file_name_525}}&module_name=planning_only_task_tracker.home" target="_blank">Download</a>
								<br>
								{{$item.doc_date_uploaded_525}}
							{{/if}}
						</td>
						<td data-col="upload_weekly_letter">
							{{if $item.weekly_update_456}}
							 <a href="{{$BASE_URL}}planning_only_task_tracker.download_content?file_name={{$item.weekly_update_456}}&module_name=planning_only_task_tracker.home" title="{{$item.weekly_update_456}}" target="_blank">Download</a>
							 {{/if}}
							...
							<!--<form name="mlist123" method="post" enctype="multipart/form-data">
								...
								{{if $item.bc_pott_letter}}
								<div style="text-align:center;">
									<a href="/planning_only_task_tracker.download_content_wl?file_name={{$item.bc_pott_letter}}&module_name=planning_only_task_tracker.home"
										target="_blank">
										Download</a>
								</div> {{/if}}
								<br/><input type="submit" name="savedata" title="Save" value="Upload" class="set2"> &nbsp;
							</form>-->
						</td>
						{{ if $item.bs_traffic_light eq 1}}
						<td style="background:#00CC33; width:350px;">
							<a href="{{$BASE_URL}}planning_only_task_tracker.colorbox/bsn_id/{{$item.bsn_id}}"
								class="various">Color</a>
							<br /><br />{{$item.bs_tl_user}}<br />{{$item.bs_tl_date}}<br />
							<a href="{{$BASE_URL}}planning_only_task_tracker.reason/bsn_id/{{$item.bsn_id}}"
						...
						<td>
							...
							<div id="usr3{{$item.bs_business_id}}">
								{{$item.bs_ptt_pc_user}}<br />{{$item.bs_ptt_pc_date}}
							</div>
							<script>
								function update_pc(id, value) {
									...
									$.ajax({
										type: "GET",
										url: "{{$BASE_URL}}planning_only_task_tracker.update_pc/id/" + id + "/value/" + value,
										success: function (result) {
											$(tana3).html(result);
										}
									});
						...
						<td data-col="hia_meeting">
							<form name="mlist_hiaMeeting" method="post" action="">
								...
								<input type="submit" value="Set" name="hia_meeting" class="set" />
							</form>
