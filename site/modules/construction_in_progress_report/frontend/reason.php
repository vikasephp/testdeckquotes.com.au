...
if($reasondetail)
{
	...
	if($table->rowExists())
	{
		$reason['bs_con_in_prog_tl_reason'] = $reasonData;
	...
	$fwViewData['opr'] = "Close";	
     ...
     $sqlreason = "Select business_sellers.bs_con_in_prog_tl_reason   from  business_sellers
	           where business_sellers.bs_business_id = ".$bsn_id;
     
     $reasonData = $fwDb->queryOne($sqlreason);
	
     $fwViewData['reasonData'] = $reasonData['bs_con_in_prog_tl_reason'];
