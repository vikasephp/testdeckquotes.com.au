	...
	<div style="float: left; margin-left: 10px; text-align: left;">
		<div style="display: inline-block;">
			...
			<div>
				...
				<div class="bsearch_scroll_div" style="margin-bottom: 5px;">
				...
				<tbody>
					...
					<tr bgcolor="{{cycle values=" #D3E8D6,WHITE" advance=true}}">
						...
						<td data-col="project_view_details">
							<a href="javascript:void(0);" target="_blank" class="set3" style="color:#FFF;">View Project
						</a>
						</td>
						...
						<td data-col="letter_text" style="white-space: nowrap;">
							...
							<div>
								<a href="{{$BASE_URL}}inclusions_task_tracker.letter_text_read/bsn_id/{{$item.bsn_id}}" class="various">Read</a>
							</div>
