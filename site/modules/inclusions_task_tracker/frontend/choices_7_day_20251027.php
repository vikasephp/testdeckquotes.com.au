...
foreach ($result as $row) {
    $difference_per = '';
    if (!empty($row['last_week_per']) && !empty($row['this_week_per'])) {
        $difference_per = $row['this_week_per'] - $row['last_week_per'];
    } elseif (!empty($row['last_per']) && !empty($row['this_week_per'])) {
        $difference_per = $row['this_week_per'] - $row['last_per'];
    }
