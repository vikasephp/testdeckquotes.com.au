			...
			<tbody>
				{{foreach from=$final_list key="index" item="row"}}
					<tr style="background: {{cycle values="#D3E8D6,WHITE"}}">
						...
						<td data-col="status" style="white-space: nowrap; background: {{$row.status_color}}">
							...
							<div style="display: inline-block; color: #fff; vertical-align: middle; margin-left: 5px;">
								{{$row.status_user_and_date}}
							</div>						
						</td>
						...
						<td data-col="qa" style="white-space: nowrap;">
							<p>
							...
							<p>Total Ques: {{$row.total_ques}}</p>
						</td>
						<td data-col="auto" style="white-space: nowrap;">{{$row.auto}}</td>
