...
<tr>
	{{assign var = countn value = 1}}
       ...
       <td><input type="checkbox" name="emails[{{$item.cs_id}}]" checked="checked" />
       {{$item.cs_first_name}}&nbsp;{{$item.cs_surname}}</td>
