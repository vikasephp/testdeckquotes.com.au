...
<td style="text-align:center;">{{if $item.cu_date ne '0000-00-00 00:00:00'}} {{$item.cu_date}}{{/if}}</td>
<td style="text-align:center;">
{{if $item.cu_attachment}} <a href="{{$BASE_URL}}files/uploads/{{$item.cu_attachment}}">Download</a><br />{{/if}}
{{if $item.cu_attachment_2}} <a href="{{$BASE_URL}}files/uploads/{{$item.cu_attachment_2}}">Download</a><br />{{/if}}
{{if $item.cu_attachment_3}} <a href="{{$BASE_URL}}files/uploads/{{$item.cu_attachment_3}}">Download</a><br />{{/if}}
{{if $item.cu_attachment_4}} <a href="{{$BASE_URL}}files/uploads/{{$item.cu_attachment_4}}">Download</a><br />{{/if}}
{{if $item.cu_attachment_5}} <a href="{{$BASE_URL}}files/uploads/{{$item.cu_attachment_5}}">Download</a>{{/if}}
