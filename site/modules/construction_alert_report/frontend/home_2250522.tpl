				...
				<td>
					<form name="recmet2" method="post" action="">
						...
						<a href="{{$BASE_URL}}construction_alert_report.include_suppliers/car_id/{{$item.car_id}}"
							class="various">Include Supplier</a><br /><br />
				</td>
					...
					{{if $item.car_image1}}
						<div style="text-align:center;">
							{{ if $item.car_image1_newdesign }}
								Photo 1 : <a href="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image1}}&module_name={{ $BASEFOLDER }}.home" target="_blank"><img src="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image1}}&module_name={{ $BASEFOLDER }}.home">Download</a>
							{{ else }}
								Photo 1 : <a href="{{$BASE_URL}}files/uploads/{{$item.car_image1}}" target="_blank"><img src="{{$BASE_URL}}files/uploads/{{$item.car_image1}}">Download</a>
							{{ /if }}
						</div>
						<span style="display: none">{{$item.car_image1}}</span>
					{{/if}}
					{{if $item.car_image2}}
						<div style="text-align:center;">
							{{ if $item.car_image2_newdesign }}
								Photo 2 : <a href="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image2}}&module_name={{ $BASEFOLDER }}.home" target="_blank"><img src="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image2}}&module_name={{ $BASEFOLDER }}.home">Download</a>
							{{ else }}
								Photo 2 : <a href="{{$BASE_URL}}files/uploads/{{$item.car_image2}}" target="_blank"><img src="{{$BASE_URL}}files/uploads/{{$item.car_image2}}">Download</a>
							{{ /if }}
						</div>
					{{/if}}
					{{if $item.car_image3}}
						<div style="text-align:center;">
							{{ if $item.car_image3_newdesign }}
								Photo 3 : <a href="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image3}}&module_name={{ $BASEFOLDER }}.home" target="_blank"><img src="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image3}}&module_name={{ $BASEFOLDER }}.home">Download</a>
							{{ else }}
								Photo 3 : <a href="{{$BASE_URL}}files/uploads/{{$item.car_image3}}" target="_blank"><img src="{{$BASE_URL}}files/uploads/{{$item.car_image3}}">Download</a>
							{{ /if }}
						</div>
					{{/if}}
					{{if $item.car_image4}}
						<div style="text-align:center;">
							{{ if $item.car_image4_newdesign }}
								Photo 4 : <a href="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image4}}&module_name={{ $BASEFOLDER }}.home" target="_blank"><img src="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image4}}&module_name={{ $BASEFOLDER }}.home">Download</a>
							{{ else }}
								Photo 4 : <a href="{{$BASE_URL}}files/uploads/{{$item.car_image4}}" target="_blank"><img src="{{$BASE_URL}}files/uploads/{{$item.car_image4}}">Download</a>
							{{ /if }}
						</div>
					{{/if}}
					{{if $item.car_image5}}
						<div style="text-align:center;">
							{{ if $item.car_image5_newdesign }}
								Photo 5 : <a href="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image5}}&module_name={{ $BASEFOLDER }}.home" target="_blank"><img src="/{{ $BASEFOLDER }}.download_content?file_name={{$item.car_image5}}&module_name={{ $BASEFOLDER }}.home">Download</a>
							{{ else }}
								Photo 5 : <a href="{{$BASE_URL}}files/uploads/{{$item.car_image5}}" target="_blank"><img src="{{$BASE_URL}}files/uploads/{{$item.car_image5}}">Download</a>
							{{ /if }}
						</div>
					{{/if}}
				</td>
