   ...
   <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
            	   ...
            	   <th class="topmenu" align="center" valign="middle" width="15%">First Name</th>   
                   ...
                   <th class="topmenu" align="center" valign="middle" width="7%">Mobile</th> 
                   <th class="topmenu" align="center" valign="middle" width="6%">Include</th>  
            </tr>
        </thead>
        <tbody>
    ...
    <script type="text/javascript">
		...
		$(document).ready(function () {
			$("input[name^='emails']").click(function () {
				if ($(this).is(":checked")) {
					var current = $(this);
					var checkedCount = $("input[name^='emails']:checked").not(current).length;
					if (checkedCount > 0) {
						alert("You can select only one contact at a time.");
						$("input[name^='emails']:checked")
							.not(current)
							.removeAttr("checked");
					}
				}
