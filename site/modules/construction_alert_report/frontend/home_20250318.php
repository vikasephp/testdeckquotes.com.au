...
if ($total_rows > 0) {
	...
	foreach ($listsnew as $i => $v) {
		if (!empty($listsnew[$i])) {
			...
			$listsnew[$i]['car_project'] = stripslashes($listsnew[$i]['car_project']);
