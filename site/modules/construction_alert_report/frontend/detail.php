...
if (!empty($submit)) {
	...
	if (!empty($detail['car_type'])) {
		$typedata = implode(",", $detail['car_type']);
		$detail['car_type'] = $typedata;
	}
	unset($detail[$ID]);
	...
	if ($_FILES['image1']['name']) {
		...
		$detail['car_image1_newdesign'] = true;
	}
	...
	if ($_FILES['image2']['name']) {
		...
		$docfile_1 = $_FILES['image2']['name'];
		$docfile_1 =  preg_replace('/[^A-Z0-9._]/i', '_', $docfile_1);
		$temp_name_1 = $_FILES['image2']['tmp_name'];
		$detail['car_image2'] = $docfile_1;
		$fileUploaded = upload($docfile_1, $temp_name_1);
		$detail['car_image2_newdesign'] = true;
	}
	...
	if ($_FILES['image3']['name']) {
		...
		$docfile_1 = $_FILES['image3']['name'];
		$docfile_1 =  preg_replace('/[^A-Z0-9._]/i', '_', $docfile_1);
		$temp_name_1 = $_FILES['image3']['tmp_name'];
		$detail['car_image3'] = $docfile_1;
		$fileUploaded = upload($docfile_1, $temp_name_1);
		$detail['car_image3_newdesign'] = true;
	}
	...
	if ($_FILES['image4']['name']) {
		...
		$docfile_1 = $_FILES['image4']['name'];
		$docfile_1 =  preg_replace('/[^A-Z0-9._]/i', '_', $docfile_1);
		$temp_name_1 = $_FILES['image4']['tmp_name'];
		$detail['car_image4'] = $docfile_1;
		$fileUploaded = upload($docfile_1, $temp_name_1);
		$detail['car_image4_newdesign'] = true;
	}
	...
	if ($_FILES['image5']['name']) {
		...
		$docfile_1 = $_FILES['image5']['name'];
		$docfile_1 =  preg_replace('/[^A-Z0-9._]/i', '_', $docfile_1);
		$temp_name_1 = $_FILES['image5']['tmp_name'];
		$detail['car_image5'] = $docfile_1;
		$fileUploaded = upload($docfile_1, $temp_name_1);
		$detail['car_image5_newdesign'] = true;
	}

	$sql = "SELECT bsn_id, bsn_name, bsn_address from business where bsn_name = '" . $detail['car_project'] . "'";
    $res = $fwDb->queryOne($sql);
    $detail['car_bsn_id'] = $res['bsn_id'];
