...
<div style="float:left; width:100%;">
  <table id="doclist-table" class="nav-back" width="100%">
    ...
    <tbody>
  	...
  	<label class="switch">
<input class="switch-input" type="checkbox"  name="hide[{{$item.bs_business_id}}]" value="1"  onclick="this.form.submit();" {{if $item.bs_sales_phase_hide eq 1 }} checked="checked" {{/if}} />
  	...
  	<label class="switch">
<input class="switch-input" type="checkbox"  name="sales[{{$item.bs_business_id}}]" value="1"  onclick="this.form.submit();" {{if $item.bs_sales_phase_sales eq 1 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
       </label> 
       </form></td>
