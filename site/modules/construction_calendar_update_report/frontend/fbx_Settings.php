...
// module names
$MODULE_SINGULAR = 'Construction Calendar Update Report';
$MODULE_PLURAL = 'Construction Calendar Update Report';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'construction_cal_update_report';
$ID = 'cc_id';
	...
	include_once $filetoinclude;
        ...
        try {
          ...
          $s3 = new S3('AKIA2AMNCYNNR3C7ELXP', 'ut4HuWX5HovWcxoCaU8gSSE27/RBxidTIh3SqYe2');
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/purchase_order_quote/'.$zipfile, S3::ACL_PRIVATE)) {
