			...
			<tr>
				...
				<td>
					<div style="display: flex; flex-direction: column; gap: 8px;">
						<div>{{$item.inspection_status}}</div>
						<div>
							...
							<table id="view_status_at{{$item.wa_id}}" style="display: none; width: 100%;">
								...
								{{if $item.wa_is_inspection_fee_required_accepted_date}}
									<tr>
										<td>Customer Approved</td>
										<td style="white-space: nowrap;">{{$item.wa_is_inspection_fee_required_accepted_date}}</td>
									</tr>
									<tr>
								...
								{{/if}}
								{{if $item.wa_is_inspection_fee_required_scheduled_at}}
									<tr>
										<td>Customer Selected Window</td>
										<td style="white-space: nowrap;">{{$item.wa_is_inspection_fee_required_scheduled_at}}</td>
									</tr>
									<tr>
								...
								{{/if}}
								{{if $item.wa_is_inspection_fee_required_status_update_at}}
									<tr>
										<td>{{$item.inspection_status}}</td>
										<td style="white-space: nowrap;">{{$item.wa_is_inspection_fee_required_status_update_at}}</td>
									</tr>
								{{/if}} -->
							</table>
						</div>
