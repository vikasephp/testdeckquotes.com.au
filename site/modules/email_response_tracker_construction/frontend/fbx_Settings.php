...
// module names
$MODULE_SINGULAR = 'Email Response Tracker - Construction';
$MODULE_PLURAL =   'Email Response Tracker - Construction';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'email_response_construction';
$ID = 'er_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/email_response/'.$zipfile, S3::ACL_PRIVATE)) {
...
function create_email_response_pdf($heading, $html, $fname)
		{
...
$nameoffile = 'email_response_accounts';
...
$pdf->SetTitle("CGFB");
$pdf->SetSubject('Email Resposnse Traceker Construction Report');
