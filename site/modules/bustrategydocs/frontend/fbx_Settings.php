...
// module names
$MODULE_SINGULAR = 'Projects Strategy Documents';
$MODULE_PLURAL = 'Projects Strategy Document';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'business_strategy_documents';
$ID = 'bsd_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/business_documents_hub/'.$zipfile, S3::ACL_PRIVATE)) {
