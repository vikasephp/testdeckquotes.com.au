...
$tabledoc = new Fw_Db_Table('business_strategy_docs');
...
if($this_id){$fwViewData['opr'] = "Success!"; $fwViewData['title'] = 'Edit Business Document';}
}	

if ($bsd_id > 0)
	{
		$sql1 = "Select ".$TABLE.".* from ".$TABLE."
				 where ".$TABLE.".bsd_id = ". $bsd_id;
