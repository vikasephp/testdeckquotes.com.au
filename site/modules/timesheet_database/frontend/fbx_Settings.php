...
$MODULE_SINGULAR = 'Time Sheet Database';

$MODULE_PLURAL =   'Time Sheet Database';
...

{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/timesheet/'.$zipfile, S3::ACL_PRIVATE)) {
