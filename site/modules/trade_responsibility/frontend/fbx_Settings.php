...
// module names
$MODULE_SINGULAR = 'Trade Responsibility';
$MODULE_PLURAL =   'Trade Responsibility';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'trade_responsibility';
$ID = 'wa_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/warranty_log/'.$zipfile, S3::ACL_PRIVATE)) {
