...
// module names
$MODULE_SINGULAR = 'Cgfb Street Sign Report Construction';
$MODULE_PLURAL = 'Cgfb Street Sign Report Construction';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'street_sign_construction';
$ID = 'ss_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/street_sign_construction/'.$zipfile, S3::ACL_PRIVATE)) {
...
$nameoffile = 'street_sign_construction_report';
