    ...
    <form name="detail" method="post" action="{{$XFA.detail}}" enctype="multipart/form-data">
        ...
        <table id="list-table" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td colspan="3">
                    <!--<input type="text" name="street_sign[ss_address]" value="{{$detail.ss_address}}" style="width:500px;"/>-->

                    <datalist id='project'>
                        {{foreach from=$projdetail key="key" item="item"}}
                        <option value="{{$item.bsn_name}}" {{if $detail.ss_bsn_id eq $item.bsn_id}} selected="selected"
                            {{/if}}>
                            {{$item.bsn_name}}
                        </option>
                        {{/foreach}}
                    </datalist>
                    <input type="text" list='project' name="street_sign[ss_address]" style="width:700px"
                        value="{{$detail.ss_address}}" />
            ...
            <tr>
                ...
                <td><select name="street_sign[ss_have_banner]">
                        ...
                        <option value="Yes" {{if $detail.ss_have_banner=='Yes' }} selected="selected" {{/if}}>Yes
                        </option>
                    </select>
            </tr>
            ...
            <tr>
                <th>Date Sign Up :</th>
                <td> <input type="text" name="street_sign[ss_date_signup]" value="{{$detail.ss_date_signup}}"
                        class="w16em dateformat-d-ds-m-ds-Y" id="demo1" maxlength="25" /></td>

                <th>Date Sign Down :</th>
                <td> <input type="text" name="street_sign[ss_date_signdown]" value="{{$detail.ss_date_signdown}}"
                        class="w16em dateformat-d-ds-m-ds-Y" id="demo2" maxlength="25" /></td>
            </tr>


            <tr>
                <th>Date Banner Up :</th>
                <td> <input type="text" name="street_sign[ss_date_bannerup]" value="{{$detail.ss_date_bannerup}}"
                        class="w16em dateformat-d-ds-m-ds-Y" id="demo3" maxlength="25" /></td>

                <th>Date Banner Down :</th>
                <td> <input type="text" name="street_sign[ss_date_bannerdown]" value="{{$detail.ss_date_bannerdown}}"
                        class="w16em dateformat-d-ds-m-ds-Y" id="demo4" maxlength="25" /></td>
            </tr>

            <tr>
                <th>Sign Number:</th>
                <td> <input type="text" name="street_sign[ss_sign_number]" value="{{$detail.ss_sign_number}}"
            ...
            <tr>
                ...
                <td width="970px" colspan="3">
                    <textarea cols="200" id="editor" name="street_sign[ss_notes]"
                        rows="40">{{$detail.ss_notes}}</textarea>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" style="text-align:center;">
                    ...
                    <input type="button" name="btnCancelDetail" value="Cancel"
                        onclick="javascript:parent.$.fancybox.close();" class="vsml" />
                </td>
            </tr>
