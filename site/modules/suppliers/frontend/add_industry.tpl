...
<div align="center" style="min-height:350px; margin-top:20px;">
    <h3 class="page-title">Add New Insustry</h3>    
   
   <br /><br />
<form name="detail" method="post" action="{{$XFA.detail}}"  enctype="multipart/form-data">
<table id="list-table" width="100%">
    <input type="hidden" name="industry[si_id]" value="{{$detail.si_id}}" />
   {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
   

      
      <tr>
        <th>Enter Industry</th>
        <td> <input type="text" name="industry[si_industry]" value="{{$detail.si_industry}}" style="width:700px;" /></td>
      </tr>
