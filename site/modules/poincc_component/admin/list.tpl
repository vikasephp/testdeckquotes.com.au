...
<table id="list-table" width="100%" >
     <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="2%"> Unique Id</th>
        <th class="topmenu" align="center" valign="middle"> Component Name</th>
    ...
    <tr>
        ...
        <td class="text2" align="left">{{$item.pc_id}}</td>
        <td class="text2" align="left">{{$item.pc_name}}</td>
