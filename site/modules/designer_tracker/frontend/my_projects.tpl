...
<input type="text" name="{{$TABLE}}[keyword]" value="{{$keyword}}" style="width:400px;" placeholder="Search for Checklist No. Or Customer Designer Or Assignee "/>
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="Search" name="search"  /><br />

&nbsp;&nbsp;<strong>Search By Project Name :</strong>&nbsp;&nbsp;
<input type="text" name="{{$TABLE}}[keyword2]" value="{{$keyword2}}" style="width:400px;" placeholder="Enter project name after dash(-)"/>
&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type="button" name="Design Team" value="Design Team" onclick="javascript:add_new('{{$BASE_URL}}{{$XFA.design_team}}');" />
<input type="button" name="Edit Team" value="Edit Team" onclick="javascript:add_new('{{$BASE_URL}}{{$XFA.edit_team}}');" />
<input type="button" name="ADD NEW DESIGN" value="ADD NEW DESIGN" onclick="javascript:add_new('{{$BASE_URL}}{{$XFA.detail}}');" />
</div>
</form>
