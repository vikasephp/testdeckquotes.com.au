...
// module names
$MODULE_SINGULAR = 'Designer Tracker';
$MODULE_PLURAL = 'Designer Tracker';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'designer_tracker';
$ID = 'dt_id';
...
$XFA['design_team'] = $Fusebox['circuit'] . '.design_team';
$XFA['edit_team'] = $Fusebox['circuit'] . '.edit_team';
$XFA['add_task'] = $Fusebox['circuit'] . '.add_task';

$XFA['add_comment'] = $Fusebox['circuit'] . '.add_comment';


function create_weekly_letter($heading, $html, $address)
		{
...
$nameoffile = 'inclusion_report';
//$filename = $nameoffile."_".date('d_m_Y').".pdf";
$filename = "Customer Design Update Letter - ".$address.".pdf";
