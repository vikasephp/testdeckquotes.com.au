		...
		<table id="list-table" width="100%">
			...
			<tr>
				...
				<td><select name="{{$TABLE}}[lv_type]">
						...
						<option value="{{$item2.lt_id}}" {{if $item2.lt_id eq $detail.lv_type}} selected="selected"
							{{/if}}>
							{{$item2.lt_option}}
						</option>
						{{/foreach}}
			...
			<tr>
				...
				<td><input type="text" name="{{$TABLE}}[lv_payment_option]" value="{{$detail.lv_payment_option}}"
			...
			<tr>
				...
				<td>
					...
					<input type="text" list='project' name="{{$TABLE}}[lv_project_address]" style="width:700px"
						value="{{$detail.lv_project_address}}" />
				</td>
			</tr>
			<tr>
				<th>LVC Type</th>
				<td>
					<select name="{{$TABLE}}[lv_lvc_type]">
						...
						<option value="{{$item4.lv_id}}" {{if $item4.lv_id eq $detail.lv_lvc_type}} selected="selected"
							{{/if}}>
							{{$item4.lv_option}}
						</option>
						{{/foreach}}
			...
			<tr>
				...
				<td><input type="text" name="{{$TABLE}}[lv_ma]" value="{{$detail.lv_ma}}" style="width:700px;" /></td>
			</tr>
			<tr>
				<th>Fee $</th>
				<td><input type="text" name="{{$TABLE}}[lv_fee]" value="{{$detail.lv_fee}}" style="width:700px;" />
				</td>
			</tr>
			<!--  <tr>
     <th>Report Link</th>
