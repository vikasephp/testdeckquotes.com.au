		...
		<td>
			...
			<form name="mshort" action="{{$BASE_URL}}{{$XFA.home}}" method="post">
				...
				<div style="float:right; text-align:right;">
					...
					<input type="button" name="priority" value="Edit Require Escalation" onclick="javascript:add_priority();" />
					<br />
					...
					<div style="border:1px solid #F00; display:inline-block; padding:10px; background: #CCC;">
						...
						<input type="submit" name="print_filter" value="Print Merge For Filter by Require Escalation - Open"
