...
if (!empty($submit)) {
	...
	foreach ($waData as $k => $m) {
		...
		$link = '';
		if ($m['wa_image_1']) {
			$link .= '<a href="/warranty_log.download_content?file_name=' . $m["wa_image_1"] . '&module_name=warranty_log.home" target="_blank">Link of Image 1 </a><br>';
		}
		if ($m['wa_image_2']) {
			$link .= '<a href="/warranty_log.download_content?file_name=' . $m["wa_image_2"] . '&module_name=warranty_log.home" target="_blank">Link of Image 2</a> <br>';
		}

		if ($m['wa_image_3']) {
			$link .= '<a href="/warranty_log.download_content?file_name=' . $m["wa_image_3"] . '&module_name=warranty_log.home" target="_blank">Link of Image 3</a> <br>';
		}

		if ($m['wa_image_4']) {
			$link .= '<a href="/warranty_log.download_content?file_name=' . $m["wa_image_4"] . '&module_name=warranty_log.home" target="_blank">Link of Image 4</a><br>';
		}

		if ($m['wa_image_5']) {
			$link .= '<a href="/warranty_log.download_content?file_name=' . $m["wa_image_5"] . '&module_name=warranty_log.home" target="_blank">Link of Image 5</a>';
		}
		...
		if (!empty($suData[$m['wa_id']])) {
			foreach ($suData[$m['wa_id']] as $kn2 => $vn2) {
				...
				if (!empty($vn2['ws_attachment'])) {
					...
					$notes .= '<a href="https://warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/' . $vn2['ws_attachment'] . '">Link</a>';
				}
				$notes .= '</td>';
				$notes .= '</tr>';
			}
			...
			foreach ($notesData[$m['wa_id']] as $kn => $vn) {
				...
				if (isset($vn['wn_id'])) {
					...
					if (!empty($vn['ws_attachment'])) {
						$notes .= '<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/' . $vn['ws_attachment'] . '">Link</a><br/>';
					}
					if (!empty($vn['ws_attachment_2'])) {
						$notes .= '<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/' . $vn['ws_attachment_2'] . '">Link</a><br/>';
					}
					if (!empty($vn['ws_attachment_3'])) {
						$notes .= '<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/' . $vn['ws_attachment_3'] . '">Link</a><br/>';
					}
					if (!empty($vn['ws_attachment_4'])) {
						$notes .= '<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/' . $vn['ws_attachment_4'] . '">Link</a><br/>';
					}
					if (!empty($vn['ws_attachment_5'])) {
						$notes .= '<a href="https://www.warrantyreport.com.au/public/global_files/uploads/warranty_issue_comments_files/' . $vn['ws_attachment_5'] . '">Link</a><br/>';
					}
					$notes .= '</td>';
				}
						...
						if (!empty($vn[$field])) {
							...
							if ($isValid) {
								if (in_array(strtolower($contentType), $allowedImageTypes) || in_array($ext, $allowedImageExtensions)) {
									...
									$notes .= '<a href="' . $fileUrl . '" target="_blank">Download Attachment</a><br/>';
								}
							} else {
						...
						if (!empty($vn[$field])) {
							...
							if ($headers && strpos($headers[0], '200') !== false) {
								...
								if (in_array(strtolower($contentType), $allowedImageTypes) || in_array($ext, $allowedImageExtensions)) {
									...
									$notes .= '<a href="' . $imageUrl . '" target="_blank">Download Attachment</a><br/>';
								}
							} else {
...
if (!empty($setdata2)) {
	...
	foreach ($setdata2 as $k => $v2) {
		...
		if(!empty($data['bs_business_id'])) {
			$projectLink = '<a href="business.detail/bsn_id/' . $data['bs_business_id'] . '">' . $v2['wa_project'] . '</a>';
		}
