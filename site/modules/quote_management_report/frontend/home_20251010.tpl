	...
	<div style="display: flex; justify-content: space-between; align-items: end;">
		<div style="text-align: left; margin-left: 10px;">
			<div>
				...
				<input type="button" name="component" value="Edit Component" onclick="javascript:add_component();" />
				<input type="button" name="edit_project" value="Edit Project" onclick="javascript:edit_component();" />
			</div>
			<div>
		...
		<div style="text-align: right; margin-right: 10px;">
			<div>
				<input type="submit" name="show_hidden_quotes" value="Hidden Quotes" />
