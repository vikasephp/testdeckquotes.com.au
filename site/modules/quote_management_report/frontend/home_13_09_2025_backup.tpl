...
<form name="mshort" action="{{$BASE_URL}}{{$XFA.home}}" method="post">
	<div style="float:left; text-align:left;">
		...
		&nbsp; &nbsp;<input type="button" name="component" value="Edit Component"
			onclick="javascript:add_component();" /> <br />
		...
		&nbsp; &nbsp;<input type="text" name="position" style="width:350px;" placeholder="Search for Position" />
		<input type="submit" value="Search" name="search" /> &nbsp; <br />
	...
	<table id="list-table" class="nav-back" width="100%">
		<thead>
			<tr>
				...
				<th class="topmenu" align="center" valign="middle" width="5%" data-col="qm_qmrs_id">Status</th>
