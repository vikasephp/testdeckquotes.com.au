	...
	if($_FILES['attach_1']['name'])
		{
			...
			$detail['qm_attachment_1_date'] = date('Y-m-d H:i:s');
	...
	if($_FILES['attach_2']['name'])
		{
			...
			$detail['qm_attachment_2_date'] = date('Y-m-d H:i:s');
	...
	if($_FILES['attach_3']['name'])
		{
			...
			$detail['qm_attachment_3_date'] = date('Y-m-d H:i:s');
	...
	if($_FILES['attach_4']['name'])
		{
			...
			$detail['qm_attachment_4_date'] = date('Y-m-d H:i:s');
	...
	if($_FILES['attach_5']['name'])
		{
			...
			$detail['qm_attachment_5_date'] = date('Y-m-d H:i:s');
