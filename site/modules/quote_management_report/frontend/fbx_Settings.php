...
// module names
$MODULE_SINGULAR = 'Quote Management Report';
$MODULE_PLURAL =   'Quote Management Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'quote_management_report';
$ID = 'qm_id';
$fwViewData['TABLE'] = $TABLE;
$fwViewData['ID'] = $ID;
$BASEFOLDER = $TABLE;
$fwViewData['BASEFOLDER'] = $TABLE;
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/quote_management_report/'.$zipfile, S3::ACL_PRIVATE)) {
