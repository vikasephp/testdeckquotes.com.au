...
// module names
$MODULE_SINGULAR = 'Design Plans - Mistake Log';
$MODULE_PLURAL =   'Design Plans - Mistake Log';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'design_plans_mistake_log';
$ID = 'dpml_id';
$HIDE_COL = 'dpml_hide';
...
// FOR PROCEDURE PANEL
$PPTABLE = 'pp_design_plans_mistake_log';
$PPID = 'pr_id';
...
$BASEFOLDER = 'design_plans_mistake_log';
