  ...
  <table id="doclist-table" class="nav-back" width="100%">
    <thead>
      <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="8%">DA Number</th>
        ...
        <th class="topmenu" align="center" valign="middle" width="7%">Applicant</th>
        <th class="topmenu" align="center" valign="middle" width="7%">Lessee</th>
        <th class="topmenu" align="center" valign="middle" width="7%">Date Create</th>
        ...
        <th class="topmenu" align="center" valign="middle" width="28%">Merged Plans </th>
    ...
    <form name="mlist" method="post">
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
        ...
        <td><div class="tooltip">
            {{if $item.da_merge_plans}}<a href="{{$BASE_URL}}files/meeting_minutes_doc/{{$item.da_merge_plans}}?dummy={{$ran}}" target="_blank" style="padding-bottom:2px;">{{$item.da_merge_plans|truncate:70:"...":true}}</a>
