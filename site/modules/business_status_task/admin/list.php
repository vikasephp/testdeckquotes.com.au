...
$bstasksql = "SELECT " . $TABLE . ".*, busness_status.*, project_type.*, positions.p_name, authorizearea.*, datafields.* FROM " . $TABLE . " 
...
WHERE " . $TABLE . ".bst_business_status_id = " . $bst_business_status_id . " " . $posfilter . " ORDER BY " . $TABLE . ".bst_order ASC";
//WHERE ".$TABLE.".bst_business_status_id = ".$bst_business_status_id." ORDER BY positions.p_name ASC";
