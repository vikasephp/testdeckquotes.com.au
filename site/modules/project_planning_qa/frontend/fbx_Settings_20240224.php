...
// module names
$MODULE_SINGULAR = 'Design Q/A Clearing Centre';
$MODULE_PLURAL =   'Design Q/A Clearing Centre';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'planning_approval_enquiries';
$ID = 'id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/project_planning_qa/'.$zipfile, S3::ACL_PRIVATE)) {
