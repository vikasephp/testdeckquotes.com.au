...
$tableqa = new Fw_Db_Table('planning_approval_enquiries');
...
if (!empty($submit)) {
	...
	$sql = "Select business.bsn_name, planning_approval_enquiries.enquiry, planning_approval_enquiries.solution, 
	        planning_approval_enquiries.created_at, planning_approval_enquiries.user_id from business 
	        inner join planning_approval_enquiries on business.bsn_id = planning_approval_enquiries.project_id
			where planning_approval_enquiries.id = " . $this_id;
