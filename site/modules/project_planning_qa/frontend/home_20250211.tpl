...
<form name="mshort" action="{{$BASE_URL}}{{$XFA.home}}" method="post">
	...
	<div style="float:right;">
		...
		<input type="button" name="Add New " value="Add New"
			onclick="javascript:add_new('{{$BASE_URL}}project_planning_qa.detail_addnew');" />
	</div>
</form>
<div id="">
			...
			<tr bgcolor="#FFFFFF">
				...
				<td>
					...
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ques_1}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 1</a>
					</div>
					{{/if}}
					{{if $item.attachment_ques_2}}
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ques_2}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 2</a>
					</div>
					{{/if}}
					{{if $item.attachment_ques_3}}
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ques_3}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 3</a>
					</div>
					{{/if}}
					{{if $item.attachment_ques_4}}
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ques_4}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 4</a>
					</div>
					{{/if}}
					{{if $item.attachment_ques_5}}
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ques_5}}&module_name=project_planning_qa.home"
				...
				<td>
					...
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ans_1}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 1</a>
					</div>
					{{/if}}
					{{if $item.attachment_ans_2}}
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ans_2}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 2</a>
					</div>
					{{/if}}
					{{if $item.attachment_ans_3}}
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ans_3}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 3</a>
					</div>
					{{/if}}
					{{if $item.attachment_ans_4}}
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ans_4}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 4</a>
					</div>
					{{/if}}
					{{if $item.attachment_ans_5}}
					<div style="text-align:center;">
						<a href="/project_planning_qa.download_content?file_name={{$item.attachment_ans_5}}&module_name=project_planning_qa.home"
							target="_blank">Attachment 5</a>
					</div>
					{{/if}}
				</td>
				...
				<td>
					<select name="method" Onchange="update_method({{$item.id}},this.value)">
						...
						<option value="Website" {{if $item.method eq 'Website' }} selected="selected" {{/if}}>Website
						</option>
					</select>
					<script>
				...
				<td> <a href="{{$BASE_URL}}{{$XFA.detail}}/question_id/{{$item.id}}" class="various" title="Edit">
					...
					<a href="{{$BASE_URL}}{{$XFA.delete}}/question_id/{{$item.id}}"
