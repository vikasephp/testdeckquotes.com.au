...
// module names
$MODULE_SINGULAR = 'Variations In Progress';
$MODULE_PLURAL =   'Variations In Progress';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'bus_variations';
$ID = 'va_id';
$fwViewData['TABLE'] = $TABLE;
$fwViewData['ID'] = $ID;

$PPTABLE = 'pp_variations_in_progress';
$PPID = 'pr_id';
...
$BASEFOLDER = 'variations_in_progress';
