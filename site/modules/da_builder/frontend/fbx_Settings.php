...
// module names
$MODULE_SINGULAR = 'DA Builder';
$MODULE_PLURAL =   'DA Builder';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/da_builder/'.$zipfile, S3::ACL_PRIVATE)) {
...
function create_report_rule($heading, $html)
		{
...
$pdf->SetTitle("CGFB");
$pdf->SetSubject('Rule List Report');
