...
if(!empty($designer)) { $_SESSION['designer'] = $designer; }
if(!empty($_SESSION['designer'])) {  $designer = $_SESSION['designer']; }
				...
				foreach($colhead as $kk => $vv)
				{
				   $taskid = $vv['bst_task_id'];
				    ...
				    $sql2 = "Select proposal_tasks.* from proposal_tasks
					     where proposal_tasks.bt_bsn_id = ". $v['bsn_id'].
					     " And proposal_tasks.bt_task_id = " .$vv['bst_task_id'] .
