...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
	   ...
	   {  
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/meeting_minutes_doc/'.$zipfile, S3::ACL_PUBLIC_READ)) {
