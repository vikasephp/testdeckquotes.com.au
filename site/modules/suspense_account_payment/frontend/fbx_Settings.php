...
// module names
$MODULE_SINGULAR = 'Suspense Account Payment Report';
$MODULE_PLURAL =   'Suspense Account Payment Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'suspense_account_payment';
$ID = 'sa_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/email_response/'.$zipfile, S3::ACL_PRIVATE)) {
...
$pdf->SetTitle("CGFB");
$pdf->SetSubject('Email Resposnse Traceker Accounts Report');
