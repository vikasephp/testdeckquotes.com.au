...
// module names
$MODULE_SINGULAR = 'Debt Management Report';
$MODULE_PLURAL =   'Debt Management Report';
...
$ACTION_TABLE = 'debt_management_action';
$ACTION_ID = 'dma_id';
$fwViewData['ACTION_TABLE'] = $ACTION_TABLE;
$fwViewData['ACTION_ID'] = $ACTION_ID;

$JURISDICTION_TABLE = 'debt_management_jurisdiction';
$JURISDICTION_ID = 'dmj_id';
$fwViewData['JURISDICTION_TABLE'] = $JURISDICTION_TABLE;
$fwViewData['JURISDICTION_ID'] = $JURISDICTION_ID;

$BASEFOLDER = 'debt_management_report';
	...
	$zipfile = $filename;
        ...
        try {
		 ...
		 $s3 = new S3(ACCESS_KEY, SECRET_KEY);
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/uploads_2024/'.$zipfile, S3::ACL_PRIVATE)) {
