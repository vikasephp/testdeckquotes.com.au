	...
	<table id="list-table" class="nav-back" width="100%">
		<thead>
			<tr>
				...
				<th class="topmenu" style="text-align: center;" valign="middle" width="8%" data-col="correspondence">Correspondence</th>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td data-col="jurisdiction">
					<select name="{{$TABLE}}[dm_jurisdiction_id]" onchange="updateRecord('{{ $item.$ID }}', 'dm_jurisdiction_id', this.value)">
                        ...
                        {{ foreach from=$jurisdictiondata key="key2" item="item2" }}
