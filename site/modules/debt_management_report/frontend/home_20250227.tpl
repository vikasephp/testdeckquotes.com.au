	...
	<table id="list-table" class="nav-back" width="100%">
		<thead>
			<tr>
				...
				<th class="topmenu" align="center" valign="middle" width="8%">Jurisdiction</th>
		...
		<tbody>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td><input type="text" name="last[{{$item.dm_id}}]" class="w16em dateformat-d-ds-m-ds-Y dtpic"
				...
				<td><a href="{{$BASE_URL}}debt_management_report.notes/dm_id/{{$item.dm_id}}" class="various">Notes</a>
				</td>
				<td>
...
<script>
	function displayToggle(record_id, c, t) {
        ...
        $.ajax({
            type: "POST",
            url: "{{$BASE_URL}}debt_management_report.ajax_handler",
            data: formData,
            dataType: "json",
            encode: true,
