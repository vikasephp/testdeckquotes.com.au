...
<script type="text/javascript">
	...
	window.location.href = "{{$BASE_URL}}{{ $BASEFOLDER }}.view_jurisdiction";
</script>
{{/if}}
<div align="center" style="min-height:350px; margin-top:50px; z-index:999999 !important;">
	<h3 class="page-title">Add/Edit New Jurisdiction</h3>
	<form name="detail" method="post" action="" enctype="multipart/form-data">
		<table id="list-table" width="100%">
			...
			<tr>
				<th>Option </th>
				<td>
					<input type="text" name="task[dmj_option]" style="width:700px" value="{{$detail.dmj_option}}" />
				</td>
			</tr>
			<tr>
