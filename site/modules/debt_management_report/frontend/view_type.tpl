...
<table id="list-table" width="99%">
    ...
    <tr>
        <td>{{ counter }}</td>
        <td>{{$item.dmt_option}}</td>
        <td>
            <a href="{{$BASE_URL}}debt_management_report.add_type/dmt_id/{{$item.dmt_id}}" class="various" title="Edit">
                <img style="height:20px; width:20px;" src="{{$BASE_URL}}css/admin/images/edit.png" /></a>
            <a href="{{$BASE_URL}}debt_management_report.delete_type/dmt_id/{{$item.dmt_id}}" onclick="javascript:if(!confirm('Are you sure want to delete this Type?')) return false;" title="Delete">
