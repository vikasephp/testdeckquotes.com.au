...
// $matsql = "SELECT $TABLE.*, T30.td_project_name, T30.td_dmp, T30.td_dmp_date, T30.td_dmp_user FROM $TABLE LEFT JOIN 30_days_rec_report T30 ON T30.td_project_name = $TABLE.dm_bsn_name $where AND T30.td_dmp = 1 $ord";
// echo "<br>";
...
$invoicesql = "Select it_type from invoice_types";
if ($invoicesql) {
    $invoiceType = $fwDb->query($invoicesql);
    $fwViewData['invoiceType'] = $invoiceType;
}
