...
//echo "<pre>"; print_r($data_proposal_number); exit();
...
//$subject = 'Your Latest Proposals Are Now Available - Checklist '.$checklist_number_list .$more_proposal_number.' - '.$customer_address;
$subject = 'Your Latest Proposals Are Now Available - Checklist ' .$checklist_number_list;
...
$email_content .= '<p style="margin-bottom: 15px;">We are pleased to inform you that your Latest <strong>Proposals for Checklist '.$checklist_number_list;
if (!empty($more_proposal_number)) {
...
$email_content .= '<p style="margin-bottom: 15px;">Kindly Check <strong>Updated Proposal Documents</strong> section, for the following documents which has been updated. </p>';
...
$email_content .= '<span style="color:rgb(85,142,213)">Phone: 1300 979 658</span> <span style="color:rgb(255,192,0)"><b>|</b></span> <span style="color:rgb(85,142,213)">Fax: 1300 979 657</span> <br/><span style="color:rgb(85,142,213)">Postal: Unit 11/160 Lysaght Street, Mitchell ACT 2911</span> <br/><span style="color:rgb(85,142,213)">ACT Building Lic: 2012767</span>';
$email_content .= '</p>';
...
$from_email = "DesignsandPlanning@cgfb.com.au";
