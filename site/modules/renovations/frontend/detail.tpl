...
<table id="list-table" width="100%">
   ...
   {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
    ...
    <tr>
     <th>Title</th>
     <td>
         <input type="text"  name="{{$TABLE}}[re_title]" style ="width:990px" value="{{$detail.re_title}}" />
      </td>
    </tr>
   ...
   <tr>
     <th>Header</th>
     <td>
         <input type="text"  name="{{$TABLE}}[re_header]" style ="width:990px" value="{{$detail.re_header}}" />
      </td>
    </tr>
