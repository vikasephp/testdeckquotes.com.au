    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                ...
                <th class="topmenu" align="center" valign="middle" width="40%">Text</th> 
...
<tbody>
 ...
 <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
    ...
    <td>{{$item.sf_id}}</td>
    <td>{{$item.sf_title}}</td>
    <td> <table  width="500" id="none-table22"><tr><td><textarea rows="10" cols="100" class="tinymce">{{$item.sf_body|stripslashes}}</textarea>
    </td></tr></table>
    </td> 
