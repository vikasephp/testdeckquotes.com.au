...
// module names
$MODULE_SINGULAR = 'Missing Variation Invoice Report';
$MODULE_PLURAL =   'Missing Variation Invoice Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'missing_variation_invoice';
$ID = 'mv_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/missing_variations/'.$zipfile, S3::ACL_PRIVATE)) {
