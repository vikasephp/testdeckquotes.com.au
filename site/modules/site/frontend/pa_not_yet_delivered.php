...
$message .= "<tr><td>SrNo</td><td>Customer Name</td><td>Project</td><td>Link</td><td>Create Record Date</td><td>Day Count</td>
			<td>Project Status</td><td>Complete Planning Assessment <br>Proposal - PDF (for Customer)</td>
			<td>Planning Assessment Meeting Completed Template </td><td>UID 402 Marked Complete</td></tr>";
	...
	foreach($paData as $k => $v)
	{
				...
				$sqlb = "Select document_check_list.* from document_check_list
			             where document_check_list.doc_bsn_id = ". $bsn_id . " And document_check_list.doc_name_id = 265";
				...
				$message .= "<td>".$completed44."</td>";
				$message .= "<td>".$completed265."</td>";
...
//db($message);
//exit;
send_email('Frank Walmsley', 'marketing@cgfb.com.au', 'CGFB', 'info@deckquotes.com.au', 'Planning Assessment Completed Not Yet Delivered', $message, $attachment='');
send_email('Frank Walmsley', 'info@cgfb.com.au', 'CGFB', 'info@deckquotes.com.au', 'Planning Assessment Completed Not Yet Delivered', $message, $attachment='');
send_email('Manoj Soni', 'manojsoniephp@gmail.com', 'CGFB', 'info@deckquotes.com.au', 'Planning Assessment Completed Not Yet Delivered', $message, $attachment='');
