...
foreach($Data_1 as $k1=>$v1)
{
	$sql_2 = "select  * from construction_alert_report 
	          where car_project like '%".$v1['ic_project']."%' and car_status = 'Open' and car_include_cust = 'Yes'";
	...
	foreach($Data_2 as $k2=>$v2)
	{
		 ...
		 if($v2['car_date']) {
		  ...
		  $link ='';
		   if($v2['car_image1']) {
			   $link .= '<a href="'.BASE_URL."files/uploads/".$v2['car_image1'].'">Link to Attachment1</a><br>';
		   }
		  if($v2['car_image2']) {
			   $link .= '<a href="'.BASE_URL."files/uploads/".$v2['car_image2'].'">Link to Attachment2</a><br>';
		   }
		  
		  if($v2['car_image3']) {
			   $link .= '<a href="'.BASE_URL."files/uploads/".$v2['car_image3'].'">Link to Attachment3</a><br>';
		   }
		   
		   if($v2['car_image4']) {
			   $link .= '<a href="'.BASE_URL."files/uploads/".$v2['car_image4'].'">Link to Attachment4</a><br>';
		   }
