...
foreach ($Data_1 as $k1=>$v1) 
{
	...
	foreach($data_w as $k2=>$v2)
	{
		...
		if(!empty($v2["wa_image_1"])) {
			...
			$folder_path = "files/warranty_log/";  $object_name = $v2["wa_image_1"];
		...
		if(!empty($v2["wa_image_2"])) {
			$folder_path = "files/warranty_log/";  $object_name = $v2["wa_image_2"];
		    $file = get_file_raw_data($folder_path,$object_name);
		...
		if(!empty($v2["wa_image_3"])) {
			$folder_path = "files/warranty_log/";  $object_name = $v2["wa_image_3"];
		    $file = get_file_raw_data($folder_path,$object_name);
		...
		if(!empty($v2["wa_image_4"])) {
			...
			$folder_path = "files/warranty_log/";  $object_name = $v2["wa_image_4"];
		    $file = get_file_raw_data($folder_path,$object_name);
		...
		if(!empty($v2["wa_image_5"])) {
			$folder_path = "files/warranty_log/";  $object_name = $v2["wa_image_5"];
		    $file = get_file_raw_data($folder_path,$object_name);
