...
foreach ($bsnData as $k1 => $v1)
{
	...
	$message .= '<tr><td width="5%">SrNo</td><td width="30%">Your Question</td><td width="10%">Question Attachment</td><td width="35%"> Our Answer</td><td width="10%">Answer Attachment</td><td width="10%"> Create Date </td></tr>';
