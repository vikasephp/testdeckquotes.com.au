...
$sql = "SELECT  business_sellers.bs_business_id, business_sellers.bs_customers_id, bus_customers.bcust_fname, bus_customers.bcust_lname,
        business.bsn_id, business.bsn_name,business.bsn_sub_status, business.bsn_status_sys_date 
...
$message .= "<tr><td>SrNo</td><td>Customer Name</td><td>Project Name</td><td>Link</td><td>Date Of Enquiry </td>
			...
			<td>Planning Assessment Report</td>
			<td>Meeting Minutes Present</td>
			<td>Signed Designed Agreement</td>
			</tr>";
...
//				 }
				...
				//uid 290
				$sql290 = "Select document_check_list.* from document_check_list
			                 where document_check_list.doc_bsn_id = ". $bsn_id . " And document_check_list.doc_name_id = 290";
	
				$data290 = $fwDb->queryOne($sql290);
				
				if(!empty($data290['doc_file_name']))
				 {
					   $completed290 ='Yes'; 
					   $class4='';
				}
				...
				//uid 36
				$sql36 = "Select document_check_list.* from document_check_list
			                 where document_check_list.doc_bsn_id = ". $bsn_id . " And document_check_list.doc_name_id = 36";
	
				$data36 = $fwDb->queryOne($sql36);
				
				if(!empty($data36['doc_file_name']))
				 {
					   $completed36 ='Yes'; 
					   $class6='';
				}
				...
				{ 
					 $uidcomplete480 = "No"; 
					 $class55 = "style='background:#F00'";
				}
				else 
				{ 
					 $uidcomplete480 = "No"; 
					 $class55 = "style='background:#FF0'";
				}
				//
				...
				{ 
					 $uidcomplete513 = "No"; 
					 $class66 = "style='background:#F00'";
				}
				else 
				{ 
					 $uidcomplete513 = "No"; 
					 $class66 = "style='background:#FF0'";
				}
				//
				...
				//$message .= "<td $class2>". $ccs. "</td>";
				$message .= "<td $class9>".$uidcomplete302."</td>";
				$message .= "<td $class8>".$uidcomplete137."</td>";
				$message .= "<td $class1>".$uploaded."</td>";
				$message .= "<td $class6>".$completed36."</td>";
				$message .= "<td $class4>". $completed290."</td>";
				$message .= "<td $class5>".$completed45."</td>";
...
//send_email('Saurabh V',  'supportmanager@cgfb.com.au', 'CGFB', 'info@cgfb.com.au', 'Planning Assessment Report', $message, $attachment='');
exit;
