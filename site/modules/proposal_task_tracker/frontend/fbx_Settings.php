...
function create_proposal_report($heading, $html)
		{
	...
	include_once $filetoinclude;
        ...
        try {
          ...
          $s3 = new S3(ACCESS_KEY, SECRET_KEY);
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/quote_builder/'.$zipfile, S3::ACL_PUBLIC_READ)) {
