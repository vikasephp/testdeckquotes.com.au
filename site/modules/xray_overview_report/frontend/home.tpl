...
<form name="mlist" method="post" enctype="multipart/form-data">
	...
	<div style="float:right; margin-right: 5px;"> 
		<input type="button" value="Export To XLS" onclick="document.location.href='{{$BASE_URL}}xray_overview_report.home/export/1'" />
	</div>
		...
		<table id="doclist-table" class="nav-back" width="100%">
			<thead>
				<tr>
					...
					<th class="topmenu" align="center" valign="middle" width="7%">Painting Complete - Invoice</th>
