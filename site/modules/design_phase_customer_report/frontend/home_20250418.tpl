                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch" for="bsn_pa_design_flag{{ $item.bsn_id }}">
                                <input id="bsn_pa_design_flag{{ $item.bsn_id }}" class="switch-input" {{ if $item.bsn_pa_design_flag == 1 }}checked{{ /if }} onchange="projectPhasesToggle('{{ $item.bsn_id }}', 'bsn_pa_design_flag', this)" type="checkbox" />
                                <span class="switch-label" data-on="Yes" data-off="No"></span>
                                <span class="switch-handle"></span> <br />
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch" for="bsn_pa_planning_flag{{ $item.bsn_id }}">
                                <input id="bsn_pa_planning_flag{{ $item.bsn_id }}" class="switch-input" {{ if $item.bsn_pa_planning_flag == 1 }}checked{{ /if }} onchange="projectPhasesToggle('{{ $item.bsn_id }}', 'bsn_pa_planning_flag', this)" type="checkbox" />
                                <span class="switch-label" data-on="Yes" data-off="No"></span>
                                <span class="switch-handle"></span> <br />
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch" for="bsn_pa_inclusion_flag{{ $item.bsn_id }}">
                                <input id="bsn_pa_inclusion_flag{{ $item.bsn_id }}" class="switch-input" {{ if $item.bsn_pa_inclusion_flag == 1 }}checked{{ /if }} onchange="projectPhasesToggle('{{ $item.bsn_id }}', 'bsn_pa_inclusion_flag', this)" type="checkbox" />
                                <span class="switch-label" data-on="Yes" data-off="No"></span>
                                <span class="switch-handle"></span> <br />
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch" for="bsn_pa_construction_flag{{ $item.bsn_id }}">
                                <input id="bsn_pa_construction_flag{{ $item.bsn_id }}" class="switch-input" {{ if $item.bsn_pa_construction_flag == 1 }}checked{{ /if }} onchange="projectPhasesToggle('{{ $item.bsn_id }}', 'bsn_pa_construction_flag', this)" type="checkbox" />
                                <span class="switch-label" data-on="Yes" data-off="No"></span>
                                <span class="switch-handle"></span> <br />
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch" for="bsn_pa_completion_flag{{ $item.bsn_id }}">
                                <input id="bsn_pa_completion_flag{{ $item.bsn_id }}" class="switch-input" {{ if $item.bsn_pa_completion_flag == 1 }}checked{{ /if }} onchange="projectPhasesToggle('{{ $item.bsn_id }}', 'bsn_pa_completion_flag', this)" type="checkbox" />
                                <span class="switch-label" data-on="Yes" data-off="No"></span>
                                <span class="switch-handle"></span> <br />
                            </label>
                        </td>
