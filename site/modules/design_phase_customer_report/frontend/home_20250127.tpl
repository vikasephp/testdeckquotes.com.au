        ...
        <input type="text" name="searchkey" value="{{$searchkey}}" style="width:400px;" placeholder="" />
          ...
          <select name="filterStatus" class="lrg">
              ...
              {{foreach from = $business_status key="key3" item="status"}}
                <option value="{{$status.st_id}}" {{if $filterStatus ==$status.st_id }} selected {{/if}}> {{$status.st_name}}</option>
              {{/foreach}}
    	  </select>
    	  <br/>
            ...
            <td>  
                <form name="recmet3" method="post" action="">
                    ...
                    <label class="switch">
                        ...
                        <input class="switch-input" type="checkbox" name="audit[{{$item.bs_business_id}}]" value="1"
                            onclick="this.form.submit();" {{if $item.bs_audit_block eq 1 }} checked="checked"
                            {{/if}} />
                        <span class="switch-label" data-on="Yes" data-off="No"></span>
                        <span class="switch-handle"></span> <br />
                    </label>
