...
if ($block) {
	...
	$detail['bcust_pcr_block_username'] = $_SESSION['user']['user_name'];
	$detail['bcust_pcr_block_date'] = date('Y-m-d');
...
foreach ($lists as $k => $v) {
	...
	$ckhlist_sqlus = "SELECT document_proposal_name.checklist_status, document_proposal_name.dpn_id, document_proposal_name.dpn_bsn_id, document_proposal_name.dpn_name, document_proposal_name.dpn_unique_id, document_proposal_name.dpn_uid_enabler_name, document_proposal_name.dpn_uid_enable_time FROM `document_proposal_name` where dpn_bsn_id =" . $v['bs_business_id'];
	$ckhlist_sqlus_r = $fwDb->query($ckhlist_sqlus);

	$reno_sql = "SELECT document_renovation_name.checklist_status, document_renovation_name.dpn_id, document_renovation_name.dpn_bsn_id, document_renovation_name.dpn_name, document_renovation_name.dpn_unique_id, document_renovation_name.dpn_uid_enabler_name, document_renovation_name.dpn_uid_enable_time FROM `document_renovation_name` where dpn_bsn_id =" . $v['bs_business_id'];
	$reno_res = $fwDb->query($reno_sql);
	...
	$lists[$k]['checklist_reno'] =  $reno_res;
