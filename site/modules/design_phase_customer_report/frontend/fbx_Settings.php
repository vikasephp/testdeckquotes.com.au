...
// module names
$MODULE_SINGULAR = 'Planning Customer Details Report';
$MODULE_PLURAL = 'Planning Customer Details Report';
	...
	include_once $filetoinclude;
        ...
        try {
 	    ...
 	    $s3 = new S3('AKIA2AMNCYNN5VRBSNNU', '5ys4bfLGJQDLgX/Pc+E66/2Yo8jpMgjcdAn1jGKg');
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/uploads/'.$zipfile, S3::ACL_PUBLIC_READ)) {
