...
<script type="text/javascript">
	    ...
	    var geturl= "{{$BASE_URL}}poincc3.doclist/po_id/"; // The server-side script
		var getdelurl= "{{$BASE_URL}}poincc3.docdelete/po_id/"; // The server-side script
 ...
 <input type="hidden" name="poincc[po_id]" value="{{$detail.$ID}}" id="dh_id"/>
     <table id="viewdoc-table" width="80%" cellpadding="0" cellspacing="0" >
      ...
      <tr>
		...
		<tr class="projectAddress2" {{ if $detail.po_project_number2}}style="display:table-row;"{{/if}}>
			<th> Project Address2:</th>
            <td>
            <datalist id='address2'>
           {{foreach from=$busdetail key="key_pa2" item="item_pa2"}}
            <option value="{{$item_pa2.bsn_address}}">
            {{$item_pa2.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number2]" list="address2" value="{{$detail.po_project_number2}}" style="width:300px;"/>            
            </td>
		</tr>
		
		<tr class="projectAddress3" {{ if $detail.po_project_number3}}style="display:table-row;"{{/if}}>
			<th> Project Address3:</th>
            <td>
            <datalist id='address3'>
           {{foreach from=$busdetail key="key_pa3" item="item_pa3"}}
            <option value="{{$item_pa3.bsn_address}}">
            {{$item_pa3.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number3]" list="address3" value="{{$detail.po_project_number3}}" style="width:300px;"/>            
            </td>
		</tr>
		
		<tr class="projectAddress4" {{ if $detail.po_project_number4}}style="display:table-row;"{{/if}}>
			<th> Project Address4:</th>
            <td>
            <datalist id='address4'>
           {{foreach from=$busdetail key="key_pa4" item="item_pa4"}}
            <option value="{{$item_pa4.bsn_address}}">
            {{$item_pa4.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number4]" list="address4" value="{{$detail.po_project_number4}}" style="width:300px;"/>            
            </td>
		</tr>
		
		<tr class="projectAddress5" {{ if $detail.po_project_number5}}style="display:table-row;"{{/if}}>
			<th> Project Address5:</th>
            <td>
            <datalist id='address5'>
           {{foreach from=$busdetail key="key_pa5" item="item_pa5"}}
            <option value="{{$item_pa5.bsn_address}}">
            {{$item_pa5.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number5]" list="address5" value="{{$detail.po_project_number5}}" style="width:300px;"/>            
            </td>
		</tr>
		
		<tr class="projectAddress6" {{ if $detail.po_project_number6}}style="display:table-row;"{{/if}}>
			<th> Project Address6:</th>
            <td>
            <datalist id='address6'>
           {{foreach from=$busdetail key="key_pa6" item="item_pa6"}}
            <option value="{{$item_pa6.bsn_address}}">
            {{$item_pa6.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number6]" list="address6" value="{{$detail.po_project_number6}}" style="width:300px;"/>            
            </td>
		</tr>
		
		<tr class="projectAddress7" {{ if $detail.po_project_number7}}style="display:table-row;"{{/if}}>
			<th> Project Address7:</th>
            <td>
            <datalist id='address7'>
           {{foreach from=$busdetail key="key_pa7" item="item_pa7"}}
            <option value="{{$item_pa7.bsn_address}}">
            {{$item_pa7.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number7]" list="address7" value="{{$detail.po_project_number7}}" style="width:300px;"/>            
            </td>
		</tr>
		
		<tr class="projectAddress8" {{ if $detail.po_project_number8}}style="display:table-row;"{{/if}}>
			<th> Project Address8:</th>
            <td>
            <datalist id='address8'>
           {{foreach from=$busdetail key="key_pa8" item="item_pa8"}}
            <option value="{{$item_pa8.bsn_address}}">
            {{$item_pa8.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number8]" list="address8" value="{{$detail.po_project_number8}}" style="width:300px;"/>            
            </td>
		</tr>
		
		<tr class="projectAddress9" {{ if $detail.po_project_number9}}style="display:table-row;"{{/if}}>
			<th> Project Address9:</th>
            <td>
            <datalist id='address9'>
           {{foreach from=$busdetail key="key_pa9" item="item_pa9"}}
            <option value="{{$item_pa9.bsn_address}}">
            {{$item_pa9.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number9]" list="address9" value="{{$detail.po_project_number9}}" style="width:300px;"/>            
            </td>
		</tr>
		
		<tr class="projectAddress10" {{ if $detail.po_project_number10}}style="display:table-row;"{{/if}}>
			<th> Project Address10:</th>
            <td>
            <datalist id='address10'>
           {{foreach from=$busdetail key="key_pa10" item="item_pa10"}}
            <option value="{{$item_pa10.bsn_address}}">
            {{$item_pa10.bsn_address}}
            </option>
            {{/foreach}}
  	       </datalist>
            <input type="text" name="poincc[po_project_number10]" list="address10" value="{{$detail.po_project_number10}}" style="width:300px;"/>            
            </td>
		</tr>
			...
			$("#addProjectAddress").click(function() {
				...
				for (var i = 2; i <= maxIndex; i++) {
					...
					if (row.is(":hidden")) {
						...
						if (i === 2) {
							prevInput = $("input[name='poincc[po_project_number]']");
						} else {
							prevInput = $("input[name='poincc[po_project_number" + (i-1) + "]']");
						}
