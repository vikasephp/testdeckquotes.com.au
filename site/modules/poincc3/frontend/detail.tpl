     ...
     <table id="viewdoc-table" width="80%" cellpadding="0" cellspacing="0" >
      ...
      <tr>
		...
		<tr class="projectAddress2" {{ if $detail.po_project_number2}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number2]" list="address" value="{{$detail.po_project_number2}}" style="width:300px;"/>            
            </td>
		</tr>
		...
		<tr class="projectAddress3" {{ if $detail.po_project_number3}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number3]" list="address" value="{{$detail.po_project_number3}}" style="width:300px;"/>            
            </td>
		</tr>
		...
		<tr class="projectAddress4" {{ if $detail.po_project_number4}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number4]" list="address" value="{{$detail.po_project_number4}}" style="width:300px;"/>            
            </td>
		</tr>
		...
		<tr class="projectAddress5" {{ if $detail.po_project_number5}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number5]" list="address" value="{{$detail.po_project_number5}}" style="width:300px;"/>            
            </td>
		</tr>
		...
		<tr class="projectAddress6" {{ if $detail.po_project_number6}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number6]" list="address" value="{{$detail.po_project_number6}}" style="width:300px;"/>            
            </td>
		</tr>
		...
		<tr class="projectAddress7" {{ if $detail.po_project_number7}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number7]" list="address" value="{{$detail.po_project_number7}}" style="width:300px;"/>            
            </td>
		</tr>
		...
		<tr class="projectAddress8" {{ if $detail.po_project_number8}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number8]" list="address" value="{{$detail.po_project_number8}}" style="width:300px;"/>            
            </td>
		</tr>
		...
		<tr class="projectAddress9" {{ if $detail.po_project_number9}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number9]" list="address" value="{{$detail.po_project_number9}}" style="width:300px;"/>            
            </td>
		</tr>
		...
		<tr class="projectAddress10" {{ if $detail.po_project_number10}}style="display:table-row;"{{/if}}>
            ...
            <td>
            <input type="text" name="poincc[po_project_number10]" list="address" value="{{$detail.po_project_number10}}" style="width:300px;"/>            
            </td>
		</tr>
