...
function fetchPoRecords($job)
{
	...
	$fetchQuery = "SELECT SQL_CALC_FOUND_ROWS null as row_name, poincc3.* FROM poincc3  WHERE 1=1 AND po_invoice_stage = '$invStageId' ORDER BY STR_TO_DATE(poincc3.po_invoice_date,'%d-%m-%Y') DESC";
