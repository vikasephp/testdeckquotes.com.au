...
<a href="{{$BASE_URL}}poincc3.add_stage" class="various" title="Edit" style="color:#FFF; text-decoration:none; font-size:14px;">Add New Stage</a>
</div>
...
<th width="10%">SrNo</th><th width="60%">Invoice Stage Option </th><th width="15%">Color Code</th><th width="15%">Action</th>
       ...
       <tr>
        ...
        <td> <a href="{{$BASE_URL}}poincc3.add_stage/is_id/{{$item.is_id}}" class="various" title="Edit"> 
