...
<table id="viewdoc-table" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #999;">
   ...
   <td colspan="2">
    ...
    {{$detail.po_alert_text}}
    </textarea>
    </td>
    <tr>
    <td> User : {{$user_name}} </td> <td> Date : <input type="text" name="alert_date" value="{{$detail.po_alert_date}}" class="w16em dateformat-d-ds-m-ds-Y" id="demo7" maxlength="25" /> </td>
    </tr>
