...
{
	var viewurl = "{{$BASE_URL}}budgeting_report.view_procedure"+ "/random/" + Math.random();	
  ...
  <table id="doclist-table" class="nav-back" width="100%">
    <thead>
      <tr>
        ...
        <th class="topmenu" align="center" valign="middle" width="7%">Budget</th>
        <th class="topmenu" align="center" valign="middle" width="7%">GP</th> 
    ...
    <tbody>
      ...
      <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
        ...
        <td style="text-align:center;" >{{$item.bcust_wcr_occ_date}}<br />
        {{if  $item.bcust_wcr_occ_date }} {{$item.bcust_wcr_occ_dt_who}} {{/if}} 
        </td>
        <td style="text-align:center;" >{{$item.bcust_br_budget}}</td>
        <td style="text-align:center;" >{{$item.bcust_br_gp}}</td>
            
        <td style="text-align:center;"> <a href="{{$BASE_URL}}{{$XFA.detail}}/bcust_id/{{$item.bs_customers_id}}" class="various" title="Edit"> 
