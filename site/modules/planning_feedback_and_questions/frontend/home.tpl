...
<div id="">
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                <th class="topmenu" align="center" valign="middle" data-col="1">S.N.</th>
                <th class="topmenu" align="center" valign="middle" data-col="2">User</th>
                <th class="topmenu" align="center" valign="middle" data-col="3">Project</th>
                <th class="topmenu" align="center" valign="middle" data-col="4">When</th>
                <th class="topmenu" align="center" valign="middle" data-col="5">Message</th>
                <th class="topmenu" align="center" valign="middle" data-col="6">Status</th>
            </tr>
        </thead>
        <tbody>
            {{ foreach from=$list key="key" item="item" }}
            <tr bgcolor="{{cycle values=" #D3E8D6,WHITE" advance=true}}">
                <td data-col="1">{{counter}}</td>
                <td data-col="2">{{ $item.bcust_fname }} {{ $item.bcust_lname }}</td>
                <td data-col="3">{{ $item.bsn_name }}</td>
                <td data-col="4">{{ $item.fb_created_at }}</td>
                <td data-col="5">{{ $item.fb_feedback }}</td>
                <td data-col="6">{{ $item.fb_status }}</td>
            </tr>
            {{ /foreach }}
        </tbody>
    </table>
