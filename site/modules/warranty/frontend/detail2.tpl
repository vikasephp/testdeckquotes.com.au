...
{{foreach from = $issueDetail key = 'key' item = 'item' }}
 ...
 <table id="product-table" width="100%" border="1">
     ...
     <td style="width:12%"><input  type="text" name="warranty_issue[{{$item.wi_id}}][wi_warrany_issue_num]"  value="{{$item.wi_warrany_issue_num}}" style="width:100px;" /> </td>
    ...
    <th style="width:12%"> CGFB Person </th>
     ...
     <td style="width:12%">
     <input  type="text" name="warranty_issue[{{$item.wi_id}}][wi_date]"  value="{{$item.wi_date}}" id="demo1" class="w16em dateformat-d-ds-m-ds-Y dtpic" style="width:100px;" /> </td>
     </td>
    </tr> 
    <tr>
     <th>Upload Image</th>
  ...
  <input type="hidden" name="new_issue[wi_wa_id]" value="{{$wa_id}}" />
     ...
     <td style="width:12%"><input  type="text" name="new_issue[wi_warrany_issue_num]"  value="{{$detail.wi_warrany_issue_num}}" style="width:100px;" /> </td>
