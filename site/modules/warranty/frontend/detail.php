...
if(!empty($submitissue))
{
	...
	foreach($detail_wi as $ki => $vi)
	{
		...
		// db($_FILES['img1']['name']);
		 ...
		 if($_FILES['img1']['name'][$ki])
		  {
			  	db($_FILES['img1']['name'][$ki]);
		 		$image_1 = $_FILES['img1']['name'][$ki];
				$image_1 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_1);
				$temp_name_1 = $_FILES['img1']['tmp_name'][$ki];
				$vi['wi_img1'] = $image_1;
				upload($image_1, $temp_name_1);
		}
		
		if($_FILES['img2']['name'][$ki])
		{
				$image_2 = $_FILES['img2']['name'][$ki];
				$image_2 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_2);
				$temp_name_2 = $_FILES['img2']['tmp_name'][$ki];
				$vi['wi_img2'] = $image_2;
				upload($image_2, $temp_name_2);
		}
		
		if($_FILES['img3']['name'][$ki])
		{
				$image_3 = $_FILES['img3']['name'][$ki];
				$image_3 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_3);
				$temp_name_3 = $_FILES['img3']['tmp_name'][$ki];
				$vi['wi_img3'] = $image_3;
				upload($image_3, $temp_name_3);
		}
		
		if($_FILES['img4']['name'][$ki])
		{
				$image_4 = $_FILES['img4']['name'][$ki];
				$image_4 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_4);
				$temp_name_4 = $_FILES['img4']['tmp_name'][$ki];
				$vi['wi_img4'] = $image_4;
				upload($image_4, $temp_name_4);
		}
		
		if($_FILES['img5']['name'][$ki])
		{
				$image_5 = $_FILES['img5']['name'][$ki];
				$image_5 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_5);
				$temp_name_5 = $_FILES['img5']['tmp_name'][$ki];
				$vi['wi_img5'] = $image_5;
	...
	if(!empty($detail_new)) {
		image_upload($detail_new);
	}
		
}
if(isset($detail_new)) { unset($detail_new); }	
...
if(!empty($submit))
{
	...
	if($this_id == 0 )
	{
		...
		{
				$image_1 = $_FILES['img11']['name'];
				$image_1 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_1);
				$temp_name_1 = $_FILES['img11']['tmp_name'];
				$detail_wi['wi_img1'] = $image_1;
				upload($image_1, $temp_name_1);
		}
		
		if($_FILES['img22']['name'])
		{
				$image_2 = $_FILES['img22']['name'];
				$image_2 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_2);
				$temp_name_2 = $_FILES['img22']['tmp_name'];
				$detail_wi['wi_img2'] = $image_2;
				upload($image_2, $temp_name_2);
		}
		
		if($_FILES['img33']['name'])
		{
				$image_3 = $_FILES['img33']['name'];
				$image_3 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_3);
				$temp_name_3 = $_FILES['img33']['tmp_name'];
				$detail_wi['wi_img3'] = $image_3;
				upload($image_3, $temp_name_3);
		}
		
		if($_FILES['img44']['name'])
		{
				$image_4 = $_FILES['img44']['name'];
				$image_4 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_4);
				$temp_name_4 = $_FILES['img44']['tmp_name'];
				$detail_wi['wi_img4'] = $image_4;
				upload($image_4, $temp_name_4);
		}
		
		if($_FILES['img55']['name'])
		{
				
				$image_5 = $_FILES['img55']['name'];
				$image_5 =  preg_replace('/[^A-Z0-9._]/i', '_', $image_5);
				$temp_name_5 = $_FILES['img55']['tmp_name'];
				$detail_wi['wi_img5'] = $image_5;
				upload($image_5, $temp_name_5);
		}
	}
    ...
    $fwViewData['opr'] = $opr;
		...
		Location(BASE_URL . $XFA['detail'].'/wa_id/'.$opr);
}
...
function image_upload($detail_new) 
{
...
$sqlauto = "Select max(wi_warrany_issue_num) as wi_win from warranty_issue";
$win = $fwDb->queryOne($sqlauto);

if($win['wi_win'] > 0) {

	$fwViewData['win'] = $win['wi_win'] + 1;	
} else {
	$fwViewData['win'] = 101;
