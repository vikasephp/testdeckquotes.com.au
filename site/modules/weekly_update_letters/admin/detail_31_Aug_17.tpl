...
<input type="hidden" name="emaillibrary[eml_id]" value="{{$detail.$ID}}" id="eml_id"/>
    <table id="product-table" cellpadding="0" cellspacing="0" style="width:98% !important; border:1px solid #CCC;">
        ...
        <tr>
            <th>Email Code:</th>
            <td><input type="text" name="emaillibrary[eml_code]" value="{{$detail.eml_code}}" style="width:200px;"/></td>
            <th>Email Prupose:</th>
            <td><input type="text" name="emaillibrary[eml_purpose]" value="{{$detail.eml_purpose}}" style="width:200px;"/></td>
        </tr>    
		...
		<tr>
                ...
                <textarea cols="110" id="editor1"  name="emaillibrary[eml_email_content]" rows="20" class="tinymce">{{$detail.eml_email_content}}</textarea>    
                </td></tr></table>
                </td>
            </tr>
		<tr>
            ...
            <td>
            <select name="emaillibrary[eml_business_stream]" class="lrg" style="width:220px;">
            ...
            <option value="{{$item.user_name}}" {{if $detail.eml_qa == "No"}} selected="selected" {{/if}}>{{$item.user_name}}</option>
            {{/foreach}}
            </td>
