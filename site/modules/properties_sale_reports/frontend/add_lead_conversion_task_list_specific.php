<?php
$fwMainView = 'file:' . getcwd() . '/' . $ATTRIBUTES['lead_conversion_task_list_specific']['add_file'];

$fwViewData['primary_id'] = $primary_id = $ATTRIBUTES['lead_conversion_task_list_specific']['id'];
$tableTask = new Fw_Db_Table($ATTRIBUTES['lead_conversion_task_list_specific']['table']);
