...
//$ord = " ORDER BY FIELD(ps_stage, 1, 2, 3, 19, 20, 0)";
$ord = "  ORDER BY ps_id desc"; //Order by Latest Project Added
...
foreach ($lists as $list):
	...
	if ($list['ps_brochure_link']) {
		$list['ps_brochure_link'] = '<a href="' . $list['ps_brochure_link'] . '" target="_blank">Link</a>';
	}
