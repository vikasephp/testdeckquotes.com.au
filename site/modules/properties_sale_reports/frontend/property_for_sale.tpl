<div style="float:left; text-align:left;">
	<input type="button" name="Property for Sale Task List Unique" value="Unique Task List" onclick="javascript:open_url('prop_sale_task_list_specific');" />
...
<div class="" style="float:right;">
	<input type="button" name="Property for Sale Task List" value="Task List" onclick="javascript:open_url('prop_sale_task_list');" />
...
<table id="list-table">
	...
	<tbody>
		{{if $data_psri_psTable}}
		{{assign var="psri_ps" value=1}}
		{{foreach from=$data_psri_psTable key="key" item="item"}}
		<tr bgcolor='{{ cycle values=" #D3E8D6,WHITE" advance=true }}'>
			...
			<td>
				...
				{{foreach from=$prsa_psr_complete item=item_lc}}
				...
				<form name="recmet3" method="post" action="">
					...
					<input type="hidden" name="psr_complete[psrtc_key]" value="prop_sale">
		...
		{{assign var="psri_ps" value=$psri_ps+1}}
		{{/foreach}}
		{{else}}
		<tr>
