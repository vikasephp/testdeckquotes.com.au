<?php
$fwMainView = 'file:' . getcwd() . '/' . $ATTRIBUTES['prep_market_task_list_specific']['add_file'];

$fwViewData['primary_id'] = $primary_id = $ATTRIBUTES['prep_market_task_list_specific']['id'];
$tableTask = new Fw_Db_Table($ATTRIBUTES['prep_market_task_list_specific']['table']);
