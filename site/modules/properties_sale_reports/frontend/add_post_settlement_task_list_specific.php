<?php
$fwMainView = 'file:' . getcwd() . '/' . $ATTRIBUTES['post_settlement_task_list_specific']['add_file'];

$fwViewData['primary_id'] = $primary_id = $ATTRIBUTES['post_settlement_task_list_specific']['id'];
$tableTask = new Fw_Db_Table($ATTRIBUTES['post_settlement_task_list_specific']['table']);
