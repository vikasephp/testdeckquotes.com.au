<?php
$fwMainView = 'file:' . getcwd() . '/' . $ATTRIBUTES['lead_conversion_task_list']['add_file'];

$fwViewData['primary_id'] = $primary_id = $ATTRIBUTES['lead_conversion_task_list']['id'];
$tableTask = new Fw_Db_Table($ATTRIBUTES['lead_conversion_task_list']['table']);
