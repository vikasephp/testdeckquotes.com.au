...
// module names
$MODULE_SINGULAR = 'Design Pricing Update Report';
$MODULE_PLURAL = 'Design Pricing Update Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'design_interface';
$ID = 'di_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/design_interface/'.$zipfile, S3::ACL_PUBLIC_READ)) {
