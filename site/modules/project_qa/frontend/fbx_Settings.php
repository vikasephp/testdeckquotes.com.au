...
// module names
$MODULE_SINGULAR = 'Project Q/A Clearing Center';
$MODULE_PLURAL =   'Project Q/A Clearing Center';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/project_qa/'.$zipfile, S3::ACL_PRIVATE)) {
