...
if(!empty($submit))
{
	...
	$data = explode("|",$detail['project']);
		...
		if($_FILES['ques_attach_1']['name'])
		{
				...
				$detail['attachment_ques_1'] = $docfile_1;
		...
		if($_FILES['ques_attach_2']['name'])
		{
				...
				$detail['attachment_ques_2'] = $docfile_2;
	    ...
	    if($_FILES['ques_attach_3']['name'])
		{
				...
				$detail['attachment_ques_3'] = $docfile_3;
	    ...
	    if($_FILES['ques_attach_4']['name'])
		{
				...
				$detail['attachment_ques_4'] = $docfile_4;
	    ...
	    if($_FILES['ques_attach_5']['name'])
		{
				...
				$detail['attachment_ques_5'] = $docfile_5;
				upload($docfile_5, $temp_name_5);
		}
	

	
	$detail['project_id'] = $data[0];
