...
// module names
$MODULE_SINGULAR = 'All Accounts Receivable Report';
$MODULE_PLURAL =   'All Accounts Receivable Report';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = '30_days_rec_report';
$ID = 'td_id';
...
function upload_2024($filename, $tmpname)
{
...
function create_30_days_pdf($heading, $html, $fname)
		{
...
$nameoffile = '30_day_account_report';
...
$pdf->SetTitle("CGFB");
$pdf->SetSubject('30 Days Plus Accounts Receivable Report');
