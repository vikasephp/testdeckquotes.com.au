...
{
	var viewurl = "{{$BASE_URL}}sales_process_explained.view_procedure"+ "/random/" + Math.random();	
...
<div id="">
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
                   ...
                   <th class="topmenu" align="center" valign="middle" width="20%">Process</th> 
 ...
 {{foreach from=$list key="key" item="item"}}
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <td>{{$item.sp_id}}</td>
        <td>{{$item.sp_document}}</td>
        <td>{{$item.sp_explained}}</td>
