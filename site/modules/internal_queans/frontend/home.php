...
if(!empty($submit))
{
	$heading = "Internal Questions and Answer";
	$fname = "soni";
	...
	foreach($qaData as $m)
	{
	$html .= "<b>".$m['iqa_question']."</b>";
	$html .= $m['iqa_answer']."<br>";
	}
...
if($keyword):
$where .= "AND ".$TABLE.".iqa_question LIKE '%".$keyword."%' OR ".$TABLE.".iqa_answer LIKE '%".$keyword."%'";
