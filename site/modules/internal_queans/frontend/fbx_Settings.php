...
// module names
$MODULE_SINGULAR = 'Internal Question Answer';
$MODULE_PLURAL = 'Internal Questions Answers';

$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'internal_question_answer';
$ID = 'iqa_id';
	...
	include_once $filetoinclude;
        ...
        try {
           ...
           $s3 = new S3(ACCESS_KEY, SECRET_KEY);
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/question_answer_doc/'.$zipfile, S3::ACL_PRIVATE)) {
