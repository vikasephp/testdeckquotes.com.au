...
// module names
$MODULE_SINGULAR = 'Cgfb Street Sign Report Designs';
$MODULE_PLURAL = 'Cgfb Street Sign Report Designs';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'street_sign_design';
$ID = 'ss_id';
...
function upload($filename, $tmpname)
{
	...
	include_once $filetoinclude;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, BUCKET_NAME, 'files/street_sign_design/'.$zipfile, S3::ACL_PRIVATE)) {
