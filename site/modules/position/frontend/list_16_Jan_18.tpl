    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>	
            		...
            		<th class="topmenu" align="left" valign="middle" width="20%"><div align="left">Position:</div></th>
                    <th class="topmenu" align="left" valign="middle" width="30%"><div align="left">Position Description:</div></th>
                    ...
                    <th class="topmenu" align="left" valign="middle"><div align="left">Persons holding this position:</div></th>
               		<th class="topmenu" align="left" valign="middle" width="5%"><div align="left">Access:</div></th>
           </tr>
        <tbody>
        ...
        {{foreach from=$list key="key" item="item"}}
            <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
                ...
                <td>{{$item.rp_name}}</td>
                <td> </td>
                <td><a href="{{$BASE_URL}}/files/user_docs/{{$item.p_document}}">{{$item.p_document}} </a></td>
                <td>{{if $item.u_name}}
          ...
          <td><div align="left"><a href="{{$BASE_URL}}{{$XFA.view}}/user_id/{{$item.user_id}}" class="various" title="View"><img style="height: 20px;; width:20px" src="{{$BASE_URL}}css/admin/images/view.png"/></a></div></td>
            </tr>
        {{/foreach}}
        </tbody>
        </form>
