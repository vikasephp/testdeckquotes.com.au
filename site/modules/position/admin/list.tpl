    ...
    <table id="list-table" class="nav-back" width="100%">
        <thead>
            <tr>
            		...
            		<th class="topmenu" align="center" valign="middle" width="45%">Type</th>
					<th class="topmenu" align="center" valign="middle" width="30%">Email</th>
                    <th class="topmenu" align="center" valign="middle" width="30%">Document</th>
