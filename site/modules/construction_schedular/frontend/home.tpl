    ...
    <table id="list-table" class="nav-back" width="100%" >
        <thead>
            <tr>
                ...
                <th class="topmenu" align="center" valign="middle" width="50%">Project Name</th> 
                <th class="topmenu" align="center" valign="middle" width="40%">Link To Calendar</th>
             </tr>
        </thead>
<tbody>
 ...
 <tr bgcolor="{{cycle values="#D3E8D6,WHITE" advance=true}}">
    ...
    <td>{{counter}}</td>
    <td>{{$item.bsn_name}}</td> 
    <td><a href="{{$BASE_URL}}construction_schedular.grid_view/bsn_id/{{$item.bsn_id}}">View Calendar</a></td>
