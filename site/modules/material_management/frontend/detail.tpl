        ...
        <table id="list-table" width="100%">
           ...
           {{if $error}} <tr><th colspan="2" style="color:#FF0000;">{{$error}}</th></tr>{{/if}}
            <tr>
             ...
             <tr>
                ...
                <td >
                    ...
                    <option value="{{$item.sp_id}}" {{if $item.sp_id == $detail.sp_id}}selected{{/if}}>{{$item.sp_business_name}}</option>
                    {{/foreach}}
                    </select>    
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input type= "text" name="{{$TABLE}}[ms_link]" value="{{$detail.ms_link}}" class="xlrg" style="width:500px;" /></td>
            </tr>
            <tr>
                <th>Quantity:</th>
            ...
            <tr>
                <th>Image:</th>
                <td><input type= "file" name="image1" /> &nbsp;&nbsp;{{if $detail.ms_image}}<img src="{{$BASE_URL}}files/suppliers/materials/thumb/{{$detail.ms_image}}" />{{/if}}</td>
            </tr>
            <tr>
