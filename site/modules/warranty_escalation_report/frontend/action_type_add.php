<?php
$fwMainView = 'file:' . getcwd() . '/' . $ATTRIBUTES['action_type']['add_file'];

$fwViewData['primary_id'] = $primary_id = $ATTRIBUTES['action_type']['id'];
$tableTask = new Fw_Db_Table($ATTRIBUTES['action_type']['table']);
