...
.wrapper2{ }
.div1 {width:3380px; height: 20px; }
.div2 {width:3380px;  overflow: auto;}  
.dtpic {
...
<input class="switch-input" type="checkbox"  name="hasreno[{{$item.dpn_unique_id}}]" value="1"  onclick="this.form.submit();" {{if $item.dpn_pcp_hasreno eq 1 }} checked="checked" {{/if}} />
	...
	<td>{{$item.uid1}}</td>
        ...
        <td style="text-align:center;" > 
           ...
           <a href = "/proposal_report.download_content?file_name={{$item.checklist20}}&module_name=proposal_report.home" target="_blank">Download</a> 
	   ...
	   function update_where_we_are(id,value)
		...
		//alert(id);	
         ...
         <td><a href="{{$BASE_URL}}proposal_report.view_alerts/bsn_id/{{$item.dpn_bsn_id}}" class="various">View Alert</a><br />
       ...
       <td>
       <input type="text" name="esti_reno[{{$item.dpn_unique_id}}]" value="{{$item.dpn_pcp_est_reno_val}}" onkeyup = "update_esti_reno({{$item.dpn_unique_id|ltrim:'0'}},this.value)" style="width:120px;"/>
	   ...
	   function update_esti_reno(id,value)
        ...
        <td style="text-align:center;" > {{if $item.checklist37}}
           ...
           <a href = "/proposal_report.download_content?file_name={{$item.checklist37}}&module_name=proposal_report.home" target="_blank">Download</a>  
	  ...
	  <td style="text-align:center;" > 
             ...
             <a href = "/proposal_report.download_content?file_name={{$item.checklist9}}&module_name=proposal_report.home" target="_blank">Download</a>
       ...
       <td style="text-align:center;" > 
             ...
             <a href = "/proposal_report.download_content?file_name={{$item.checklist61}}&module_name=proposal_report.home" target="_blank">Download</a>
     ...
     <!-- <a href = "https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$item.checklist8}}?dummy={{$ran}}" target="_blank">Download</a>-->
        <a href = "/proposal_report.download_content?file_name={{$item.checklist8}}&module_name=proposal_report.home" target="_blank">Download</a>     
       ...
       <!--<a href = "https://deckquote.s3.amazonaws.com/files/document_check_list_files/{{$item.checklist62}}?dummy={{$ran}}" target="_blank">Download</a>-->
          <a href = "/proposal_report.download_content?file_name={{$item.checklist62}}&module_name=proposal_report.home" target="_blank">Download</a>  
     ...
     <input type="hidden" name="prnum[{{$item.dpn_bsn_id}}]" value="{{$item.dpn_proposal_number}}" />
  	<label class="switch">
   <input class="switch-input" type="checkbox"  name="ssp[{{$item.dpn_bsn_id}}]" value="1"  onclick="this.form.submit();" {{if $item.uid43_com eq 1 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
        </label>
     </form>
     ...
     <input type="hidden" name="prnumcpp[{{$item.dpn_bsn_id}}]" value="{{$item.dpn_proposal_number}}" />
  	<label class="switch">
   <input class="switch-input" type="checkbox"  name="cpp[{{$item.dpn_bsn_id}}]" value="1"  onclick="this.form.submit();" {{if $item.uid95_com eq 1 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
        </label>
     </form>
     ...
     <input type="hidden" name="reno_checked[{{$item.dpn_unique_id}}]" value="0" />
  	<label class="switch">
   <input class="switch-input" type="checkbox" name="reno_checked[{{$item.dpn_unique_id}}]" value="1" onclick="this.form.submit();" {{if $item.dpn_pcp_reno_checkd eq 1 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
        </label>
     </form>
       ...
       <td> 
       <input type="text" name="prop_val[{{$item.dpn_unique_id}}]" value="{{$item.dpn_pcp_proposal_value}}" onkeyup = "update_proposal_value({{$item.dpn_unique_id|ltrim:'0'}},this.value)" style="width:120px;"/>
       ...
       <td>
        <input type="text" name="ss_val[{{$item.dpn_unique_id}}]" value="{{$item.dpn_pcp_ss_value}}" onkeyup = "update_ss_value({{$item.dpn_unique_id|ltrim:'0'}},this.value)" style="width:120px;"/>
      ...
      <td>
      <input type="text" name="reno_val[{{$item.dpn_unique_id}}]" value="{{$item.dpn_pcp_reno_value}}" onkeyup = "update_reno_value({{$item.dpn_unique_id|ltrim:'0'}},this.value)" style="width:120px;"/>
     ...
     <input type="hidden" name="box1[{{$item.dpn_bsn_id}}]" value="0" />
  	<label class="switch">
   <input class="switch-input" type="checkbox"  name="box1[{{$item.dpn_bsn_id}}]" value="1"  onclick="this.form.submit();" {{if $item.uid64_com eq 1 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
        </label>
     </form>
     ...
     <input type="hidden" name="box2[{{$item.dpn_bsn_id}}]" value="0" />
  	<label class="switch">
   <input class="switch-input" type="checkbox"  name="box2[{{$item.dpn_bsn_id}}]" value="1"  onclick="this.form.submit();" {{if $item.uid65_com eq 1 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
        </label>
     </form>
