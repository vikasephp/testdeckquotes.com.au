	...
	<td>{{$item.uid1}}</td>
	  ...
	  <td style="text-align:center;" >
       ...
       <form name = "tent" method="post" action="">
        <input type="text" name="dpn_pcp_tent_date[{{$item.dpn_unique_id}}]"  class="w16em dateformat-d-ds-m-ds-Y dtpic"  value="{{$item.dpn_pcp_tent_date}}"  /> 
       <input type="submit" value="Set" name="test_date" class="set" />
        ...
        <input type="text" name="bsn_pcp_pbd[{{$item.dpn_bsn_id}}]"  class="w16em dateformat-d-ds-m-ds-Y dtpic" id="demo22_{{$item.dpn_unique_id|ltrim:'0'}}" value="{{$item.bsn_pcp_pbd}}"  /> 
     ...
     <td style="text-align:center;" >
        ...
        <td style="text-align:center;" > 
         <form name = "pbd" method="post" action="">
         <input type="text" name="bsn_pcp_hbd[{{$item.dpn_bsn_id}}]"  class="w16em dateformat-d-ds-m-ds-Y dtpic" id="demo33_{{$item.dpn_unique_id|ltrim:'0'}}" value="{{$item.bsn_pcp_hbd}}"  /> 
...
<input class="switch-input" type="checkbox"  name="hide[{{$item.dpn_unique_id}}]" value="1"  onclick="this.form.submit();" {{if $item.dpn_pcp_hide eq 1 }} checked="checked" {{/if}} />
        ...
        <td>
        <form name ="recmet" method="post" action="">
        <input type="hidden" name="pbns[{{$item.dpn_unique_id}}]" value="1" />
  	<label class="switch">
<input class="switch-input" type="checkbox"  name="pbns[{{$item.dpn_unique_id}}]" value="0"  onclick="this.form.submit();" {{if $item.dpn_pbns_hide eq 0 }} checked="checked" {{/if}} />
        <span class="switch-label" data-on="Yes" data-off="No"></span> 
        <span class="switch-handle"></span> <br />
        </label>
