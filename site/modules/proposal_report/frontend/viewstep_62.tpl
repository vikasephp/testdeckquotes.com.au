...
<td><input type="text" name="rdd62" class="w16em dateformat-d-ds-m-ds-Y" value="{{$dpn_render_due_dt62}}" onfocus ="update_rdd_62({{$dpn_unique_id|ltrim:'0'}}, this.value);" />

<script>
	   
	function update_rdd_62(id,value)
	{
		 
		 $.ajax({
			   type: "GET",
			   url: "{{$BASE_URL}}proposal_report.update_rdd_62/dpn_unique_id/"+id+"/value/"+value,
