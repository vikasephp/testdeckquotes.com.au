...
<tr> 
<td>{{counter}}</td>
<td>Design Summary QC for A and B</td>
<td>{{$data36}}</td>
</tr> 

<tr> 
<td>{{counter}}</td>
<td>Project Proposal - Features & Benefits list - MS Word </td>
<td>{{$data40}}</td>
</tr>

<tr> 
<td>{{counter}}</td>
<td>Operations Calculator - MS Excel</td>
<td>{{$data6}}</td>
</tr>
...
<tr> 
<td>{{counter}}</td>
<td>Master Project Helicopter and GP - Excel</td>
<td>{{$data7}}</td>
</tr>
