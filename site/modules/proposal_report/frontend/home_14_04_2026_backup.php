...
$sql = "select document_proposal_name.*, business.bsn_pcp_pbd from document_proposal_name 
        LEFT JOIN business ON business.bsn_id = document_proposal_name.dpn_bsn_id $where $ord ";
