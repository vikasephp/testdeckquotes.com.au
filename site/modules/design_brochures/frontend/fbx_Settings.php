...
// module names
$MODULE_SINGULAR = 'Design Brochure';
$MODULE_PLURAL = 'Design Brochures';
$fwViewData['MODULE_SINGULAR'] = $MODULE_SINGULAR;
$fwViewData['MODULE_PLURAL'] = $MODULE_PLURAL;

// module table and id
$TABLE = 'design_brochures';
$ID = 'dh_id';
...
function upload($filename, $tmpname)
{
	...
	$zipfile = $filename;
        ...
        try {
            ...
            if ($s3->putObjectFile($path . "/" . $zipfile, 'deckquote', 'files/brochures_hub_docs/'.$zipfile, S3::ACL_PRIVATE)) {
