...
<table id="list-table" width="100%">
   ...
   <tr>
     ...
     <td><input  type="text" name="{{$TABLE}}[sc_special_condition]"  value="{{$detail.sc_special_condition}}" style="width:700px;" /> </td>
    </tr>
   
    <tr>
     <th>Link</th>
     <td><input  type="text" name="{{$TABLE}}[sc_link]"  value="{{$detail.sc_link}}" style="width:700px;"  /> </td>
    </tr>
