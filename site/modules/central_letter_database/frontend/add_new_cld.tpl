		...
		<table id="list-table" width="100%">
			...
			<tr>
				...
				<td>
				    ...
				    <input type="text" list="project" name="task[cld_project_name]" value="{{$search_project}}" style="width: 500px;" autocomplete="off" />
				</td>
			</tr>
			<tr>
				<th>Letter Type*</th>
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="task[cld_date_uploaded]" value="{{$detail.cld_date_uploaded}}" id="demo1" class="w16em dateformat-d-ds-m-ds-Y dtpic" />
				</td>
			</tr>
			<tr>
